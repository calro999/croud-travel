...
const microWave12Configs = [
  {
    ...
    queries: [
      { key: 'kaike_ocean_view_onsen', query: '皆生温泉 ホテル 旅館 露天風呂 海 オーシャンビュー 鳥取', label: '日本海一望・美保湾を望むオーシャンビュー温泉宿' },
      { key: 'daisen_highland_nature_stay', query: '大山 蒜山 ホテル コテージ 温泉 鳥取 宿泊', label: '伯耆大山・ブナ原生林と星空の高原リゾート' },
      { key: 'sakaiminato_crab_gourmet', query: '皆生温泉 旅館 松葉ガニ カニ 料理 境港 高級', label: '境港水揚げ！極上松葉ガニ＆鳥取和牛会席宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'ashinomaki_valley_view_onsen', query: '芦ノ牧温泉 旅館 ホテル 露天風呂 渓谷 福島 会津', label: '大川渓谷一望・棚田風渓流露天風呂の名門宿' },
      { key: 'aizu_tsurugajo_higashiyama', query: '会津若松 東山温泉 旅館 鶴ヶ城 歴史 温泉 福島', label: '鶴ヶ城至近・東山温泉の歴史ある老舗温泉旅館' },
      { key: 'ouchijuku_negisoba_stay', query: '会津 旅館 馬刺し 会津地鶏 地酒 郷土料理 福島 高級', label: '会津名物極上馬刺し・会津地鶏＆金賞地酒会席宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'gero_bihada_onsen_walk', query: '下呂温泉 ホテル 旅館 露天風呂 美肌の湯 湯めぐり 岐阜', label: '日本三名泉・pH9.2美肌の湯を引く名門老舗旅館' },
      { key: 'gero_gassho_village_stay', query: '下呂温泉 下呂温泉合掌村 旅館 ホテル 温泉 宿泊', label: '下呂温泉合掌村・飛騨川パノラマ展望温泉宿' },
      { key: 'gero_hidagyu_tomato_gourmet', query: '下呂温泉 旅館 飛騨牛 朴葉味噌 料理 部屋食 高級', label: '最高級A5飛騨牛ステーキ＆飛騨牛朴葉味噌会席宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'ito_onsen_tokainkan_walk', query: '伊東温泉 ホテル 旅館 露天風呂 東海館 静岡 宿泊', label: '東海館周辺・松川沿いの風情ある老舗温泉旅館' },
      { key: 'jogasaki_omuroyama_view', query: '城ヶ崎海岸 大室山 伊豆高原 ホテル 旅館 温泉', label: '城ヶ崎海岸・大室山リフト周辺の高原温泉リゾート' },
      { key: 'ito_iseebi_local_fish_gourmet', query: '伊東 旅館 伊勢海老 アワビ 金目鯛 地魚 料理 高級', label: '伊豆近海朝獲れ地魚・伊勢海老＆アワビ踊り焼き宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'yuzawa_snow_onsen_sake', query: '越後湯沢 温泉 旅館 ホテル 露天風呂 ぽんしゅ館 新潟', label: '越後湯沢駅至近・源泉かけ流しと酒風呂の名門宿' },
      { key: 'dragondola_nature_resort', query: '苗場 ドラゴンドラ ホテル リゾート 温泉 越後湯沢', label: '苗場ドラゴンドラ・秋の紅葉＆冬のビッグゲレンデ宿' },
      { key: 'minamiuonuma_koshihikari_gourmet', query: '南魚沼 越後湯沢 旅館 魚沼産コシヒカリ にいがた和牛 料理 高級', label: '魚沼産コシヒカリ釜炊きご飯＆にいがた和牛会席宿' }
    ],
    areaGuides: [
      {
...
async function main() {
  console.log('=== Fetching direct hotel data from Rakuten Travel API for 5 Micro Tourist Hubs (Wave 12) ===');
  ...
  for (const theme of microWave12Configs) {
    console.log(`\n========================================`);
  ...
  console.log(`\nSuccessfully saved all Micro Tourist Hubs Wave 12 hotel data to: ${cachePath}`);
}
