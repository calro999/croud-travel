...
const microWave15Configs = [
  {
    ...
    queries: [
      { key: 'kanzanji_lake_view_onsen', query: '舘山寺温泉 旅館 ホテル 露天風呂 浜名湖 静岡 宿泊', label: '舘山寺温泉・浜名湖一望の絶景展望露天風呂旅館' },
      { key: 'hamanako_ropeway_resort_stay', query: '浜名湖 ホテル リゾート 温泉 かんざんじ 静岡 宿泊', label: 'かんざんじロープウェイ至近・湖畔オーシャンリゾート' },
      { key: 'hamanako_unagi_gyoza_gourmet', query: '浜名湖 旅館 うなぎ 鰻 料理 温泉 高級 静岡 浜松', label: '本場「浜名湖うなぎ」蒲焼き・ひつまぶし会席宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'minamichita_seaside_onsen_stay', query: '南知多温泉郷 旅館 ホテル 露天風呂 内海 海鮮 愛知 宿泊', label: '南知多温泉郷・伊勢湾一望オーシャンビュー露天風呂宿' },
      { key: 'himakajima_tako_fugu_stay', query: '日間賀島 旅館 民宿 タコ ふぐ 海鮮 愛知 宿泊', label: '日間賀島・名物タコ丸茹で＆冬のフグ会席付き島宿' },
      { key: 'chita_beef_isewan_fish_stay', query: '知多 旅館 知多牛 あわび 伊勢海老 料理 高級 温泉 愛知', label: 'ブランド知多牛ステーキ＆伊勢湾活アワビ・伊勢海老宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'sumoto_onsen_ocean_luxury', query: '洲本温泉 旅館 ホテル 露天風呂 淡路島 兵庫 宿泊 高級', label: '洲本温泉・紀淡海峡パノラマの絶景オーシャンビュー名旅館' },
      { key: 'awaji_north_flower_resort', query: '淡路島 北部 ホテル リゾート グランピング 明石海峡大橋 宿泊', label: '明石海峡大橋・あわじ花さじき周辺のモダンリゾート' },
      { key: 'awaji_beef_onion_gourmet', query: '淡路島 旅館 淡路牛 玉ねぎ 由良うに 料理 温泉 部屋食 兵庫', label: '特選淡路牛サーロイン＆淡路島玉ねぎ・由良赤ウニ会席宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'karatsu_castle_matsubara_stay', query: '唐津 旅館 ホテル 露天風呂 虹の松原 唐津城 佐賀 宿泊', label: '唐津城＆虹の松原一望・唐津湾オーシャンビュー名旅館' },
      { key: 'yobuko_squid_fresh_stay', query: '呼子 旅館 イカ 活き造り ホテル 温泉 佐賀 宿泊', label: '呼子港直送！透き通る活イカ姿造り＆イカしゅうまい宿' },
      { key: 'karatsu_saga_beef_pottery_stay', query: '唐津 旅館 佐賀牛 唐津焼 料理 温泉 高級 部屋食 佐賀', label: '唐津焼の名器で味わう最高峰佐賀牛＆玄界灘海鮮会席宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'kirishima_jingu_heritage_onsen', query: '霧島神宮 温泉 旅館 露天風呂 国宝 鹿児島 宿泊 高級', label: '国宝霧島神宮至近・神話の森に佇む名門温泉旅館' },
      { key: 'kirishima_mud_sulfur_onsen', query: '霧島温泉 泥湯 硫黄泉 旅館 ホテル 露天風呂 鹿児島 宿泊', label: '霧島温泉郷・湯けむり立ち上る天然泥湯＆硫黄泉宿' },
      { key: 'kurobuta_shabu_kagoshima_stay', query: '霧島 旅館 黒豚 しゃぶしゃぶ 鹿児島黒牛 料理 部屋食 温泉', label: '本場かごしま黒豚しゃぶしゃぶ＆鹿児島黒牛会席宿' }
    ],
    areaGuides: [
      {
...
async function main() {
  console.log('=== Fetching direct hotel data from Rakuten Travel API for 5 Micro Tourist Hubs (Wave 15) ===');
  ...
  for (const theme of microWave15Configs) {
    console.log(`\n========================================`);
  ...
  console.log(`\nSuccessfully saved all Micro Tourist Hubs Wave 15 hotel data to: ${cachePath}`);
}
