...
const microWave22Configs = [
  {
    ...
    queries: [
      { key: 'osorezan_shimofuro_onsen_stay', query: '下風呂温泉 恐山 旅館 温泉 宿泊 下北 青森 露天風呂', label: '恐山参拝拠点＆下風呂温泉・津軽海峡望む白濁硫黄泉宿' },
      { key: 'oma_tuna_cape_stay', query: '大間 ホテル 旅館 マグロ 大間崎 宿泊 青森 海鮮', label: '本州最北端大間崎至近・極上「大間まぐろ」一本釣り料理宿' },
      { key: 'hotokegaura_mutsu_stay', query: 'むつ市 ホテル 旅館 仏ヶ浦 下北半島 宿泊 青森', label: 'むつ市中心部＆仏ヶ浦遊覧・下北ジオパーク観光名宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'naruko_onsen_kyo_heritage_stay', query: '鳴子温泉 旅館 ホテル 露天風呂 温泉 宿泊 宮城 こけし', label: '鳴子温泉駅至近・伝統こけしの里＆源泉かけ流し名旅館' },
      { key: 'narukokyo_gorge_autumn_stay', query: '鳴子峡 温泉 旅館 ホテル 紅葉 宿泊 宮城 大深沢橋', label: '鳴子峡一望＆紅葉トレッキング拠点パノラマ温泉宿' },
      { key: 'naruko_kuridango_miyagi_beef_stay', query: '鳴子温泉 旅館 栗だんご 仙台牛 料理 温泉 宿泊 宮城', label: '名物「栗だんご」＆極上仙台牛ステーキ会席温泉宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'shimobe_onsen_shingen_stay', query: '下部温泉 旅館 ホテル 温泉 宿泊 山梨 ぬる湯 武田信玄', label: '信玄公隠し湯・下部温泉ぬる湯＆源泉かけ流し湯治宿' },
      { key: 'minobusan_kuonji_shukubo_stay', query: '身延山 宿坊 旅館 久遠寺 宿泊 山梨 しだれ桜', label: '身延山久遠寺門前町＆歴史ある宿坊・精進料理名宿' },
      { key: 'minobu_yuba_koshu_beef_stay', query: '身延 旅館 ゆば 甲州牛 料理 温泉 下部 宿泊 山梨', label: '身延特産「身延ゆば」会席＆甲州ワインビーフ温泉宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'misasa_radium_onsen_ryokan_stay', query: '三朝温泉 旅館 ホテル ラジウム温泉 宿泊 鳥取 露天風呂', label: '三朝温泉街中心部・高濃度ラジウム温泉＆名湯老舗旅館' },
      { key: 'mitokusan_nageiredou_stay', query: '三徳山 投入堂 温泉 旅館 宿泊 鳥取 三朝 修験道', label: '三徳山投入堂参拝拠点＆六根清浄・精進料理温泉宿' },
      { key: 'tottori_wagyu_tochimochi_stay', query: '三朝温泉 旅館 鳥取和牛 松葉ガニ とち餅 料理 宿泊 鳥取', label: '鳥取名物「鳥取和牛オレイン55」＆冬の松葉ガニ会席旅館' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'uwajima_castle_hotel_stay', query: '宇和島 ホテル 旅館 宿泊 宇和島城 温泉 愛媛', label: '宇和島駅＆宇和島城至近・伊達の歴史薫る城下町ホテル' },
      { key: 'nametoko_gorge_nature_stay', query: '滑床渓谷 松野町 ホテル ロッジ 宿泊 温泉 愛媛 キャニオニング', label: '滑床渓谷＆雪輪の滝至近・大自然フォレストロッジ宿' },
      { key: 'uwajima_taimeshi_seafood_stay', query: '宇和島 旅館 鯛めし 料理 宿泊 愛媛 海鮮 宇和海', label: '元祖「宇和島鯛めし」＆真鯛・愛南びやびやかつお海鮮宿' }
    ],
    areaGuides: [
      {
...
async function main() {
  console.log('=== Fetching direct hotel data from Rakuten Travel API for 5 Micro Tourist Hubs (Wave 22) ===');
  ...
  for (const theme of microWave22Configs) {
    console.log(`\n========================================`);
    console.log(`Micro Hub (Wave 22): ${theme.title} (${theme.slug})`);
    console.log(`========================================`);
  ...
  console.log(`\nSuccessfully saved all Micro Tourist Hubs Wave 22 hotel data to: ${cachePath}`);
}
