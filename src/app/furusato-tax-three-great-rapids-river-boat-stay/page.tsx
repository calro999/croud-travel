      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 mt-12 space-y-16">
        ...
        <section className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 backdrop-blur shadow-2xl">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">
            豪快な激流を巧みな竿さばきで下る爽快感。清流のせせらぎと川魚の美食に酔いしれる渓谷ステイ
          </h2>
          <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
            日本列島の険しい山々から海へと一気に流れ下り、古くから水運の要衝として歴史を刻んできた「日本三大急流」――松尾芭蕉が「五月雨をあつめて早し」と詠み、船頭の情緒あふれる舟唄が渓谷にこだまする山形の「最上川」、甲斐の山々から駿河湾へと注ぎ、富士の絶景と豊かな水量を誇る山梨の「富士川」、そして日本屈指の激流としてラフティングや伝統の木造船下りが愛される熊本の「球磨川」。川面を吹き抜けるマイナスイオンたっぷりの風を感じ、白波を蹴立てて進む舟下りはスリルと感動の連続です。渓谷美を望む宿で鮎の塩焼きや山菜、銘酒を味わう癒やしのリバーサイドステイを楽天ふるさと納税でお楽しみください。
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key="0" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              ...
              <h3 className="font-bold text-white text-lg mb-2">川のせせらぎをBGMに眠る！全室リバービューの風情あふれる名門宿</h3>
              <p className="text-slate-400 text-sm leading-relaxed">窓を開ければ目の前に清流が広がり、清らかな水の音に包まれながら心身をリフレッシュできます。</p>
            </div>
            <div key="1" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                02
              </div>
              <h3 className="font-bold text-white text-lg mb-2">天然鮎・岩魚・ヤマメの塩焼きと山形牛・甲州ワインビーフの美食</h3>
              <p className="text-slate-400 text-sm leading-relaxed">清流の恵みで育まれた新鮮な川魚の炭火焼きと、地元自慢のブランド和牛を贅沢に食べ比べ。</p>
            </div>
            <div key="2" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                03
              </div>
              <h3 className="font-bold text-white text-lg mb-2">楽天ふるさと納税宿泊クーポンで大自然のアドベンチャー旅行をお得に</h3>
              <p className="text-slate-400 text-sm leading-relaxed">舟下りやラフティングの拠点となる名湯旅館の宿泊費用を大幅に控除し、家族やグループでお得に満喫。</p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            ...
            <article key="0" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  山形県戸沢村・大蔵村ふるさと納税：芭蕉が愛した名流「最上川舟下り」舟唄の響きと高見屋最上川別邸・紅ステイ
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  四季折々の渓谷美が広がる最上川。船頭の唄を聴きながらの舟下りを楽しんだ後は、全室リバービューの名宿「高見屋 最上川別邸 紅」で、最上川を眼下に望む露天風呂と最高級山形牛の陶板焼きを堪能します。
                </p>
              </div>
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F147592%2F147592.html"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <article key="1" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  山梨県身延町・富士川町ふるさと納税：怒濤の清流「富士川舟運」歴史探訪と武田信玄ゆかりの下部温泉下部ホテル
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  甲州の歴史を支えた富士川。富士川クラフトパークや身延山久遠寺を巡った後は、名湯百選に選ばれる「下部ホテル」の二種類の源泉掛け流し湯巡りと、里山バイキング・甲州牛すき焼きを満喫します。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F40916%2F40916.html"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
            ...
            <article key="2" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  熊本県人吉市ふるさと納税：九州屈指の激流「球磨川くだり・ラフティング」と登録有形文化財・人吉温泉芳野旅館
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  球磨川の白波を越える爽快な舟下り。歴史ある人吉城跡や国宝・青井阿蘇神社を訪ねた後は、創業明治の文化財の宿「芳野旅館」で、弱アルカリ性炭酸水素塩泉の美肌湯と球磨焼酎・鮎の塩焼きを味わいます。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F16280%2F16280.html"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
        ...
        <section className="border-t border-slate-800/80 pt-12 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div>
                <h3 className="font-bold text-white text-base group-hover:text-rose-400 transition mb-2">
                  激流ラフティング＆清流キャニオニング宿×ふるさと納税完全ガイド
                </h3>
            ...
            <Link
              key="2"
              href="/furusato-tax-three-great-bridges-riverside-stay"
              className="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 hover:border-slate-700 transition flex flex-col justify-between group"
            >
              <div>
                <h3 className="font-bold text-white text-base group-hover:text-rose-400 transition mb-2">
                  日本三大名橋＆清流リバーサイド宿×ふるさと納税完全ガイド
                </h3>
                <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                  錦帯橋・眼鏡橋・猿橋の渓谷。
                </p>
