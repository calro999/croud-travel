...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の広島・尾道＆しまなみ海道特集！映画の街・尾道の千光寺公園から望む尾道水道の紅葉と夕景、しまなみ海道・生口島瀬戸田の国産レモン畑、瀬戸内海の潮風香るラドン天然温泉、名物オコゼ・鯛・レモンポークをふるさと納税で堪能。',
    url: 'https://croud-travel.com/furusato-tax-mihara-onomichi-setoda-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "尾道・千光寺山の紅葉坂道としまなみ海道！瀬戸内海の多島美温泉・秋の地魚＆レモンポークを味わう広島旅",
    "description": "10月・11月の広島・尾道＆しまなみ海道特集！映画の街・尾道の千光寺公園から望む尾道水道の紅葉と夕景、しまなみ海道・生口島瀬戸田の国産レモン畑、瀬戸内海の潮風香るラドン天然温泉、名物オコゼ・鯛・レモンポークをふるさと納税で堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-mihara-onomichi-setoda-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "尾道・しまなみ海道・千光寺山の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月下旬（千光寺公園もみじ紅葉・尾道水道夕景・秋の瀬戸内真鯛・瀬戸田レモン収穫）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の尾道・しまなみ海道・千光寺山旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の尾道・しまなみ海道・千光寺山は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月下旬〜11月下旬（千光寺公園もみじ紅葉・尾道水道夕景・秋の瀬戸内真鯛・瀬戸田レモン収穫）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">広島・尾道＆しまなみ海道特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の尾道・しまなみ海道・千光寺山の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              広島県を代表する景勝地・温泉地である尾道・しまなみ海道・千光寺山は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月下旬〜11月下旬（千光寺公園もみじ紅葉・尾道水道夕景・秋の瀬戸内真鯛・瀬戸田レモン収穫）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の尾道・しまなみ海道・千光寺山を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">おのみちぎえすとはうす みはらしてい</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">尾道ゲストハウス　みはらし亭</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.75 <span className="text-xs text-stone-500 font-normal">(20件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥4,050〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                千光寺へ続く石段坂道の中腹に建つ、築百年の国登録有形文化財（旧茶園）を再生した絶景ゲストハウス。尾道水道と尾道の街並みを一望する息をのむ大パノラマが自慢。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">近隣天然温泉施設利用可能（尾道みなと館等） / 展望テラス・絶景カフェバー併設</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">尾道水道を眺めながらいただくモーニングセット、地元ロースターのハンドドリップ珈琲、瀬戸内レモンスイーツ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">登録有形文化財の伝統建築から眺める朝焼けと夕景。坂の街・尾道の情緒を最も色濃く体感できる特別な滞在空間。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR山陽本線「尾道駅」より徒歩約15分（千光寺山ロープウェイ山麓駅より石段を徒歩約10分）</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F165878%2F165878.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">おのみちやすらぎのやど しーそー</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">尾道やすらぎの宿　しーそー</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.75 <span className="text-xs text-stone-500 font-normal">(91件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥5,400〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                尾道水道の対岸・向島に佇み、全室から尾道の街並みと夜景を一望できるオーシャンフロントの隠れ宿。瀬戸内の新鮮魚介を使った創作和食が絶賛される宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">展望風呂（尾道水道を一望） / 効能：疲労回復、リフレッシュ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">瀬戸内海の旬魚お造り盛り合わせ、真鯛の荒焚き、広島牛の陶板焼き、瀬戸田レモンポーク鍋、地酒ペアリング</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">渡船でわずか数分でアクセスできる非日常のリゾート空間。夜にはライトアップされた尾道水道の夜景を目の前に眺めながら贅沢なディナー。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">尾道駅前桟橋より渡船で約5分、下船後徒歩約5分 / 西瀬戸自動車道「向島IC」より車で約10分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F166267%2F166267.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">てんねんおんせんうらゆ りょかんうらしま</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">天然温泉うら湯　旅館浦島＜広島県＞</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.17 <span className="text-xs text-stone-500 font-normal">(325件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥5,060〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                尾道・三原エリアで珍しい自家源泉の天然温泉「うら湯」をたたえる純和風温泉旅館。とろりとした肌触りの良泉と、瀬戸内の新鮮な魚介会席が好評。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">単純弱放射能冷鉱泉（天然ラドン温泉・自家源泉うら湯） / 大浴場・露天風呂・サウナ / 効能：神経痛、筋肉痛、冷え性、五十肩、関節痛、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">瀬戸内産天然真鯛の薄造り、タコの天ぷら、広島県産ブランド豚のしゃぶしゃぶ、穴子ご飯、三原名物料理</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">身体の芯まで温まる良質な天然ラドン温泉。尾道観光やしまなみ海道サイクリングの疲れをじっくり癒やす隠れ家。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR尾道駅より車で約15分 / JR山陽本線「東尾道駅」より車で約5分 / 山陽道「尾道IC」より車で約15分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F52248%2F52248.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月下旬〜11月下旬（千光寺公園もみじ紅葉・尾道水道夕景・秋の瀬戸内真鯛・瀬戸田レモン収穫））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
