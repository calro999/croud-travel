...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の山形・庄内秋旅！出羽三山・羽黒山の国宝五重塔と黄金に染まる2446段の石段杉並木、日本海に沈む夕日が絶景の湯野浜温泉、新米つや姫や庄内豚を味わうふるさと納税トラベルガイド。',
    url: 'https://croud-travel.com/furusato-tax-hagurosan-yunohama-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "羽黒山杉並木紅葉と湯野浜温泉の夕日！秋の庄内味覚（新米つや姫・寒鱈・庄内豚）と開運温泉旅",
    "description": "10月・11月の山形・庄内秋旅！出羽三山・羽黒山の国宝五重塔と黄金に染まる2446段の石段杉並木、日本海に沈む夕日が絶景の湯野浜温泉、新米つや姫や庄内豚を味わうふるさと納税トラベルガイド。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-hagurosan-yunohama-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "鶴岡・羽黒山・湯野浜温泉の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月下旬（羽黒山の石段杉並木紅葉と日本海の秋夕日、新米・秋の日本海海鮮）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の鶴岡・羽黒山・湯野浜温泉旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の鶴岡・羽黒山・湯野浜温泉は昼夜の寒暖差が激しくなります。日中は長袖シャツで快適ですが、早朝や夕暮れの散策・露天風呂への移動時には防寒アウター（フリースやダウン等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月中旬〜11月下旬（羽黒山の石段杉並木紅葉と日本海の秋夕日、新米・秋の日本海海鮮）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">山形・羽黒山＆湯野浜温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の鶴岡・羽黒山・湯野浜温泉の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              山形県を代表する景勝地・温泉地である鶴岡・羽黒山・湯野浜温泉は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月中旬〜11月下旬（羽黒山の石段杉並木紅葉と日本海の秋夕日、新米・秋の日本海海鮮）</li>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">ゆのはまおんせん ゆうすいてい いさごや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">湯野浜温泉　游水亭　いさごや</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.38 <span className="text-xs text-stone-500 font-normal">(710件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥15,488〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                日本海を一望する浜辺に佇む、数寄屋造りの粋を集めた老舗温泉旅館。夕陽と波音に抱かれる展望露天風呂と、庄内の海の幸・山の幸を極めた本格懐石が絶賛される極上宿。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉（高温泉） / 展望露天風呂・大浴場・貸切風呂 / 効能：きりきず、やけど、慢性皮膚病、虚弱児童、慢性婦人病、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">庄内浜獲れたて地魚のお造り、山形牛のサーロインステーキ、新米つや姫の釜炊きご飯、庄内豚の角煮、秋の紅ズワイガニ会席</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">茜色に染まる日本海のサンセットを露天風呂から眺める贅沢。羽黒山参拝後の疲れをじんわり解きほぐす、きめ細やかなおもてなし。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR羽越本線「鶴岡駅」より路線バスで約40分（無料送迎あり要予約） / 山形自動車道「鶴岡IC」より車で約15分 / 庄内空港より車で約10分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">ゆのはまおんせん たけやほてる</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">湯野浜温泉　竹屋ホテル（鶴岡・酒田）</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 3.75 <span className="text-xs text-stone-500 font-normal">(476件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                全客室から日本海のオーシャンビューを誇る海辺の湯宿。開湯千年の湯野浜の源泉を引き込む展望風呂と、庄内浜直送の新鮮魚介を堪能できる会席料理が好評。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉 / 展望大浴場・露天風呂 / 効能：神経痛、筋肉痛、関節痛、五十肩、冷え性、病後回復期、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">庄内浜地魚のお刺身舟盛り、山形県産豚のしゃぶしゃぶ、秋の日本海海鮮寄せ鍋、山形ブランド米の炊き込みご飯</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">波打ち際まで徒歩すぐの絶好の立地。波の音をBGMに湯浴みを楽しみ、手頃な料金設定で庄内の秋の味覚を心ゆくまで味わえます。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">鶴岡駅よりバスで約35分 / 鶴岡ICより車で約20分 / 庄内空港より車で約10分（事前予約で送迎対応可）</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F53414%2F53414.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">ゆのはまおんせん げんせんつききゃくしつ ひんせんそう</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">湯野浜温泉　源泉付客室　浜泉荘</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4 <span className="text-xs text-stone-500 font-normal">(88件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                全室に天然温泉の内湯または半露天風呂を備えた、湯治情緒あふれる大人の隠れ宿。源泉100%を気兼ねなく楽しめ、地元の温かい郷土料理でもてなす人気宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物泉（自家源泉かけ流し） / 客室専用源泉風呂・大浴場 / 効能：冷え性、切り傷、慢性関節痛、美肌効果、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">庄内浜の旬魚焼き魚御膳、山形名物芋煮鍋、季節の山菜小鉢、鶴岡産コシヒカリ、手作り郷土のおばんざい</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">客室で24時間好きな時に名湯を満喫できるプライベート空間。羽黒山のロングトレイル後の湯治泊やワーケーションにも最適。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR鶴岡駅より湯野浜温泉行きバスで約40分「湯野浜温泉下車」徒歩約3分 / 日本海東北自動車道「庄内空港IC」より車で約10分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F31365%2F31365.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月中旬〜11月下旬（羽黒山の石段杉並木紅葉と日本海の秋夕日、新米・秋の日本海海鮮））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
