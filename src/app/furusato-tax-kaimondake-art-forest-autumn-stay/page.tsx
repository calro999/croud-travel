...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の鹿児島・指宿＆霧島特集！薩摩半島にそびえる開聞岳（薩摩富士）と黄金色に輝くススキ野原、世界的に珍しい指宿の天然砂むし温泉、霧島アートの森の現代アート紅葉散策、鹿児島黒豚・黒牛をふるさと納税で味わう旅。',
    url: 'https://croud-travel.com/furusato-tax-kaimondake-art-forest-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "薩摩富士・開聞岳の黄金ススキと指宿温泉砂むし！霧島アートの森紅葉と鹿児島黒豚・黒牛を味わう秋旅",
    "description": "10月・11月の鹿児島・指宿＆霧島特集！薩摩半島にそびえる開聞岳（薩摩富士）と黄金色に輝くススキ野原、世界的に珍しい指宿の天然砂むし温泉、霧島アートの森の現代アート紅葉散策、鹿児島黒豚・黒牛をふるさと納税で味わう旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-kaimondake-art-forest-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "指宿・開聞岳・霧島アートの森の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月〜11月（開聞岳山麓のススキと秋空、指宿砂むし温泉、霧島高原の紅葉と野外彫刻、黒豚・鹿児島黒牛・さつま芋）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の指宿・開聞岳・霧島アートの森旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の指宿・開聞岳・霧島アートの森は昼夜の寒暖差が激しくなります。日中は長袖シャツで快適ですが、早朝や夕暮れの散策・露天風呂への移動時には防寒アウター（フリースやダウン等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月〜11月（開聞岳山麓のススキと秋空、指宿砂むし温泉、霧島高原の紅葉と野外彫刻、黒豚・鹿児島黒牛・さつま芋）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">鹿児島・指宿温泉＆開聞岳特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の指宿・開聞岳・霧島アートの森の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              鹿児島県を代表する景勝地・温泉地である指宿・開聞岳・霧島アートの森は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月〜11月（開聞岳山麓のススキと秋空、指宿砂むし温泉、霧島高原の紅葉と野外彫刻、黒豚・鹿児島黒牛・さつま芋）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の指宿・開聞岳・霧島アートの森を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">いぶすきおんせん いぶすきろいやるほてる</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">指宿温泉　指宿ロイヤルホテル　～すべての女性へ美と健康を楽しむホテル～</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.49 <span className="text-xs text-stone-500 font-normal">(1620件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥12,650〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                錦江湾の高台に建ち、大隅半島と開聞岳の絶景を見晴らすオーシャンビューリゾート。美肌成分メタケイ酸を豊富に含む天然温泉と、鹿児島黒豚や黒牛の美食が自慢。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">塩化物泉（高濃度メタケイ酸配合の美肌温泉） / 絶景展望露天風呂・大浴場 / 効能：美肌効果、切り傷、冷え性、疲労回復、神経痛、筋肉痛</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">鹿児島県産黒豚のしゃぶしゃぶ会席、鹿児島黒牛の溶岩焼きステーキ、錦江湾獲れたて鮮魚のお造り、さつま揚げ、芋焼酎</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">海を見渡す絶景露天風呂から望む朝日の美しさは圧巻。ヨガ体験やハーブティーバーなど、美と健康をテーマにした癒やしのおもてなし。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR指宿枕崎線「指宿駅」よりタクシーで約7分（無料送迎あり要予約） / 指宿スカイライン「谷山IC」より車で約50分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F10832%2F10832.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">いぶすきおんせん いぶすきしゅうすいえん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">指宿温泉　いぶすき秀水園</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.67 <span className="text-xs text-stone-500 font-normal">(536件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥25,300〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                全国のプロが選ぶ日本のホテル・旅館100選「料理部門」で長年上位に輝く指宿の名門純和風旅館。枯山水の名園と、一皿一皿に技が光る極上会席、源泉かけ流しの名湯。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム-塩化物温泉（高温泉） / 露天風呂「離れの湯」・大浴場・足湯 / 効能：神経痛、五十肩、冷え性、疲労回復、慢性婦人病、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">料理部門受賞の特選会席「薩摩美味づくし」、鹿児島黒牛の石焼き、黒豚のやわらか煮、季節の地魚会席、さつま芋ご飯</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">砂むし会館「砂楽」まで徒歩約3分の好立地。枯山水の日本庭園を眺めながらいただく最高峰の料理と、心温まるきめ細やかな仲居のおもてなし。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR指宿駅より車で約5分（無料送迎あり） / 鹿児島空港より連絡バスで約95分 / 谷山ICより車で約50分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">いぶすきおんせん いぶすきこころのやど</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">指宿温泉　指宿こころの宿</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.13 <span className="text-xs text-stone-500 font-normal">(875件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                指宿の自然に囲まれた癒やしの温泉宿。隣接する温浴施設「こころの湯」で多彩なお風呂や岩盤浴を満喫でき、地元の旬食材を使った郷土料理が好評。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム-塩化物温泉 / 多彩な大浴場・露天風呂・泥パック・炭酸泉・サウナ / 効能：冷え性、疲労回復、関節痛、神経痛、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">鹿児島黒豚のせいろ蒸し御膳、さつま地鶏のたたき、きびなごのお刺身、手作りさつま揚げ、地元産野菜の天ぷら</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">指宿の天然温泉を多彩な湯船で楽しめる温浴リゾート。開聞岳登山や長崎鼻観光の拠点として、アクティブ派にもリラックス派にも最適。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR指宿駅より車で約10分（事前予約で送迎あり） / 谷山ICより産業道路経由で車で約45分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月〜11月（開聞岳山麓のススキと秋空、指宿砂むし温泉、霧島高原の紅葉と野外彫刻、黒豚・鹿児島黒牛・さつま芋））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
