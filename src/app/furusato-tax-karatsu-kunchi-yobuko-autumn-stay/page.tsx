...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '11月2日〜4日に豪華絢爛な曳山が巡行する「唐津くんち」。呼子名物の透明な活きイカ姿造りと最高峰の佐賀牛・伊万里牛、唐津湾を一望する天然温泉をふるさと納税で堪能する秋の佐賀・北松浦旅。',
    url: 'https://croud-travel.com/furusato-tax-karatsu-kunchi-yobuko-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "唐津くんち（11月国重要無形民俗文化財）の熱気と呼子イカ・唐津湾オーシャンビュー温泉",
    "description": "11月2日〜4日に豪華絢爛な曳山が巡行する「唐津くんち」。呼子名物の透明な活きイカ姿造りと最高峰の佐賀牛・伊万里牛、唐津湾を一望する天然温泉をふるさと納税で堪能する秋の佐賀・北松浦旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-karatsu-kunchi-yobuko-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "唐津・呼子・唐津湾の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年11月上旬の唐津くんち秋祭りと玄界灘の旬魚・呼子活イカが見頃のピークとなります。山々や街並みの美しい秋景色とともに、旬を迎える地場食材を存分にお楽しみいただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の唐津・呼子・唐津湾旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の唐津・呼子・唐津湾は朝夕の寒暖差が大きくなります。日中は快適な服装で問題ありませんが、朝夕の散策や露天風呂への移動時には防寒着（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：11月上旬の唐津くんち秋祭りと玄界灘の旬魚・呼子活イカ</span>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-amber-950 border-b-2 border-amber-600 pb-3 mb-6">
            はじめに：秋の唐津・呼子・唐津湾で味わう絶景と至高の温泉時間
          </h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            10月から11月にかけての佐賀県・唐津・呼子・唐津湾は、豊かな自然美と歴史情緒が鮮やかに交差する特別なシーズンを迎えます。澄んだ秋空の下、山肌や街並みが織りなす錦秋のパノラマは息をのむ美しさで、訪れる人々を魅了してやみません。
          </p>
          <p className="text-slate-700 leading-relaxed mb-4">
            心地よい秋風を感じながら名所を巡ったあとは、名湯に身を浸して日々の喧騒を忘れ、夜には秋の実りを凝縮した贅沢な郷土会席に舌鼓を打つ――これこそが大人の旅にふさわしい至高の贅沢です。
          </p>
          <p className="text-slate-700 leading-relaxed">
            本記事では、唐津・呼子・唐津湾エリアで高い評価を誇るおすすめの名宿3選を徹底解説します。楽天ふるさと納税の宿泊クーポンを活用すれば、実質自己負担わずか2,000円で憧れの高級旅館や温泉宿にお得に宿泊可能です。秋の特別な旅行プランをぜひご検討ください。
          </p>
        </section>
        ...
        <section className="bg-amber-50 rounded-2xl p-6 sm:p-8 border border-amber-200 mb-12">
          <h3 className="text-lg sm:text-xl font-bold text-amber-900 mb-4 flex items-center gap-2">
            <span>🍁</span> 唐津・呼子・唐津湾 秋旅の3大魅力ポイント
          </h3>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">唐津シーサイドホテル</h3>
              <p className="text-xs text-slate-500">からつしーさいどほてる</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.59点 <span className="text-xs font-normal text-slate-600">(2468件)</span>
            </div>
          </div>
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  日本三大松原「虹の松原」と唐津湾に隣接する最高峰オーシャンフロント温泉リゾート。海と一体化するインフィニティ露天風呂と、極上佐賀牛・呼子イカ会席。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  唐津温泉（ナトリウム-塩化物強塩温泉） / インフィニティ露天風呂・スチームサウナ / 効能：美肌、保温効果、神経痛、筋肉痛、疲労回復
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR筑肥線「東唐津駅」より車で約3分（無料送迎あり） / 福岡空港・博多駅より車で約60分（西九州道経由）
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                呼子直送の透き通る活きイカ姿造り（後造り天ぷら付き）、最高級A5ランク佐賀牛ステーキ、玄界灘の旬魚お造り、唐津Qサバ
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                唐津湾を一望するインフィニティ露天風呂は言葉を失う美しさ。唐津くんちの熱気と呼子の極上イカを堪能する極上の佐賀リゾート。
              </p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">からつ温泉 かぐや姫の湯 旅館 綿屋</h3>
              <p className="text-xs text-slate-500">からつおんせん かぐやひめのゆ りょかん わたや</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 3.64点 <span className="text-xs font-normal text-slate-600">(282件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                ...
                alt="からつ温泉 かぐや姫の湯 旅館 綿屋の外観・温泉風景"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  創業明治9年、唐津城下町に佇む登録有形文化財の老舗純和風旅館。数寄屋造りの風情ある客室と、天然温泉「かぐや姫の湯」、伝統の玄海会席。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  ナトリウム・カルシウム-塩化物・炭酸水素塩温泉 / 檜風呂・岩風呂 / 効能：冷え性、皮膚病、神経痛、疲労回復、美肌
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR唐津駅より徒歩約15分（車で約4分・送迎あり要連絡） / 多久ICより車で約40分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                呼子活イカ会席、極上佐賀牛しゃぶしゃぶ、玄界灘天然真鯛の荒炊き、唐津の郷土料理と佐賀の銘酒
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                唐津くんちの舞台となる唐津神社や城下町散策に絶好の立地。歴史ある日本建築のぬくもりと細やかなもてなしに心が和みます。
              </p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">嬉野温泉 和多屋別荘</h3>
              <p className="text-xs text-slate-500">うれしのおんせん わたやべっそう</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.14点 <span className="text-xs font-normal text-slate-600">(1334件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  日本三大美肌の湯・嬉野温泉を代表する二万坪の広大な敷地を誇る老舗温泉リゾート。嬉野川沿いに広がる日本庭園と、とろとろの美肌名湯、佐賀牛会席。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  ナトリウム-炭酸水素塩・塩化物温泉（日本三大美肌の湯） / 源泉かけ流し大浴場・露天風呂 / 効能：美肌（角質軟化・美白）、神経痛、リウマチ、胃腸病
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：西九州新幹線「嬉野温泉駅」より車で約5分 / 長崎道「嬉野IC」より車で約5分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                名物「嬉野温泉どうふ」、特選佐賀牛のセイロ蒸し・すき焼き、有明海の海鮮、嬉野茶を使った特製デザート
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                化粧水のようなとろとろの温泉に浸かり、嬉野川のせせらぎを聞く至福の時間。唐津くんちや呼子観光とあわせた佐賀周遊に最適。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D40527"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
        ...
        <section className="bg-gradient-to-br from-stone-900 to-amber-950 text-white rounded-2xl p-6 sm:p-8 shadow-lg mb-12">
          ...
          <p className="text-stone-200 text-sm sm:text-base leading-relaxed mb-6">
            楽天ふるさと納税を利用すれば、佐賀県内の対象宿泊施設で使える楽天トラベルクーポンが寄付額に応じて返礼品として付与されます。実質負担2,000円で高級宿に泊まれるお得な活用法をチェックしましょう。
          </p>
          ...
          <div className="space-y-6">
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
                <span className="text-amber-600 font-bold">Q.</span> 唐津・呼子・唐津湾の秋の見頃時期はいつですか？
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                例年11月上旬の唐津くんち秋祭りと玄界灘の旬魚・呼子活イカが見頃となります。標高差や気候に合わせて色づきが移り変わり、長期間にわたって楽しめます。
              </p>
            </div>
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                10月〜11月の唐津・呼子・唐津湾は朝夕の冷え込みが予想されます。日中は薄手のアウターで快適ですが、早朝や夜間、散策時には厚手のフリースやジャケット、歩きやすい靴をご用意ください。
              </p>
            </div>
          </div>
        </section>
