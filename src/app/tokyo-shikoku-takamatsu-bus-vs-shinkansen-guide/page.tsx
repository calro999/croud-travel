...
export const metadata: Metadata = {
  ...
  keywords: ["tokyo-shikoku-takamatsu-bus-vs-shinkansen-guide", "高速バス", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["tokyo-shikoku-takamatsu-bus-vs-shinkansen-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for tokyo-shikoku-takamatsu-bus-vs-shinkansen-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "06:45",
        "title": "高松駅高速バスターミナル到着＆駅前レンタサイクル",
        "desc": "夜行バスを降りてすぐに駅前地下のレンタサイクルポートへ。"
      },
      {
        "time": "07:15",
        "title": "1軒目：早朝営業の老舗「うどんバカ一代」で名物釜バターうどん",
        "desc": "熱々の釜揚げ麺にバターと粗挽き黒胡椒、生卵を絡める絶品カルボナーラ風うどん。"
      },
      {
        "time": "09:30",
        "title": "国の特別名勝・日本一の庭園美「栗林公園（りつりんこうえん）」",
        "desc": "ミシュラン・グリーンガイド三つ星。「一歩一景」の美しい大名庭園を歩き、掬月亭でお抹茶。"
      },
      {
        "time": "12:00",
        "title": "2軒目：「竹清（ちくせい）」で揚げたて半熟卵天うどんランチ",
        "desc": "注文を受けてから揚げるサクサクの半熟卵天とちくわ天をセルフうどんにトッピング。"
      },
      {
        "time": "15:30",
        "title": "高松駅前・瓦町の天然温泉付きホテルチェックイン",
        "desc": "夜行バスと自転車移動の疲れを天然温泉大浴場でじっくり癒やす。"
      },
      {
        "time": "18:30",
        "title": "高松名物「骨付鳥 一鶴（いっかく）」＆香川の地酒「金陵」",
        "desc": "スパイシーな特製スパイスで焼き上げたパリパリ皮のおやどり・ひなどりと生ビール。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "08:30",
        "title": "レトロな高松琴平電気鉄道（ことでん）で琴平へ",
        "desc": "ことちゃん電車に揺られて約1時間で琴電琴平駅へ。"
      },
      {
        "time": "09:45",
        "title": "785段の石段を登る「金刀比羅宮」参拝＆資生堂パーラー神椿",
        "desc": "海の神様こんぴらさんへお参り。500段目のカフェ神椿で特製パフェ休憩。"
      },
      {
        "time": "13:00",
        "title": "琴平参道で3軒目：「こんぴらうどん」しょうゆうどんランチ",
        "desc": "すだちと特製だし醤油でシンプルに小麦の香りを味わう極上の一杯。"
      },
      {
        "time": "15:30",
        "title": "高松駅ビルでお土産購入（讃岐うどん生麺・和三盆糖・オリーブオイル）",
        "desc": "お土産用うどんセットや「名物かまど」「灸まん」を購入。"
      },
      {
        "time": "17:00",
        "title": "帰路（夜行バスまたは新幹線で東京へ）",
        "desc": "讃岐うどんの余韻に浸りながら東京へ帰還。"
      }
    ]
  }
];
