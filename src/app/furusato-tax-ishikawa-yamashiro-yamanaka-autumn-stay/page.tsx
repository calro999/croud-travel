...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の石川・加賀山代温泉特集！明治時代の総湯を復元した「古総湯」のステンドグラスと九谷焼タイルの美、薬王院温泉寺の紅葉、ゆのくに天祥の多彩な自家源泉三湯めぐり、11月6日解禁の加能ガニ（越前・松葉ガニ）や橋立港直送の寒魚をふるさと納税トラベルで味わう贅沢プラン。',
    url: 'https://croud-travel.com/furusato-tax-ishikawa-yamashiro-yamanaka-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-ishikawa-yamashiro-yamanaka-autumn-stay"
  };
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 石川・加賀山代温泉の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月下旬〜11月下旬（山代温泉紅葉・加能ガニ初競り・寒ブリ）（薬王院温泉寺紅葉ライトアップ・鶴仙渓紅葉散策・11月加能ガニ解禁）が見頃のピークとなります。山々や渓谷・海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 石川・加賀山代温泉へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
