...
export const metadata: Metadata = {
  ...
  keywords: ["tokyo-sendai-bus-vs-shinkansen-guide", "高速バス", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["tokyo-sendai-bus-vs-shinkansen-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for tokyo-sendai-bus-vs-shinkansen-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "06:30",
        "title": "仙台駅東口到着＆駅ナカモーニング",
        "desc": "夜行バスで早朝到着。駅ナカのカフェで仙台名物「ずんだシェイク」や朝食セットでリフレッシュ。"
      },
      {
        "time": "09:00",
        "title": "日本三景「松島」へ仙石線で移動＆松島湾遊覧船",
        "desc": "仙台駅から約40分で松島海岸駅へ。260余りの島々が浮かぶ松島湾を大型遊覧船から一望。"
      },
      {
        "time": "11:30",
        "title": "国宝・瑞巌寺参拝＆焼き牡蠣食べ歩き",
        "desc": "伊達政宗公が建立した名刹「瑞巌寺」。参道周辺で香ばしい焼き牡蠣や笹かまの手焼き体験。"
      },
      {
        "time": "14:30",
        "title": "仙台駅へ戻り本場の「極厚熟成牛たん定食」",
        "desc": "「司」「善治郎」「利久」などの名店で、炭火で香ばしく焼き上げた極厚牛たんとテールスープ。"
      },
      {
        "time": "16:30",
        "title": "仙台駅西口ホテルチェックイン＆大浴場",
        "desc": "駅徒歩数分の天然温泉付きホテルでゆったり旅の疲れを癒やす。"
      },
      {
        "time": "19:00",
        "title": "壱弐参（いろは）横丁・国分町で三陸海の幸と宮城の地酒",
        "desc": "レトロな横丁で三陸の金華サバやホヤ、宮城の銘酒「伯楽星」「浦霞」を味わう。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "09:30",
        "title": "仙台城跡（青葉城）＆伊達政宗公騎馬像",
        "desc": "るーぷる仙台バスで仙台城跡へ。仙台市内を一望できるビュースポットで記念撮影。"
      },
      {
        "time": "12:00",
        "title": "定禅寺通のケヤキ並木散歩＆おしゃれカフェランチ",
        "desc": "杜の都を象徴する美しいケヤキ並木を歩き、メディアテーク近くのカフェでランチ。"
      },
      {
        "time": "14:30",
        "title": "仙台駅「エスパル仙台」でお土産ショッピング",
        "desc": "「萩の月」「生ずんだ餅」「笹かまぼこ」など仙台を代表する銘菓を購入。"
      },
      {
        "time": "16:00",
        "title": "帰路（昼行高速バスまたは新幹線で東京へ）",
        "desc": "高速バスまたは新幹線に乗車。車内で駅弁を楽しみながら東京へ帰還。"
      }
    ]
  }
];
