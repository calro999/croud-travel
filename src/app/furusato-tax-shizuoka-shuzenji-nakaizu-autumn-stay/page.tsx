...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の静岡・修善寺＆中伊豆特集！弘法大師開湯1200年の歴史を誇る伊豆最古の温泉街、桂川沿いの「竹林の小径」と修禅寺境内の燃えるような紅葉ライトアップ、歴史ある名宿の湯回廊、天城軍鶏や極上伊豆牛をふるさと納税トラベルクーポンでお得に堪能する大人の秋旅。',
    url: 'https://croud-travel.com/furusato-tax-shizuoka-shuzenji-nakaizu-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "静岡・伊豆最古の名湯 修善寺温泉と竹林の小径紅葉！歴史の湯回廊と極上伊豆牛・天城軍鶏",
    "description": "10月・11月の静岡・修善寺＆中伊豆特集！弘法大師開湯1200年の歴史を誇る伊豆最古の温泉街、桂川沿いの「竹林の小径」と修禅寺境内の燃えるような紅葉ライトアップ、歴史ある名宿の湯回廊、天城軍鶏や極上伊豆牛をふるさと納税トラベルクーポンでお得に堪能する大人の秋旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-shizuoka-shuzenji-nakaizu-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "静岡・修善寺温泉＆中伊豆の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年11月中旬〜12月上旬（伊豆随一のもみじ林・秋晴れの富士山眺望）（修禅寺庭園特別公開・竹林の小径紅葉ライトアップ・修善寺自然公園もみじ林）が見頃のピークとなります。山々や渓谷・海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "静岡・修善寺温泉＆中伊豆へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 静岡・修善寺温泉＆中伊豆</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 11月中旬〜12月上旬（伊豆随一のもみじ林・秋晴れの富士山眺望）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の静岡・修善寺温泉＆中伊豆を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が心地よく吹き抜け、木々が鮮やかに色づく10月・11月。日本各地がもっとも美しく、実り豊かな季節を迎えます。なかでも「静岡・修善寺温泉＆中伊豆」は、修禅寺庭園特別公開・竹林の小径紅葉ライトアップ・修善寺自然公園もみじ林など、この時期にしか出逢えない息を呑む絶景と旬の味覚が凝縮された屈指の名所です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>竹林の小径（桂川沿いの散策路）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>修禅寺（弘法大師創建の名刹）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>修善寺自然公園もみじ林</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>虹の郷（紅葉ライトアップ）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>独鈷の湯（とっこのゆ）</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                天城軍鶏（しゃも）鍋・伊豆牛ステーキ・生わさび一本付き海鮮丼・ズガニ汁・修善寺そば
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                修善寺温泉（アルカリ性単純温泉・肌にしっとり馴染む名湯）と桂川のせせらぎを望む露天風呂
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">静岡県伊豆市修善寺874-1</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 伊豆箱根鉄道 修善寺駅よりバス約８分※送迎無し／東名高速 沼津ICから国道１号線、国道１３６号線 伊豆中央道経由約３５分</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥21,230〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F7491%2F7491.html"
              target="_blank"
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">静岡県伊豆市修善寺860</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.34
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 伊豆箱根鉄道修善寺駅よりタクシーで８分。</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥13,100〜</p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">静岡県伊豆市大平1529</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.09
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/160836/160836.jpg"
                alt="伊豆マリオットホテル修善寺"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="space-y-3">
              <h4 className="font-bold text-stone-900 text-sm">宿の魅力と秋の過ごし方</h4>
              <p className="text-sm text-stone-700 leading-relaxed">
                富士や天城連山を望む絶景の地で特別な休日を。
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 伊豆縦貫道経由、天城北道路大平ICよりお車にて約15分　修善寺駅より定時運行の無料送迎バスにて約25分</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥11,434〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F160836%2F160836.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】静岡・修善寺温泉＆中伊豆を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、竹林の小径（桂川沿いの散策路）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（天城軍鶏（しゃも）鍋など）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 修禅寺（弘法大師創建の名刹）へ移動。午後の柔らかな木漏れ日の中で絶景撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、修善寺自然公園もみじ林を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - 虹の郷（紅葉ライトアップ）にてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 静岡・修善寺温泉＆中伊豆の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年11月中旬〜12月上旬（伊豆随一のもみじ林・秋晴れの富士山眺望）（修禅寺庭園特別公開・竹林の小径紅葉ライトアップ・修善寺自然公園もみじ林）が見頃のピークとなります。山々や渓谷・海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 静岡・修善寺温泉＆中伊豆へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
