...
export default function Page() {
  ...
  const hotels = [
  {
    ...
    "reviewCount": 915,
    "reviewAverage": 4,
    "userReview": "花火会場への好立地と充実したサービスが魅力越前市サマーフェスティバルのために宿泊しました。花火会場に行くには立地は最高でした。部屋などはよくあるビジネスホテルといった感じで良くも悪くもなく…　2026-08-16 23:55:34投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=6113\" class=\"3click\">つづきはこちら</a>",
    "hotelMinCharge": 4400,
    "address1": "福井県",
    "address2": "越前市府中1-2-3",
