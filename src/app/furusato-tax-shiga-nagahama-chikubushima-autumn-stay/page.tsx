...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の滋賀・長浜＆北びわ湖特集！琵琶湖に浮かぶ神の島「竹生島（宝厳寺・都久夫須麻神社）」の秋クルーズ、秀吉公ゆかりの長浜城（豊公園）の紅葉、太閤秀吉が開湯した赤茶色の名湯「長浜太閤温泉」、認証近江牛や秋解禁の天然鴨鍋をふるさと納税トラベルで味わう湖北の秋旅。',
    url: 'https://croud-travel.com/furusato-tax-shiga-nagahama-chikubushima-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "滋賀・北びわ湖 長浜城下町の紅葉とパワースポット竹生島！長浜太閤温泉＆近江牛・鴨鍋",
    "description": "10月・11月の滋賀・長浜＆北びわ湖特集！琵琶湖に浮かぶ神の島「竹生島（宝厳寺・都久夫須麻神社）」の秋クルーズ、秀吉公ゆかりの長浜城（豊公園）の紅葉、太閤秀吉が開湯した赤茶色の名湯「長浜太閤温泉」、認証近江牛や秋解禁の天然鴨鍋をふるさと納税トラベルで味わう湖北の秋旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-shiga-nagahama-chikubushima-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "滋賀・長浜＆北びわ湖・竹生島の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月下旬（竹生島紅葉・長浜城紅葉ピーク・新米近江米）（竹生島紅葉クルーズ・豊公園長浜城紅葉ライトアップ・湖北の天然鴨鍋解禁）が見頃のピークとなります。山々や渓谷・城下町の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "滋賀・長浜＆北びわ湖・竹生島へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 滋賀・長浜＆北びわ湖・竹生島</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 10月下旬〜11月下旬（竹生島紅葉・長浜城紅葉ピーク・新米近江米）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の滋賀・長浜＆北びわ湖・竹生島を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が心地よく吹き抜け、木々が鮮やかに色づく10月・11月。日本各地がもっとも美しく、実り豊かな季節を迎えます。なかでも「滋賀・長浜＆北びわ湖・竹生島」は、竹生島紅葉クルーズ・豊公園長浜城紅葉ライトアップ・湖北の天然鴨鍋解禁など、この時期にしか出逢えない息を呑む絶景と旬の味覚が凝縮された屈指の名所です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>竹生島（琵琶湖汽船クルーズ・宝厳寺唐門）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>黒壁スクエア（黒壁ガラス館・レトロモダン街並み）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>長浜城歴史博物館・豊公園（琵琶湖畔の夕陽名所）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>鶏足寺（旧飯福寺・紅葉の参道敷きモミジ）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>余呉湖（鏡湖の秋景色）</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                特選近江牛ステーキ・しゃぶしゃぶ・秋解禁湖北名物天然鴨鍋・ビワマスのお造り・焼鯖そうめん
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                長浜太閤温泉＆須賀谷温泉（含鉄-ナトリウム-塩化物強塩泉、鉄分豊富な赤茶色の美肌・温まり湯）と琵琶湖一望露天風呂
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">滋賀県長浜市港町4-17</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/16047/16047.jpg"
                alt="北ビワコホテル　グラツィエ"
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> ＪＲ長浜駅西口より徒歩10分(土日祝日は西口よりシャトルバス運行※要連絡）北陸自動車道長浜ＩＣより15分</p>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F16047%2F16047.html"
              target="_blank"
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">滋賀県長浜市公園町4-25</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.77
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> ＪＲ長浜駅より徒歩５分／北陸自動車道長浜ＩＣより約１０分 無料駐車場</p>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">滋賀県長浜市須賀谷町36</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.33
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 北陸自動車道長浜ICより国道365経由約２０分（看板有り）／JR北陸本線河毛駅より無料送迎有り 無料駐車場</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥15,637〜</p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】滋賀・長浜＆北びわ湖・竹生島を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、竹生島（琵琶湖汽船クルーズ・宝厳寺唐門）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（特選近江牛ステーキなど）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 黒壁スクエア（黒壁ガラス館・レトロモダン街並み）へ移動。午後の柔らかな木漏れ日の中で絶景撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、長浜城歴史博物館・豊公園（琵琶湖畔の夕陽名所）を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - 鶏足寺（旧飯福寺・紅葉の参道敷きモミジ）にてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 滋賀・長浜＆北びわ湖・竹生島の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月下旬〜11月下旬（竹生島紅葉・長浜城紅葉ピーク・新米近江米）（竹生島紅葉クルーズ・豊公園長浜城紅葉ライトアップ・湖北の天然鴨鍋解禁）が見頃のピークとなります。山々や渓谷・城下町の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 滋賀・長浜＆北びわ湖・竹生島へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
