...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月〜11月に新酒ワインと実りの秋を迎える山形・南陽赤湯温泉。開湯920年の歴史ある源泉かけ流し美肌湯と、最高峰「米沢牛」ステーキ・すき焼き、地場ワイナリー巡りをふるさと納税でお得に楽しむ秋旅特集。',
    url: 'https://croud-travel.com/furusato-tax-akayu-wine-grape-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "山形ワイン＆ぶどうの郷「南陽・赤湯温泉」開湯920年の名湯と米沢牛ステーキ・ワイナリー巡り",
    "description": "10月〜11月に新酒ワインと実りの秋を迎える山形・南陽赤湯温泉。開湯920年の歴史ある源泉かけ流し美肌湯と、最高峰「米沢牛」ステーキ・すき焼き、地場ワイナリー巡りをふるさと納税でお得に楽しむ秋旅特集。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-akayu-wine-grape-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "南陽・赤湯温泉・高畠の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月〜11月のワイナリー新酒解禁と秋の実り・米沢牛グルメが見頃のピークとなります。山々や街並みの美しい秋景色とともに、旬を迎える地場食材を存分にお楽しみいただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の南陽・赤湯温泉・高畠旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の南陽・赤湯温泉・高畠は朝夕の冷え込みが強まります。日中は快適な服装で問題ありませんが、朝夕の散策や露天風呂への移動時には防寒着（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight mb-6">
            山形ワイン＆ぶどうの郷「南陽・赤湯温泉」開湯920年の名湯と米沢牛ステーキ・ワイナリー巡り
          </h1>
          <p className="text-base sm:text-lg text-amber-100 max-w-3xl leading-relaxed">
            東北最古のワイナリーが点在するぶどうの郷。開湯920年の名湯・赤湯温泉で極上米沢牛とワインに酔いしれる秋。
          </p>
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月〜11月のワイナリー新酒解禁と秋の実り・米沢牛グルメ</span>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-amber-950 border-b-2 border-amber-600 pb-3 mb-6">
            はじめに：秋の南陽・赤湯温泉・高畠で味わう絶景と至高の温泉時間
          </h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            10月から11月にかけての山形県・南陽・赤湯温泉・高畠は、豊かな自然美と歴史情緒が鮮やかに交差する特別なシーズンを迎えます。澄んだ秋空の下、山肌や街並みが織りなす錦秋のパノラマは息をのむ美しさで、訪れる人々を魅了してやみません。
          </p>
          <p className="text-slate-700 leading-relaxed mb-4">
            心地よい秋風を感じながら名所を巡ったあとは、名湯に身を浸して日々の喧騒を忘れ、夜には秋の実りを凝縮した贅沢な郷土会席に舌鼓を打つ――これこそが大人の旅にふさわしい至高の贅沢です。
          </p>
          <p className="text-slate-700 leading-relaxed">
            本記事では、南陽・赤湯温泉・高畠エリアで高い評価を誇るおすすめの名宿3選を徹底解説します。楽天ふるさと納税の宿泊クーポンを活用すれば、実質自己負担わずか2,000円で憧れの高級旅館や温泉宿にお得に宿泊可能です。秋の特別な旅行プランをぜひご検討ください。
          </p>
        </section>
        ...
        <section className="bg-amber-50 rounded-2xl p-6 sm:p-8 border border-amber-200 mb-12">
          <h3 className="text-lg sm:text-xl font-bold text-amber-900 mb-4 flex items-center gap-2">
            <span>🍁</span> 南陽・赤湯温泉・高畠 秋旅の3大魅力ポイント
          </h3>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">赤湯温泉 升形屋旅館</h3>
              <p className="text-xs text-slate-500">あかゆおんせん ますがたやりょかん</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.1点 <span className="text-xs font-normal text-slate-600">(470件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/5841/5841.jpg"
                alt="赤湯温泉 升形屋旅館の外観・温泉風景"
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  開湯920年の歴史を誇る赤湯温泉の中心に佇む老舗純和風旅館。源泉かけ流しの美肌名湯と、山形牛・米沢牛を贅沢に盛り込んだ郷土会席が人気。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  含硫黄-ナトリウム・カルシウム-塩化物温泉（弱アルカリ性源泉かけ流し） / 効能：神経痛、筋肉痛、冷え性、切り傷、慢性皮膚病、美肌効果
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR山形新幹線「赤湯駅」より車・タクシーで約5分（徒歩約20分） / 東北中央自動車道「南陽高畠IC」より車で約10分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                A5ランク米沢牛のすき焼き鍋会席、山形名物芋煮汁、地場産ラ・フランスやぶどうのデザート、山形ワイナリー直送ワイン
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                硫黄が香る柔らかなお湯で体の芯からポカポカに。南陽のワイナリー巡りやぶどう狩りの拠点として至福のステイを提供。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D5841"
              target="_blank"
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">赤湯温泉 大正ロマン香る癒しの宿 丹波館</h3>
              <p className="text-xs text-slate-500">あかゆおんせん たいしょうろまんかおるいやしのやど たんばかん</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.37点 <span className="text-xs font-normal text-slate-600">(282件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                ...
                alt="赤湯温泉 大正ロマン香る癒しの宿 丹波館の外観・温泉風景"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  大正ロマンの風情が色濃く残る、ステンドグラスとアンティーク調の落ち着いた温泉宿。2種類の源泉を引く良質な名湯と、米沢牛ステーキが評判。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  含硫黄-ナトリウム・カルシウム-塩化物温泉 / 総ヒノキ風呂・大浴場 / 効能：美肌、疲労回復、リウマチ、胃腸病、冷え性
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR赤湯駅よりタクシーで約5分 / 南陽高畠ICより車で約8分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                米沢牛のサーロインステーキ会席、山形県産つや姫の新米、旬のきのこ鍋、契約農家の朝採れ地場野菜小鉢
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                大正時代にタイムスリップしたようなノスタルジックな館内。心地よい湯守りの湯に浸かり、ワインと米沢牛に酔いしれる秋の夜長。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D14667"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">赤湯温泉 丹泉ホテル</h3>
              <p className="text-xs text-slate-500">あかゆおんせん たんせんほてる</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.17点 <span className="text-xs font-normal text-slate-600">(752件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/11034/11034.jpg"
                alt="赤湯温泉 丹泉ホテルの外観・温泉風景"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  赤湯温泉最大級の規模を誇る格式ある和風温泉ホテル。ローマ風大浴場や露天風呂、自家製手打ちそばと米沢牛の贅沢会席が自慢。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  含硫黄-ナトリウム・カルシウム-塩化物泉 / 露天風呂・大浴場「古代ローマ風呂」 / 効能：神経痛、関節痛、筋肉痛、冷え性、五十肩、美肌
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR赤湯駅より車で約5分（送迎あり要予約） / 山形空港より車で約60分 / 南陽高畠ICより車で約10分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                米沢牛のすき焼き・しゃぶしゃぶ・ステーキ選べる会席、名物手打ち十割そば、山形郷土料理、南陽産地ワイン
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                広々とした大浴場で名湯赤湯温泉を満喫。烏帽子山公園の紅葉散策やワイナリーへのアクセスも抜群の好立地。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D11034"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
          ...
          <div className="space-y-6">
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
                <span className="text-amber-600 font-bold">Q.</span> 南陽・赤湯温泉・高畠の秋の見頃時期はいつですか？
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                例年10月〜11月のワイナリー新酒解禁と秋の実り・米沢牛グルメが見頃となります。標高差や気候に合わせて色づきが移り変わり、長期間にわたって楽しめます。
              </p>
            </div>
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                10月〜11月の南陽・赤湯温泉・高畠は朝夕の冷え込みが予想されます。日中は薄手のアウターで快適ですが、早朝や夜間、散策時には厚手のフリースやジャケット、歩きやすい靴をご用意ください。
              </p>
            </div>
          </div>
        </section>
