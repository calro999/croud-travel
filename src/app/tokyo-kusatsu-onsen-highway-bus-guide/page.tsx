...
export const metadata: Metadata = {
  ...
  keywords: ["tokyo-kusatsu-onsen-highway-bus-guide", "高速バス", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["tokyo-kusatsu-onsen-highway-bus-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for tokyo-kusatsu-onsen-highway-bus-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "09:00",
        "title": "バスタ新宿から直行高速バス「ゆめぐり号」乗車",
        "desc": "乗換なしで車窓を眺めながらゆったり移動。途中上里SAなどで休憩。"
      },
      {
        "time": "13:00",
        "title": "草津温泉バスターミナル到着＆湯畑へ",
        "desc": "徒歩5分で草津のシンボル「湯畑」へ。湯けむりと硫黄の香りに包まれる感動の瞬間。"
      },
      {
        "time": "13:30",
        "title": "熱乃湯で伝統の「湯もみと踊りショー」見学",
        "desc": "草津節に合わせた迫力の湯もみショーを観覧。草津名物の温泉まんじゅう食べ歩き。"
      },
      {
        "time": "15:00",
        "title": "西の河原通り散策＆名旅館にチェックイン",
        "desc": "お土産屋が立ち並ぶ通りを抜け旅館へ。源泉かけ流しの名湯と夕食の上州牛に舌鼓。"
      },
      {
        "time": "20:00",
        "title": "湯畑の幻想的な夜間ライトアップ散歩",
        "desc": "緑や青に照らされる湯畑と立ち上る湯けむりの絶景ナイトウォーク。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "09:00",
        "title": "日本屈指の大露天風呂「西の河原露天風呂」",
        "desc": "圧倒的な開放感を誇る総面積500平方メートルの巨大露天風呂で森林浴温泉。"
      },
      {
        "time": "11:00",
        "title": "湯畑草庵の「足湯カフェ」で特製スイーツ",
        "desc": "足湯に浸かりながら地ビールや抹茶パフェを楽しむ癒やしのひととき。"
      },
      {
        "time": "12:30",
        "title": "名物「おっきりこみうどん」ランチ＆お土産購入",
        "desc": "群馬の郷土料理おっきりこみや、湯畑名物の湯の花、草津温泉ラスクをお買い物。"
      },
      {
        "time": "14:30",
        "title": "バスターミナルから直行バス乗車〜新宿・東京へ",
        "desc": "乗り換えなしで座ったまま爆睡。夕方18:30頃にバスタ新宿到着。"
      }
    ]
  }
];
