        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key="0" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              ...
              <h3 className="font-bold text-white text-lg mb-2">真夏も10度前後の別世界！迫力ある地底滝とイルミネーションライトアップ</h3>
              <p className="text-slate-400 text-sm leading-relaxed">猛暑を忘れさせる大自然の天然クーラーの中で、地球のダイナミズムを間近に体感。</p>
            </div>
            <div key="1" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                02
              </div>
              <h3 className="font-bold text-white text-lg mb-2">岡山千屋牛・福島銘柄豚・奥多摩わさびヤマメなど山麓の絶品ごちそう</h3>
              <p className="text-slate-400 text-sm leading-relaxed">鍾乳洞を生み出したミネラル豊富な清流水が育む最高峰の農畜産物と旬菜を堪能。</p>
            </div>
            <div key="2" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                03
              </div>
              <h3 className="font-bold text-white text-lg mb-2">楽天ふるさと納税宿泊クーポンで秘境の温泉リゾートをお得にリザーブ</h3>
              <p className="text-slate-400 text-sm leading-relaxed">ホテル華の湯やはとのす荘など人気宿の宿泊代金を即時控除し、実質2,000円負担で宿泊。</p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            ...
            <article key="0" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  岡山県新見市ふるさと納税：高さ50mの地底滝「井倉洞」と日本最古の蔓牛・新見グランドホテルみよしや
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  高梁川の断崖に穿たれた全長1,200mの巨大洞窟。地底の大滝や水簾観音の威容に驚嘆した後は、新見駅前の快適ホテル「グランドホテルみよしや」で、和牛のルーツ千屋牛ステーキと地酒三光正宗を満喫します。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/9151/9151.jpg"
                    alt="新見　グランドホテルみよしや"
                    fill
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-4 bg-slate-900/60 p-3.5 rounded-xl border border-slate-800/60">
                      新見駅に１番近く、岡山県新見市の中心にありビジネスにも観光にも　洋室はシモンズベッドにデュベスタイル
                    </p>
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F9151%2F9151.html"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <article key="1" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  福島県田村市ふるさと納税：三千万年の奇跡「あぶくま洞・滝根御殿」と三十種の湯舎・磐梯熱海温泉ホテル華の湯
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  東洋一の種類と数を誇る鍾乳石の回廊。幻想的なライトアップを楽しんだ後は、美肌の湯として名高い磐梯熱海温泉「ホテル華の湯」で、30種類の湯舎めぐりと福島牛・旬の創作ビュッフェを心ゆくまで堪能します。
                </p>
              </div>
            ...
            <article key="2" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  東京都奥多摩町ふるさと納税：関東随一のスケール「日原鍾乳洞」と鳩ノ巣渓谷を望む奥多摩の風はとのす荘
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  巨岩が連なる荘厳な日原鍾乳洞。神秘的な鍾乳石を巡った後は、鳩ノ巣渓谷沿いに佇むデザイナーズ温泉宿「奥多摩の風 はとのす荘」で、自家源泉の美肌温泉と奥多摩ヤマメ・本格イタリアンフルコースに癒やされます。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/148933/148933.jpg"
                    alt="奥多摩の風　はとのす荘"
                    fill
                    className="object-cover hover:scale-105 transition duration-500"
                    unoptimized
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F148933%2F148933.html"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
