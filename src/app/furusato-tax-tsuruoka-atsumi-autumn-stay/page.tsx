...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "あつみ温泉の湯けむりと温海川の鮭遡上！出羽の秋味覚（庄内柿・山形牛・日本海地魚）と老舗温泉街の秋旅",
    "description": "10月・11月の山形・鶴岡あつみ温泉特集！温海川沿いに広がる開湯千年の名湯、秋に川を力強く遡上する鮭の姿と朝市散策、日本海に沈む秋夕日、山形牛のすき焼きやすり身汁・庄内柿をふるさと納税トラベルで楽しむ風情豊かな湯治ステイ。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "鶴岡・あつみ温泉・温海川の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月〜11月（温海川の鮭遡上・あつみ温泉朝市・庄内柿・新米つや姫・山形牛会席）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の鶴岡・あつみ温泉・温海川旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の鶴岡・あつみ温泉・温海川は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月〜11月（温海川の鮭遡上・あつみ温泉朝市・庄内柿・新米つや姫・山形牛会席）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">山形・あつみ温泉＆鶴岡特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の鶴岡・あつみ温泉・温海川の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              山形県を代表する景勝地・温泉地である鶴岡・あつみ温泉・温海川は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月〜11月（温海川の鮭遡上・あつみ温泉朝市・庄内柿・新米つや姫・山形牛会席）</li>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">あつみおんせん たちばなや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">温海温泉　たちばなや</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.43 <span className="text-xs text-stone-500 font-normal">(1192件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥5,280〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                創業三百余年の歴史を誇るあつみ温泉の名門旅館。日本庭園を囲む雅な館内と、温海川のせせらぎを聞く露天風呂、山形牛や日本海の幸を極めた本格会席が評判。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物・硫酸塩温泉 / 庭園大浴場・露天風呂「月見の湯」・貸切風呂 / 効能：きりきず、やけど、慢性皮膚病、神経痛、冷え性、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">特選山形牛のすき焼き・ステーキ会席、日本海獲れたて地魚のお造り、新米つや姫、庄内豚の角煮、秋の味覚小鉢</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">錦鯉が泳ぐ池と美しい日本庭園を眺めながら過ごす優雅な休日。あつみ温泉街の足湯散策や温海川の鮭遡上見学にも最高の立地。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR羽越本線「あつみ温泉駅」より路線バスまたはタクシーで約5分（無料送迎あり要予約） / 日本海東北道「あつみ温泉IC」より車で約5分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F13821%2F13821.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">あつみおんせん ばんこくや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">温海温泉　萬国屋</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.59 <span className="text-xs text-stone-500 font-normal">(2668件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥11,000〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                プロが選ぶ日本のホテル・旅館100選に連続入選するあつみ温泉最高峰の大型旅館。自家源泉の多彩な湯殿と、山形・庄内の旬の山海の幸を尽くした極上会席が自慢。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物・硫酸塩温泉 / 庭園露天風呂「桃源の湯」・大浴場・サウナ / 効能：神経痛、筋肉痛、関節痛、五十肩、冷え性、美肌効果</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">山形牛のしゃぶしゃぶ会席、日本海産紅ズワイガニ、鮑の踊り焼き、庄内名物芋煮、鶴岡産コシヒカリ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">吹き抜けの優美なロビーと、木々の香りに包まれる広々とした露天風呂。細やかで行き届いたおもてなしで記念日や特別な旅行に最適。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">あつみ温泉駅より車で約5分（無料送迎バスあり） / あつみ温泉ICより車で約5分 / 庄内空港より車で約45分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F12577%2F12577.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">たかみやべってい くおん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">高見屋別邸　久遠　－ＫＵＯＮ－</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 3.91 <span className="text-xs text-stone-500 font-normal">(1294件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                老舗「高見屋グループ」が手掛けるモダンで洗練された大人の温泉リゾート。あつみ温泉の名湯を引くスタイリッシュな大浴場と、オープンキッチンで仕立てる創作会席が人気。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物・硫酸塩温泉 / 露天風呂・大浴場・シルク風呂 / 効能：疲労回復、健康増進、神経痛、筋肉痛、冷え性、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">山形牛の鉄板焼き会席、庄内浜直送旬魚のカルパッチョ、山形郷土料理バイキング朝食、地酒ペアリング</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">伝統とモダンが融合した落ち着きある客室空間。心地よいラウンジや足湯でリラックスし、自由で上質な温泉ステイを満喫。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JRあつみ温泉駅より送迎車で約5分 / あつみ温泉ICより車で約5分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F135915%2F135915.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月〜11月（温海川の鮭遡上・あつみ温泉朝市・庄内柿・新米つや姫・山形牛会席））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
