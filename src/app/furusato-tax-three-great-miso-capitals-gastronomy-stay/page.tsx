...
export default function Page() {
  ...
  const hotels = [
  {
    ...
    "reviewCount": 1937,
    "reviewAverage": 4.3,
    "userReview": "裏側の部屋からは湖が見えず残念な結果に紅やさんに泊まれると密かにワクワクして投宿わかっていたことですが湖畔のホテルですが裏側のお部屋からは湖は1ミリも見えませんなんだか残念感の残る結果に自…　 ",
  ...
  },
  {
    ...
    "reviewCount": 273,
    "reviewAverage": 3.95,
    "userReview": "駅チカで見つけやすく、中のアメニティも充実していました!豊スタにも行きやすくまた利用したいです。クチコミの詳細はこちらから　https://review.travel.rakuten.co.j…　 ",
