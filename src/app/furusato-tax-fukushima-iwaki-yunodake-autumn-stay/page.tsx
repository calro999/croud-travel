...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の福島・いわき湯本温泉特集！道後・有馬と並ぶ日本三古湯の一つ「いわき湯本温泉」の毎分5.5トンを誇る極上の硫黄泉、湯ノ岳パノラマラインの錦秋ドライブ、築地・豊洲でも最高評価を受ける「常磐もの（ヒラメ・メヒカリ・あんこう）」をふるさと納税トラベルで味わうみちのく名湯旅。',
    url: 'https://croud-travel.com/furusato-tax-fukushima-iwaki-yunodake-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "福島・日本三古湯 いわき湯本温泉と湯の岳パノラマ紅葉！毎分5.5トンの美肌名湯＆常磐もの海鮮会席",
    "description": "10月・11月の福島・いわき湯本温泉特集！道後・有馬と並ぶ日本三古湯の一つ「いわき湯本温泉」の毎分5.5トンを誇る極上の硫黄泉、湯ノ岳パノラマラインの錦秋ドライブ、築地・豊洲でも最高評価を受ける「常磐もの（ヒラメ・メヒカリ・あんこう）」をふるさと納税トラベルで味わうみちのく名湯旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-fukushima-iwaki-yunodake-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "福島・いわき湯本温泉＆湯の岳の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月下旬（白水阿弥陀堂紅葉ライトアップ・常磐ものヒラメ・アンコウ旬）（湯ノ岳パノラマライン紅葉ドライブ・国宝白水阿弥陀堂紅葉ライトアップ・秋の常磐もの旬）が見頃のピークとなります。山々や海岸・温泉街の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "福島・いわき湯本温泉＆湯の岳へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 福島・いわき湯本温泉＆湯の岳</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 10月下旬〜11月下旬（白水阿弥陀堂紅葉ライトアップ・常磐ものヒラメ・アンコウ旬）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の福島・いわき湯本温泉＆湯の岳を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が心地よく吹き抜け、山海の恵みが豊かに実る10月・11月。日本各地がもっとも美しく鮮やかな彩りに包まれる季節を迎えます。なかでも「福島・いわき湯本温泉＆湯の岳」は、湯ノ岳パノラマライン紅葉ドライブ・国宝白水阿弥陀堂紅葉ライトアップ・秋の常磐もの旬など、この時期にしか出逢えない息を呑む情景と極上の味覚が凝縮された屈指の旅先です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>国宝 白水阿弥陀堂（平安時代後期の浄土庭園と紅葉ライトアップ）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>湯ノ岳パノラマライン展望台（太平洋と山々の大絶景）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>アクアマリンふくしま（環境水族館）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>いわき湯本温泉街・さはこの湯（公衆浴場）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>いわき・ら・ら・ミュウ（観光物産館）</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                常磐ものヒラメ・メヒカリの唐揚げ・福島牛ステーキ・秋アンコウ鍋・いわき地酒「又兵衛」
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                いわき湯本温泉（含硫黄-ナトリウム-塩化物・硫酸塩温泉、美肌作用・血行促進・保温の三拍子揃う日本三古湯）と源泉かけ流し風呂
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">福島県いわき市常磐白鳥町壱丁田18</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/19278/19278.jpg"
                alt="いわき湯本温泉　ホテルパームスプリング"
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                ハワイアンズ車5分と好アクセス！源泉100％掛け流し檜香る温泉に旬の食材を使用した料理長特製の和食膳
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> ＪＲ湯本駅から車で7分／常磐道いわき湯本ＩＣより車で５分</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥7,200〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F19278%2F19278.html"
              target="_blank"
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">福島県いわき市常磐湯本町笠井1</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.4
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-stone-900 text-sm">宿の魅力と秋の過ごし方</h4>
              <p className="text-sm text-stone-700 leading-relaxed">
                こだわりの湯使い、本当の源泉かけ流しをご堪能ください&amp;#9832;
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> ＪＲ常磐線湯本駅より徒歩８分　常磐自動車道いわき湯本ＩＣから４ｋｍ（車で７分）　ハワイアンズまで車で約７分　</p>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F31896%2F31896.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">福島県いわき市常磐湯本町吹谷58</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.33
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 常磐線・湯本駅より徒歩７分／常磐自動車道・湯本ＩＣよりお車で１０分</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥7,650〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F18337%2F18337.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】福島・いわき湯本温泉＆湯の岳を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、国宝 白水阿弥陀堂（平安時代後期の浄土庭園と紅葉ライトアップ）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（常磐ものヒラメなど）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 湯ノ岳パノラマライン展望台（太平洋と山々の大絶景）へ移動。午後の柔らかな木漏れ日の中で絶景散策・撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、アクアマリンふくしま（環境水族館）を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - いわき湯本温泉街・さはこの湯（公衆浴場）にてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 福島・いわき湯本温泉＆湯の岳の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月下旬〜11月下旬（白水阿弥陀堂紅葉ライトアップ・常磐ものヒラメ・アンコウ旬）（湯ノ岳パノラマライン紅葉ドライブ・国宝白水阿弥陀堂紅葉ライトアップ・秋の常磐もの旬）が見頃のピークとなります。山々や海岸・温泉街の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 福島・いわき湯本温泉＆湯の岳へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
