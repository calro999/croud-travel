...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月上旬〜10月下旬に白樺とダケカンバが黄金に輝く志賀高原・横手山。レトロな石畳が続く湯田中渋温泉郷の老舗宿で、外湯めぐりと旬の信州りんご・信州プレミアム牛をふるさと納税で楽しむ秋の信濃路。',
    url: 'https://croud-travel.com/furusato-tax-shigakogen-yudanaka-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "志賀高原横手山のパノラマ紅葉＆石畳の風情漂う湯田中渋温泉郷・信州りんご＆信州牛ステイ",
    "description": "10月上旬〜10月下旬に白樺とダケカンバが黄金に輝く志賀高原・横手山。レトロな石畳が続く湯田中渋温泉郷の老舗宿で、外湯めぐりと旬の信州りんご・信州プレミアム牛をふるさと納税で楽しむ秋の信濃路。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-shigakogen-yudanaka-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "志賀高原・湯田中渋温泉郷・山ノ内の秋（10月〜11月）の見どころや旬の味覚は？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月上旬〜10月下旬の標高2,000m超の黄金パノラマと情緒ある温泉街が最高のシーズンです。息をのむ秋の絶景とともに、この時期にしか味わえない旬のブランド食材や名物鍋をご堪能いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の志賀高原・湯田中渋温泉郷・山ノ内旅行のおすすめの過ごし方は？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <header className="relative bg-gradient-to-br from-amber-950 via-stone-900 to-amber-900 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月上旬〜10月下旬の標高2,000m超の黄金パノラマと情緒ある温泉街</span>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-amber-950 border-b-2 border-amber-600 pb-3 mb-6">
            はじめに：10月・11月の志賀高原・湯田中渋温泉郷・山ノ内で叶える極上の秋旅
          </h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            秋が深まる10月から11月、長野県・志賀高原・湯田中渋温泉郷・山ノ内エリアは一年の中で最も豊かで魅力的な表情を見せてくれます。澄み切った秋空に映える山々や渓谷のグラデーション、歴史ある町並みに漂う秋の情緒、そしてこの季節ならではの極上グルメが旅人を迎えます。
          </p>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <p className="text-slate-700 leading-relaxed">
            本記事では、志賀高原・湯田中渋温泉郷・山ノ内エリアで高い評価を獲得しているおすすめの名宿3選を詳しくご紹介します。楽天ふるさと納税を活用すれば、実質自己負担わずか2,000円でお得に宿泊クーポンを取得可能。賢く上質な大人の秋旅を計画しましょう。
          </p>
        </section>
        ...
        <section className="bg-amber-50 rounded-2xl p-6 sm:p-8 border border-amber-200 mb-12">
          <h3 className="text-lg sm:text-xl font-bold text-amber-900 mb-4 flex items-center gap-2">
            <span>🍁</span> 志賀高原・湯田中渋温泉郷・山ノ内 秋旅の3大魅力ポイント
          </h3>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">信州湯田中温泉 ホテルゆだなか ～大浴場「吉の湯」～</h3>
              <p className="text-xs text-slate-500">しんしゅうゆだなかおんせん ほてるゆだなか よしのゆ</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 3.72点 <span className="text-xs font-normal text-slate-600">(284件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/38584/38584.jpg"
                alt="信州湯田中温泉 ホテルゆだなか ～大浴場「吉の湯」～の外観・温泉風景"
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  湯田中駅前に位置する便利な好立地ホテル。自家源泉から湧き出る豊富な天然温泉を湛えた名物大浴場「吉の湯」と、信州の山の幸・郷土料理バイキングまたは会席が好評。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  ナトリウム-塩化物・硫酸塩温泉（弱アルカリ性高温泉） / 自家源泉かけ流し / 効能：神経痛、冷え性、関節痛、美肌効果、疲労回復
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：長野電鉄長野線「湯田中駅」より徒歩約3分 / 上信越自動車道「信州中野IC」より車で約15分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                信州牛の陶板焼き、信州サーモンのお造り、信州そば、採れたて信州キノコ鍋、信州りんごを使った秋スイーツ
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                駅近でありながら本格的な源泉かけ流し温泉を堪能。志賀高原へのアクセス拠点としても抜群で、アクティブな紅葉ドライブに最適。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D38584"
              target="_blank"
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">湯田中温泉 白雲楼旅館</h3>
              <p className="text-xs text-slate-500">ゆだなかおんせん はくうんろうりょかん</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.06点 <span className="text-xs font-normal text-slate-600">(198件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/7120/7120.jpg"
                alt="湯田中温泉 白雲楼旅館の外観・温泉風景"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  創業明治の歴史を刻む湯田中温泉の純和風旅館。夜間瀬川のほとりに位置し、源泉100%かけ流しの名湯と、真心込めた郷土会席料理でおもてなし。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  単純温泉（弱アルカリ性低張性高温泉） / 源泉100%かけ流し / 効能：リウマチ性疾患、運動器障害、神経痛、疲労回復、健康増進
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：長野電鉄「湯田中駅」より徒歩約10分（送迎あり） / 信州中野ICより車で約15分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                信州プレミアム牛の朴葉味噌焼き、山ノ内町特産のみゆきポーク鍋、旬の松茸やキノコの炊き込みご飯、信州手打ちそば
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                大浴場から望む秋の山並みと川のせせらぎ。昔ながらの湯治場の風情が漂い、静かに心と体を癒やす大人の温泉旅にぴったり。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D7120"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">信州・湯田中温泉 清風荘</h3>
              <p className="text-xs text-slate-500">しんしゅう ゆだなかおんせん せいふうそう</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.13点 <span className="text-xs font-normal text-slate-600">(108件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  庭園露天風呂と源泉かけ流しの天然温泉が自慢の温泉宿。信州の素材を吟味した手作り料理と、落ち着いた和の客室でプライベートなひとときを。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  ナトリウム-塩化物温泉（源泉かけ流し） / 露天風呂・大浴場・貸切風呂 / 効能：冷え性、疲労回復、筋肉痛、神経痛、皮膚病
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：長野電鉄「湯田中駅」より徒歩約7分（送迎あり） / 信州中野ICより約15分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                信州牛のすき焼き会席、信州サーモンと岩魚のお造り、山菜とキノコの天ぷら、信州りんごのデザート
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                四季の彩りを見せる日本庭園を眺めながらの露天風呂。湯田中・渋温泉街の外湯めぐり（九湯めぐり）への散策も楽しめます。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D41634"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
          ...
          <div className="space-y-6">
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
                <span className="text-amber-600 font-bold">Q.</span> 志賀高原・湯田中渋温泉郷・山ノ内の秋のベストシーズンはいつですか？
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                例年10月上旬〜10月下旬の標高2,000m超の黄金パノラマと情緒ある温泉街が最高の見頃となります。標高差や気候に合わせて色づきや食材の旬が移り変わり、10月から11月下旬まで長く楽しめます。
              </p>
            </div>
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                10月〜11月の志賀高原・湯田中渋温泉郷・山ノ内は朝晩の冷え込みが予想されます。日中は薄手のアウターで快適ですが、早朝や夜間、山間部の散策には防風ジャケットやフリース、歩きやすい靴をご用意ください。
              </p>
            </div>
          </div>
        </section>
