...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の兵庫・淡路島特集！瀬戸内海・播磨灘に沈む茜色の絶景サンセットと湯ざわり滑らかなうずしお温泉＆洲本温泉、秋解禁の極上「淡路島3年とらふぐ」や最高級淡路牛、鳴門海峡の秋の大潮うずしおをふるさと納税トラベルクーポンで満喫する大人の島旅。',
    url: 'https://croud-travel.com/furusato-tax-awaji-sunset-onsen-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "兵庫・淡路島サンセット温泉＆秋の鳴門海峡！絶品淡路島3年とらふぐ＆淡路牛会席",
    "description": "10月・11月の兵庫・淡路島特集！瀬戸内海・播磨灘に沈む茜色の絶景サンセットと湯ざわり滑らかなうずしお温泉＆洲本温泉、秋解禁の極上「淡路島3年とらふぐ」や最高級淡路牛、鳴門海峡の秋の大潮うずしおをふるさと納税トラベルクーポンで満喫する大人の島旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-awaji-sunset-onsen-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "兵庫・淡路島（洲本・南あわじ）の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月下旬（秋うずしお・3年とらふぐ旬入り・夕陽絶景）（播磨灘サンセット・秋の大潮うずしおクルーズ・淡路島3年とらふぐ解禁）が見頃のピークとなります。山々や湖畔・海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "兵庫・淡路島（洲本・南あわじ）へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 兵庫・淡路島（洲本・南あわじ）</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 10月中旬〜11月下旬（秋うずしお・3年とらふぐ旬入り・夕陽絶景）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の兵庫・淡路島（洲本・南あわじ）を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が心地よく吹き抜け、木々が鮮やかに色づく10月・11月。日本各地がもっとも美しく、実り豊かな季節を迎えます。なかでも「兵庫・淡路島（洲本・南あわじ）」は、播磨灘サンセット・秋の大潮うずしおクルーズ・淡路島3年とらふぐ解禁など、この時期にしか出逢えない息を呑む絶景と旬の味覚が凝縮された屈指の名所です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>うずしおクルーズ（鳴門海峡大潮）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>慶野松原（日本の夕陽百選）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>あわじ花さじき（秋のコスモス畑）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>淡路夢舞台</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>洲本城跡</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                淡路島3年とらふぐ（てっさ・てっちり・唐揚げ・ひれ酒）・特選淡路牛鉄板焼き・伊勢海老・淡路玉ねぎ御膳
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                洲本温泉＆南あわじうずしお温泉（美肌の重曹泉・単純温泉）と海一望パノラマ露天風呂
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">兵庫県洲本市小路谷1052-2</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/17856/17856.jpg"
                alt="洲本温泉　ホテルニューアワジ別亭　淡路夢泉景　＜淡路島＞"
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 車:洲本ICから15分／高速バス:大阪120分・三宮80分で洲本BCへ</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥16,500〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F17856%2F17856.html"
              target="_blank"
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">兵庫県南あわじ市松帆古津路970-76</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.62
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> バス：各線「陸の港西淡」「西淡志知」下車、無料送迎車（要予約）　車：神戸淡路鳴門自動車道、西淡三原ICより５～８分</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥11,960〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F67828%2F67828.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">兵庫県洲本市小路谷1277-5</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.46
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/108118/108118.jpg"
                alt="洲本温泉　海のホテル　島花　＜淡路島＞"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 車：洲本ICから18分／高速バス：大阪120分・三宮80分で洲本BCへ</p>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F108118%2F108118.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】兵庫・淡路島（洲本・南あわじ）を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、うずしおクルーズ（鳴門海峡大潮）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（淡路島3年とらふぐ（てっさなど）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 慶野松原（日本の夕陽百選）へ移動。午後の柔らかな木漏れ日の中で絶景撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、あわじ花さじき（秋のコスモス畑）を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - 淡路夢舞台にてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 兵庫・淡路島（洲本・南あわじ）の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月中旬〜11月下旬（秋うずしお・3年とらふぐ旬入り・夕陽絶景）（播磨灘サンセット・秋の大潮うずしおクルーズ・淡路島3年とらふぐ解禁）が見頃のピークとなります。山々や湖畔・海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 兵庫・淡路島（洲本・南あわじ）へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
