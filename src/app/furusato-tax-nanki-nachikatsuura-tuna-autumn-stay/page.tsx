...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の和歌山・南紀勝浦＆熊野那智大社特集！落差日本一の名瀑「那智の滝」と熊野古道大門坂の秋景色、太平洋の荒波が迫る勝浦温泉の海辺洞窟露天風呂「忘帰洞」、水揚げ日本一を誇る極上の「勝浦生まぐろ」とブランド熊野牛をふるさと納税で満喫。',
    url: 'https://croud-travel.com/furusato-tax-nanki-nachikatsuura-tuna-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "那智の滝と熊野古道の秋紅葉！南紀勝浦温泉の海辺洞窟露天風呂・生まぐろ＆熊野牛を味わう聖地紀州旅",
    "description": "10月・11月の和歌山・南紀勝浦＆熊野那智大社特集！落差日本一の名瀑「那智の滝」と熊野古道大門坂の秋景色、太平洋の荒波が迫る勝浦温泉の海辺洞窟露天風呂「忘帰洞」、水揚げ日本一を誇る極上の「勝浦生まぐろ」とブランド熊野牛をふるさと納税で満喫。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-nanki-nachikatsuura-tuna-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "那智勝浦・勝浦温泉・熊野古道の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月〜11月下旬（那智の滝周辺紅葉・熊野古道大門坂散策・勝浦生まぐろ・熊野牛・みかん）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の那智勝浦・勝浦温泉・熊野古道旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の那智勝浦・勝浦温泉・熊野古道は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月〜11月下旬（那智の滝周辺紅葉・熊野古道大門坂散策・勝浦生まぐろ・熊野牛・みかん）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">和歌山・那智勝浦＆熊野古道特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の那智勝浦・勝浦温泉・熊野古道の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              和歌山県を代表する景勝地・温泉地である那智勝浦・勝浦温泉・熊野古道は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月〜11月下旬（那智の滝周辺紅葉・熊野古道大門坂散策・勝浦生まぐろ・熊野牛・みかん）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の那智勝浦・勝浦温泉・熊野古道を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">なんきかつうらおんせん りょうりりょかん まんせいろう</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">南紀勝浦温泉　くつろぎの宿　料理旅館　万清楼</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.42 <span className="text-xs text-stone-500 font-normal">(826件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥14,850〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                勝浦港の目の前に佇み、創業以来の料理自慢で知られる純和風老舗温泉旅館。勝浦港直送の新鮮な生まぐろ会席と、源泉かけ流しの天然温泉が評判。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">含硫黄-ナトリウム-塩化物泉（源泉100%かけ流し） / 天然温泉大浴場（姉妹館ホテル浦島の温泉も利用可能） / 効能：美肌、神経痛、筋肉痛、冷え性、皮膚病、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">勝浦港水揚げ活生まぐろづくし会席、熊野牛の陶板焼き、伊勢海老の鬼殻焼き、紀州梅料理、地酒「太平洋」</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">板前が腕を振るう生まぐろ料理の質の高さ。姉妹館「ホテル浦島」の名物洞窟風呂「忘帰洞」へも専用船で無料湯めぐり可能。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR紀勢本線「紀伊勝浦駅」より徒歩約7分（無料送迎あり） / 紀勢自動車道「すさみ南IC」または「那智勝浦IC」より車で約15分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">なんきかつうらおんせん ほてるうらしま</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">南紀勝浦温泉　ホテル浦島</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.22 <span className="text-xs text-stone-500 font-normal">(6399件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                勝浦港から専用観光船で渡る、太平洋を望む巨大温泉リゾート。太平洋の荒波が押し寄せる天然洞窟露天風呂「忘帰洞」「玄武洞」をはじめ、館内6箇所の名湯巡りが大人気。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">含硫黄-ナトリウム・カルシウム-塩化物温泉（自家源泉かけ流し・乳白色） / 忘帰洞・玄武洞・滝の湯など6つの温泉 / 効能：神経痛、リウマチ、冷え性、慢性皮膚病、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">勝浦港直送生まぐろ解体ショー＆豪華バイキング、熊野牛すき焼き、紀州郷土料理、和歌山産みかんスイーツ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">「帰るのを忘れるほど」と称された絶景洞窟風呂・忘帰洞。館内だけで一日中温泉三昧を満喫できる唯一無二のエンターテインメント温泉。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR紀伊勝浦駅より桟橋へ徒歩約6分、専用船で約5分 / 那智勝浦ICより車で約15分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">なんきかつうらおんせん ほてるなぎさや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">南紀勝浦温泉　ホテルなぎさや</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4 <span className="text-xs text-stone-500 font-normal">(673件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥8,800〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                波静かな入江に佇み、全客室オーシャンビューを誇る静寂の温泉ホテル。敷地内から自噴する3本の自家源泉かけ流し露天風呂と、生まぐろや熊野牛会席が好評。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">含硫黄-ナトリウム-塩化物・硫酸塩泉（3本の自家源泉完全かけ流し） / 湾一望の露天風呂・大浴場 / 効能：美肌、神経痛、筋肉痛、関節痛、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">勝浦産生まぐろのお造り食べ比べ、熊野牛ステーキ会席、アワビの陶板焼き、紀州備長炭小鍋、和歌山県産米</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">入江の穏やかな波音と満天の星に包まれる自家源泉かけ流し露天風呂。那智の滝や熊野那智大社への観光アクセスも抜群。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">紀伊勝浦駅より車で約5分（無料送迎あり） / 那智勝浦ICより車で約10分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月〜11月下旬（那智の滝周辺紅葉・熊野古道大門坂散策・勝浦生まぐろ・熊野牛・みかん））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
