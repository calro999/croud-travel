...
export const metadata: Metadata = {
  ...
  keywords: ["nagoya-kyoto-bus-vs-shinkansen-guide", "高速バス", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["nagoya-kyoto-bus-vs-shinkansen-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for nagoya-kyoto-bus-vs-shinkansen-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "08:00",
        "title": "名鉄バスセンターから名神ハイウェイバス乗車",
        "desc": "名神高速を走り近江路へ。多賀SAで休憩。"
      },
      {
        "time": "10:35",
        "title": "京都駅烏丸口到着＆JR奈良線で「伏見稲荷大社」へ",
        "desc": "朱塗りの千本鳥居が連なる神秘的な参道を散策し、きつね絵馬に願い事。"
      },
      {
        "time": "12:30",
        "title": "宇治へ移動＆平等院鳳凰堂・本場宇治抹茶ランチ",
        "desc": "10円玉に描かれた世界遺産・鳳凰堂を鑑賞。「伊藤久右衛門」で特製抹茶そば＆抹茶パフェ。"
      },
      {
        "time": "16:00",
        "title": "京都駅前・烏丸の和モダン温泉ホテルチェックイン",
        "desc": "大浴場付きホテルでゆったり旅の疲れを癒やす。"
      },
      {
        "time": "18:30",
        "title": "祇園・四条河原町で「京鴨鍋」＆京都クラフトビール",
        "desc": "町家を改装したおしゃれなダイニングで京野菜と鴨料理を堪能。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "09:00",
        "title": "黄金に輝く世界遺産「金閣寺（鹿苑寺）」参拝",
        "desc": "鏡湖池に映る金閣の美しい逆さ金閣を鑑賞。"
      },
      {
        "time": "11:30",
        "title": "嵐山へ移動＆渡月橋・竹林の小径散策",
        "desc": "清々しい風が吹き抜ける竹林を歩き、川沿いのカフェでラテアート。"
      },
      {
        "time": "14:30",
        "title": "京都駅ポルタ・伊勢丹でお土産購入",
        "desc": "「マールブランシュのお濃茶ラングドシャ茶の菓」「八ッ橋」「阿闍梨餅」を購入。"
      },
      {
        "time": "16:00",
        "title": "京都駅から高速バス乗車〜名古屋へ",
        "desc": "夕方の高速バスで夜18:30頃に名鉄バスセンターへ帰還。"
      }
    ]
  }
];
    ...
    <div className="space-y-12 max-w-5xl mx-auto pb-16">
      ...
      <section className="bg-white border border-slate-200 rounded-3xl p-6 md:p-10 shadow-sm space-y-8">
        <div className="border-b border-slate-100 pb-4">
          ...
          <h2 className="text-xl md:text-2xl font-black font-journal-serif text-slate-900">
            京都駅烏丸口徒歩5分！天然温泉大浴場＆和朝食バイキングが人気の宿
          </h2>
          <p className="text-xs md:text-sm text-slate-600 mt-1">
