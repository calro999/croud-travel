      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 mt-12 space-y-16">
        ...
        <section className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 backdrop-blur shadow-2xl">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">
            エメラルド＆ブルーに輝く地底湖と数億年の石灰岩アート。地底アドベンチャーと極上宿の休日
          </h2>
          <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
            気の遠くなるような年月をかけて地下水が石灰岩を削り磨き上げた「日本三大鍾乳洞」――吸い込まれそうなドラゴンブルーの深い地底湖が神秘的な光を放つ岩手の「龍泉洞」、弥生時代の古代人が生活し土器が鍾乳石に包まれた学術的奇跡を誇る高知の「龍河洞」、そして秋吉台の大カルスト台地下に広がる東洋屈指の大鍾乳洞・山口の「秋芳洞」。洞窟内の年間を通じて一定に保たれた冷涼な澄んだ空気と、ライトアップされた千町田や百枚皿の造形美は訪れる者を異世界へと誘います。探検の後は、周辺の三陸海の幸や土佐和牛、長門湯本の名湯を心ゆくまで味わう贅沢な旅を楽天ふるさと納税でお楽しみください。
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key="0" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              ...
              <h3 className="font-bold text-white text-lg mb-2">通年10〜15度の快適空間！四季を問わず楽しめる非日常のアドベンチャー</h3>
              <p className="text-slate-400 text-sm leading-relaxed">夏はひんやり天然クーラー、冬は温かく感じられる地底空間で、天候に左右されずに大自然の神秘を体験できます。</p>
            </div>
            <div key="1" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                02
              </div>
              <h3 className="font-bold text-white text-lg mb-2">三陸アワビ・土佐のカツオ一本釣り・山口のとらふぐ極上会席</h3>
              <p className="text-slate-400 text-sm leading-relaxed">地底探検の後は、各県自慢の最高級海鮮グルメと地酒のマリアージュを老舗名宿で堪能できます。</p>
            </div>
            <div key="2" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                03
              </div>
              <h3 className="font-bold text-white text-lg mb-2">楽天ふるさと納税宿泊クーポンで憧れの名旅館・リゾートを賢く割引</h3>
              <p className="text-slate-400 text-sm leading-relaxed">寄付額に応じて宿泊代金が即時控除され、大谷山荘や浄土ヶ浜パークホテルなど名門ホテルの宿泊を大幅にお得に予約できます。</p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            ...
            <article key="0" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  岩手県岩泉町・宮古市ふるさと納税：ドラゴンブルーに輝く神秘の地底湖「龍泉洞」と三陸名門浄土ヶ浜パークホテル
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  世界有数の透明度を誇る地底湖群。ブルーに輝く第1〜第3地底湖の幻想美を体感した後は、三陸復興国立公園・浄土ヶ浜の高台に佇む名門ホテルで、三陸のウニやアワビ、前沢牛を味わう絶景ステイです。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/64789/64789.jpg"
                    alt="浄土ヶ浜パークホテル"
                    fill
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-4 bg-slate-900/60 p-3.5 rounded-xl border border-slate-800/60">
                      浄土ヶ浜の高台に建つ和の景観と四季の恵みあふれるホテル。三陸の海の幸をご用意してお待ちしております
                    </p>
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fhb.afl.rakuten.co.jp%2Fhgc%2F54d2a438.4bc4abc2.54d2a439.aa1be583%2F%3Fpc%3Dhttps%253A%252F%252Fimg.travel.rakuten.co.jp%252Fimage%252Ftr%252Fapi%252Fkw%252FJBe8h%252F%253Ff_no%253D64789"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <article key="1" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  高知県香美市・高知市ふるさと納税：弥生土器が鍾乳石に包まれた国の天然記念物「龍河洞」と山里の極上隠れ宿オーベルジュ土佐山
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  1億7500万年の歳月が刻んだ鍾乳洞。世界唯一の「神の壺」を巡る冒険の後は、鏡川源流の清流沿いに佇むオーベルジュ土佐山で、土佐ジローや四万十の恵みを生かした極上ディナーと美肌温泉に癒やされます。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/72851/72851.jpg"
                    alt="オーベルジュ　土佐山"
                    fill
                    className="object-cover hover:scale-105 transition duration-500"
                    unoptimized
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-slate-400 mb-3 flex items-center gap-1">
                      <span>📍</span>
                      <span>高知県高知市土佐山東川661</span>
                    </p>
                    <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-4 bg-slate-900/60 p-3.5 rounded-xl border border-slate-800/60">
                      ここは、したたる緑と澄みわたる流れに抱かれた「オーベルジュ」至福の味わいと極上の空間をご用意。
                    </p>
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fhb.afl.rakuten.co.jp%2Fhgc%2F54d2a438.4bc4abc2.54d2a439.aa1be583%2F%3Fpc%3Dhttps%253A%252F%252Fimg.travel.rakuten.co.jp%252Fimage%252Ftr%252Fapi%252Fkw%252FJBe8h%252F%253Ff_no%253D72851"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
            ...
            <article key="2" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  山口県美祢市・長門市ふるさと納税：東洋屈指の大鍾乳洞「秋芳洞」百枚皿パノラマと音信川の湯宿・大谷山荘ステイ
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  特別天然記念物の大鍾乳洞。百枚皿や傘づくし、黄金柱の圧倒的スケールを体感した後は、長門湯本温泉の老舗高級宿「大谷山荘」で、清流のせせらぎを聞きながら名湯露天風呂と長州とらふぐ会席に酔いしれます。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fhb.afl.rakuten.co.jp%2Fhgc%2F54d2a438.4bc4abc2.54d2a439.aa1be583%2F%3Fpc%3Dhttps%253A%252F%252Fimg.travel.rakuten.co.jp%252Fimage%252Ftr%252Fapi%252Fkw%252FJBe8h%252F%253Ff_no%253D8178"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
