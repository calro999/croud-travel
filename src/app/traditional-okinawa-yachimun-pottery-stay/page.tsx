...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "【やちむんの温もり】沖縄伝統の陶器で味わう琉球フレンチ＆美ら海オーシャンビューリゾート宿5選",
    description: "ぽってりとした温かみのある沖縄伝統陶器「やちむん」に美しく盛り付けられた琉球フレンチや創作料理。読谷村や恩納村のエメラルドグリーンの海を望む極上リゾートで、沖縄の文化と美食に浸る旅を。",
    url: 'https://croud-travel.com/traditional-okinawa-yachimun-pottery-stay',
...
export default function FeaturePage() {
  const jsonLd = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://croud-travel.com/traditional-okinawa-yachimun-pottery-stay"
    }
  };
      ...
      <section className="relative h-[480px] md:h-[580px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight drop-shadow-md">
            【やちむんの温もり】沖縄伝統の陶器で味わう琉球フレンチ＆美ら海オーシャンビューリゾート宿5選
          </h1>
