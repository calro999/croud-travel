...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月下旬〜11月中旬に大山南壁を鮮やかに彩る鍵掛峠のブナ紅葉。日本海に面した皆生温泉で、塩化物泉の温まり美肌湯と11月上旬に初競り解禁となる本場「松葉がに」「鳥取和牛」をふるさと納税で味わう秋の山陰旅。',
    url: 'https://croud-travel.com/furusato-tax-daisen-kagikaketoge-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "霊峰大山「鍵掛峠」ブナ樹海の圧巻紅葉＆皆生温泉・11月解禁本場「松葉がに」と大山黒牛",
    "description": "10月下旬〜11月中旬に大山南壁を鮮やかに彩る鍵掛峠のブナ紅葉。日本海に面した皆生温泉で、塩化物泉の温まり美肌湯と11月上旬に初競り解禁となる本場「松葉がに」「鳥取和牛」をふるさと納税で味わう秋の山陰旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-daisen-kagikaketoge-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "鳥取・大山・鍵掛峠・皆生温泉の秋（10月〜11月）のベストシーズン・見頃はいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月中旬のブナ原生林紅葉と11月解禁の冬の味覚の王様・松葉がにが見頃のピークとなります。山々や渓谷の美しいグラデーションとともに、旬を迎える地場食材を存分にお楽しみいただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の鳥取・大山・鍵掛峠・皆生温泉旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の鳥取・大山・鍵掛峠・皆生温泉は朝夕の冷え込みが強まります。日中は快適な服装で問題ありませんが、朝夕の散策や露天風呂への移動時には防寒着（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月下旬〜11月中旬のブナ原生林紅葉と11月解禁の冬の味覚の王様・松葉がに</span>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-amber-950 border-b-2 border-amber-600 pb-3 mb-6">
            はじめに：秋の鳥取・大山・鍵掛峠・皆生温泉で味わう絶景と至高の温泉時間
          </h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            10月から11月にかけての鳥取県・鳥取・大山・鍵掛峠・皆生温泉は、豊かな自然美と歴史情緒が鮮やかに交差する特別なシーズンを迎えます。澄んだ秋空の下、山肌や渓谷が織りなす錦秋のパノラマは息をのむ美しさで、訪れる人々を魅了してやみません。
          </p>
          <p className="text-slate-700 leading-relaxed mb-4">
            心地よい秋風を感じながら名所を巡ったあとは、名湯に身を浸して日々の喧騒を忘れ、夜には秋の実りを凝縮した贅沢な郷土会席に舌鼓を打つ――これこそが大人の旅にふさわしい至高の贅沢です。
          </p>
          <p className="text-slate-700 leading-relaxed">
            本記事では、鳥取・大山・鍵掛峠・皆生温泉エリアで高い評価を誇るおすすめの名宿3選を徹底解説します。楽天ふるさと納税の宿泊クーポンを活用すれば、実質自己負担わずか2,000円で憧れの高級旅館や温泉宿にお得に宿泊可能です。秋の特別な旅行プランをぜひご検討ください。
          </p>
        </section>
        ...
        <section className="bg-amber-50 rounded-2xl p-6 sm:p-8 border border-amber-200 mb-12">
          <h3 className="text-lg sm:text-xl font-bold text-amber-900 mb-4 flex items-center gap-2">
            <span>🍁</span> 鳥取・大山・鍵掛峠・皆生温泉 秋旅の3大魅力ポイント
          </h3>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">皆生温泉 皆生シーサイドホテル 海の四季</h3>
              <p className="text-xs text-slate-500">かいけおんせん かいけしーさいどほてる うみのしき</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.43点 <span className="text-xs font-normal text-slate-600">(4943件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                ...
                alt="皆生温泉 皆生シーサイドホテル 海の四季の外観・温泉風景"
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  全室オーシャンビュー、日本海を望む絶景シーサイド温泉リゾート。海底から湧き出るミネラル豊富な塩化物泉と、11月解禁の本場「松葉がに」会席が自慢。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  ナトリウム・カルシウム-塩化物泉（高温泉） / 海を望む露天風呂・貸切風呂 / 効能：保温効果、神経痛、関節痛、冷え性、美肌効果
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR山陰本線「米子駅」より路線バスで約20分「皆生温泉観光センター」下車徒歩約3分 / 米子自動車道「米子IC」より車で約10分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                11月解禁「境港直送・活松葉がにフルコース」（焼きがに、かに刺し、かに鍋、甲羅味噌焼き）、鳥取和牛ステーキ、地魚お造り
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                波打ち際ぎりぎりに設えられた露天風呂に浸かり、秋の日本海の夕暮れと潮騒を堪能。大山紅葉ドライブとカニ三昧の至福のコンビネーション。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D5020"
              target="_blank"
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">皆生温泉 皆生菊乃家</h3>
              <p className="text-xs text-slate-500">かいけおんせん かいけきくのや</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.46点 <span className="text-xs font-normal text-slate-600">(1409件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  温かなもてなしと館内に流れる生演奏が心地よい老舗海辺旅館。海一望の露天風呂と、料理長が腕を振るう山陰の旬味・松葉がに料理が人気。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  ナトリウム・カルシウム-塩化物泉 / 展望大浴場・露天風呂 / 効能：美肌、疲労回復、冷え性、神経痛
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR米子駅よりバス約20分（米子駅より無料送迎あり要予約） / 米子ICより車で約10分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                タグ付きブランド松葉がに会席、鳥取大山黒牛の溶岩焼き、日本海朝獲れ鮮魚の姿造り、大山おこわ
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                夕暮れ時にロビーで奏でられるジャズやピアノの生演奏。温かい塩化物泉で温まった後に味わう本場松葉がにの甘みが五臓六腑に染み渡ります。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D12677"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">皆生温泉 湯喜望 白扇</h3>
              <p className="text-xs text-slate-500">かいけおんせん ゆきぼう はくせん</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.28点 <span className="text-xs font-normal text-slate-600">(1942件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  全館畳敷きの和の趣と全室オーシャンビューを誇る高級和風旅館。全客室に展望ジャグジーまたは露天風呂を備え、極上の松葉がにと鳥取和牛会席を提供。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  ナトリウム・カルシウム-塩化物温泉 / 展望露天風呂・大浴場 / 効能：冷え性改善、筋肉痛、美肌効果、疲労回復
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR米子駅より路線バス約20分「皆生温泉」下車徒歩約5分 / 米子ICより車で約10分 / 米子鬼太郎空港より車で約20分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                特選松葉がにづくし会席、A5鳥取和牛オレイン55ステーキ、境港水揚げ本マグロのお造り、大山鶏の茶碗蒸し
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                素足で歩く心地よい畳敷きの館内。客室の大きな窓一面に広がる日本海のパノラマと、冬の味覚の王様・松葉がにを味わう贅沢。
              </p>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-br from-stone-900 to-amber-950 text-white rounded-2xl p-6 sm:p-8 shadow-lg mb-12">
          ...
          <p className="text-stone-200 text-sm sm:text-base leading-relaxed mb-6">
            楽天ふるさと納税を利用すれば、鳥取県内の対象宿泊施設で使える楽天トラベルクーポンが寄付額に応じて返礼品として付与されます。実質負担2,000円で高級宿に泊まれるお得な活用法をチェックしましょう。
          </p>
          ...
          <div className="space-y-6">
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
                <span className="text-amber-600 font-bold">Q.</span> 鳥取・大山・鍵掛峠・皆生温泉の秋の見頃時期はいつですか？
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                例年10月下旬〜11月中旬のブナ原生林紅葉と11月解禁の冬の味覚の王様・松葉がにが見頃となります。標高差や気候に合わせて色づきが移り変わり、長期間にわたって楽しめます。
              </p>
            </div>
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                10月〜11月の鳥取・大山・鍵掛峠・皆生温泉は朝夕の冷え込みが予想されます。日中は薄手のアウターで快適ですが、早朝や夜間、散策時には厚手のフリースやジャケット、歩きやすい靴をご用意ください。
              </p>
            </div>
          </div>
        </section>
