...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の兵庫・山陰 湯村温泉特集！源泉温度98度の高温泉が湧き出る名所「荒湯」の立ち上る湯煙と春来川沿いの紅葉ライトアップ、慈覚大師開湯の重曹泉、黒毛和牛の最高峰「但馬牛」のすき焼き・ステーキをふるさと納税トラベルクーポンでお得に堪能する大人の湯治旅。',
    url: 'https://croud-travel.com/furusato-tax-hyogo-yumura-onsen-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "兵庫・山陰 湯村温泉「荒湯」の湯けむり紅葉！開湯1200年の高温泉＆本場但馬牛会席",
    "description": "10月・11月の兵庫・山陰 湯村温泉特集！源泉温度98度の高温泉が湧き出る名所「荒湯」の立ち上る湯煙と春来川沿いの紅葉ライトアップ、慈覚大師開湯の重曹泉、黒毛和牛の最高峰「但馬牛」のすき焼き・ステーキをふるさと納税トラベルクーポンでお得に堪能する大人の湯治旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-hyogo-yumura-onsen-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "兵庫・山陰 湯村温泉（新温泉町）の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月下旬（紅葉見頃・松葉ガニ初競り・但馬牛旬）（荒湯の湯煙ライトアップ・清正公園の紅葉パノラマ・11月松葉ガニ解禁）が見頃のピークとなります。山々や渓谷・海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "兵庫・山陰 湯村温泉（新温泉町）へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 兵庫・山陰 湯村温泉（新温泉町）</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 10月下旬〜11月下旬（紅葉見頃・松葉ガニ初競り・但馬牛旬）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の兵庫・山陰 湯村温泉（新温泉町）を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が心地よく吹き抜け、木々が鮮やかに色づく10月・11月。日本各地がもっとも美しく、実り豊かな季節を迎えます。なかでも「兵庫・山陰 湯村温泉（新温泉町）」は、荒湯の湯煙ライトアップ・清正公園の紅葉パノラマ・11月松葉ガニ解禁など、この時期にしか出逢えない息を呑む絶景と旬の味覚が凝縮された屈指の名所です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>荒湯（足湯・温泉卵作り体験）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>杜氏館・夢千代館（昭和レトロ散策）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>清正公園展望台（湯村温泉街一望）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>霧ヶ滝渓谷（秘境紅葉トレッキング）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>浜坂漁港（松葉ガニ水揚げ）</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                本場但馬牛（サーロインステーキ・しゃぶしゃぶ・牛鍋）・荒湯源泉蒸し料理・11月解禁浜坂松葉ガニ・岩魚
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                湯村温泉（ナトリウム-炭酸水素塩・塩化物・硫酸塩泉、肌がつるつるになる純生温泉）と大浴場・露天風呂
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">兵庫県美方郡新温泉町湯1610</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                【和モダンな温泉宿】2023年2月温泉付客室＜かわみ＞3タイプ誕生。全34室
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 近畿豊岡道日高神鍋高原ICより約35分/大阪梅田より阪急特急バス「湯村温泉行」1日1～2便</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥6,400〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F10636%2F10636.html"
              target="_blank"
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">兵庫県美方郡新温泉町湯1535</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.57
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 北近畿自動車道八鹿氷ノ山ＩＣより車で50分／大阪・三宮より特急バス約3時間／JR江原駅無料送迎あり(3日前までに要予約)</p>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">兵庫県美方郡新温泉町湯1269</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.57
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/10714/10714.jpg"
                alt="山陰湯村温泉　朝野家"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="space-y-3">
              <h4 className="font-bold text-stone-900 text-sm">宿の魅力と秋の過ごし方</h4>
              <p className="text-sm text-stone-700 leading-relaxed">
                98℃の湯量豊富な美肌の湯と、但馬牛や松葉蟹など旬の味覚を彩る創作会席が自慢のおもてなしの宿
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 北近畿豊岡道八鹿氷ノ山ＩＣより車で約50分／阪急大阪三番街より全但特急バスで約3時間</p>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F10714%2F10714.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】兵庫・山陰 湯村温泉（新温泉町）を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、荒湯（足湯・温泉卵作り体験）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（本場但馬牛（サーロインステーキなど）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 杜氏館・夢千代館（昭和レトロ散策）へ移動。午後の柔らかな木漏れ日の中で絶景撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、清正公園展望台（湯村温泉街一望）を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - 霧ヶ滝渓谷（秘境紅葉トレッキング）にてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 兵庫・山陰 湯村温泉（新温泉町）の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月下旬〜11月下旬（紅葉見頃・松葉ガニ初競り・但馬牛旬）（荒湯の湯煙ライトアップ・清正公園の紅葉パノラマ・11月松葉ガニ解禁）が見頃のピークとなります。山々や渓谷・海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 兵庫・山陰 湯村温泉（新温泉町）へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
