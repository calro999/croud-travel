      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 mt-12 space-y-16">
        ...
        <section className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 backdrop-blur shadow-2xl">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">
            赤く燃える炎と響き渡る鎚の音。世界中のシェフが憧れる至高の刃物と美食を訪ねる旅
          </h2>
          <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
            鎌倉時代から続く刀鍛冶の秘伝の技を今に伝え、現代では世界中の三つ星シェフや家庭料理人を魅了してやまない「日本三大刃物産地」――ドイツ・ゾーリンゲンと並ぶ世界三大刃物都市として名高い岐阜の「関の刃物」、漆器や和紙と並び七百年の手打ち鍛造技術を守り続ける福井の「越前打刃物」、そして日本のプロ用和包丁シェア90%以上を誇る大阪の「堺打刃物」。鋭い切れ味が食材の細胞を潰さず、料理の味そのものを格段に引き上げる至高の刃物は一生モノの宝物。刃物工房での見学や研ぎ直し体験を楽しんだ後は、名料理人がその包丁で腕を振るう旬の会席料理を味わう上質なクラフト旅を楽天ふるさと納税でお楽しみください。
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key="0" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              ...
              <h3 className="font-bold text-white text-lg mb-2">一生モノの包丁に出会う！職人の手研ぎ実演やオリジナル包丁選び</h3>
              <p className="text-slate-400 text-sm leading-relaxed">工房やミュージアムで名工の技に触れ、自分の手に最も馴染む究極の包丁を手に入れる旅の喜び。</p>
            </div>
            <div key="1" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                02
              </div>
              <h3 className="font-bold text-white text-lg mb-2">切れ味鋭い包丁が引き出す最高峰のお造り・和牛ステーキディナー</h3>
              <p className="text-slate-400 text-sm leading-relaxed">断面の美しさと口当たりの違いを実感できる名店・ホテルレストランでの極上グルメ会席。</p>
            </div>
            <div key="2" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                03
              </div>
              <h3 className="font-bold text-white text-lg mb-2">ふるさと納税で包丁返礼品＆宿泊クーポンをダブルで賢くゲット</h3>
              <p className="text-slate-400 text-sm leading-relaxed">自治体への寄付で本格刃物を返礼品として受け取りつつ、宿泊クーポンで旅費も実質2,000円に抑制可能。</p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            ...
            <article key="0" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  岐阜県関市ふるさと納税：世界三大刃物産地「関の刃物」鍛冶伝承館とホテルルートイン関
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  名刀「関の孫六」の伝統を受け継ぐ刃物のまち。岐阜関刃物ミュージアムで古式日本刀鍛錬を見学した後は、ホテルルートイン関の大浴場で寛ぎ、飛騨牛料理や関名物のうなぎ丼に舌鼓を打ちます。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/84784/84784.jpg"
                    alt="ホテル　ルートイン関"
                    fill
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F84784%2F84784.html"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <article key="1" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  福井県越前市ふるさと納税：七百年の伝統火造り鍛造「越前打刃物」タケフナイフビレッジとホテルクラウンヒルズ武生駅前
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  日本初の伝統工芸品指定を受けた打刃物。円形工房タケフナイフビレッジで職人の火花散る鍛造を見学した後は、ホテルクラウンヒルズ武生駅前を拠点に名物越前おろしそばや若狭牛を堪能します。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/6113/6113.jpg"
                    alt="ホテルクラウンヒルズ武生駅前（ＢＢＨホテルグループ）"
                    fill
                    className="object-cover hover:scale-105 transition duration-500"
                    unoptimized
                  />
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-lg sm:text-xl font-bold text-white mb-2">
                      ホテルクラウンヒルズ武生駅前（ＢＢＨホテルグループ）
                    </h4>
                    <p className="text-xs sm:text-sm text-slate-400 mb-3 flex items-center gap-1">
                      <span>📍</span>
                      <span>福井県越前市府中1-2-3</span>
                    </p>
                    <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-4 bg-slate-900/60 p-3.5 rounded-xl border border-slate-800/60">
                      ハピライン武生駅より徒歩1分以内の好立地。9Fスカイレストランからは、越前市街を一望できます。
                    </p>
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F6113%2F6113.html"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
            ...
            <article key="2" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  大阪府堺市ふるさと納税：プロ料理人が信頼を寄せる最高峰和包丁「堺刃物」堺伝統産業会館とホテルアゴーラリージェンシー大阪堺
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  千利休を生んだ堺の歴史と鍛冶の技。堺伝匠館で包丁の奥深さを学んだ後は、堺駅直結のシティリゾート「ホテルアゴーラリージェンシー大阪堺」で、一流シェフが織りなす鉄板焼きや本格中華を味わいます。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-slate-400 mb-3 flex items-center gap-1">
                      <span>📍</span>
                      <span>大阪府堺市堺区戎島町4丁45番地の1</span>
                    </p>
                    <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-4 bg-slate-900/60 p-3.5 rounded-xl border border-slate-800/60">
                      なんばから急行で9分☆全室Wi-Fi ★エグゼクティブフロアのほかスタンダード～スーペリアフロアも!
                    </p>
                  </div>
        ...
        <section className="border-t border-slate-800/80 pt-12 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div>
                <h3 className="font-bold text-white text-base group-hover:text-rose-400 transition mb-2">
                  職人技が光る伝統工芸＆有形文化財の名旅館ふるさと納税完全ガイド
                </h3>
                <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                  匠の技が息づく建築宿。
                </p>
