...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の北海道・川湯温泉＆阿寒摩周特集！摩周湖の霧と雲海、屈斜路湖畔の紅葉トンネル、釘をも溶かす日本屈指の強酸性硫黄泉・川湯温泉の源泉かけ流し、秋に旬を迎えるオホーツクの秋サケ・生いくら丼と北海道黒毛和牛をふるさと納税で堪能。',
    url: 'https://croud-travel.com/furusato-tax-kawayu-akan-mashu-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "阿寒摩周の秋霧と屈斜路湖の紅葉！川湯温泉の強酸性硫黄泉・秋サケ・イクラ＆北海道和牛を味わう道東旅",
    "description": "10月・11月の北海道・川湯温泉＆阿寒摩周特集！摩周湖の霧と雲海、屈斜路湖畔の紅葉トンネル、釘をも溶かす日本屈指の強酸性硫黄泉・川湯温泉の源泉かけ流し、秋に旬を迎えるオホーツクの秋サケ・生いくら丼と北海道黒毛和牛をふるさと納税で堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-kawayu-akan-mashu-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "弟子屈・川湯温泉・阿寒摩周国立公園の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月上旬〜11月上旬（摩周湖・屈斜路湖の紅葉・硫黄山秋景色・秋サケ・新いくら・道東新米）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の弟子屈・川湯温泉・阿寒摩周国立公園旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の弟子屈・川湯温泉・阿寒摩周国立公園は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月上旬〜11月上旬（摩周湖・屈斜路湖の紅葉・硫黄山秋景色・秋サケ・新いくら・道東新米）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">北海道・川湯温泉＆阿寒摩周特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の弟子屈・川湯温泉・阿寒摩周国立公園の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              北海道を代表する景勝地・温泉地である弟子屈・川湯温泉・阿寒摩周国立公園は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月上旬〜11月上旬（摩周湖・屈斜路湖の紅葉・硫黄山秋景色・秋サケ・新いくら・道東新米）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の弟子屈・川湯温泉・阿寒摩周国立公園を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">かわゆおんせん かわゆかんこうほてる</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">川湯温泉　川湯観光ホテル</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.17 <span className="text-xs text-stone-500 font-normal">(749件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥3,000〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                川湯温泉の中心に位置し、100%源泉かけ流しの強酸性硫黄泉をたたえる老舗温泉ホテル。低温・中温・高温の3つの湯船で楽しむ名湯と、オホーツクの海の幸が自慢。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">酸性・含硫黄-鉄・ナトリウム-硫酸塩・塩化物温泉（pH1.7・源泉100%完全かけ流し） / 大浴場・露天風呂・サウナ / 効能：慢性皮膚病、神経痛、筋肉痛、冷え性、疲労回復、きりきず、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">オホーツク産秋サケのちゃんちゃん焼き、新物いくら丼、北海道産黒毛和牛ステーキ、弟子屈産野菜の天ぷら</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">国内でも極めて珍しいpH1.7の強酸性硫黄泉。硫黄山や摩周湖への観光拠点として、温泉通から絶大な支持を集める名湯宿。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR釧網本線「川湯温泉駅」より路線バスで約10分（無料送迎あり要予約） / 女満別空港より車で約60分 / 釧路空港より車で約90分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">かわゆおんせん けーけーあーるかわゆ</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">川湯温泉　ＫＫＲかわゆ（国家公務員共済組合連合会川湯保養所）</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.16 <span className="text-xs text-stone-500 font-normal">(922件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                川湯温泉の閑静なエリアに佇み、良質な強酸性自家源泉を引く快適な温泉宿。手頃な料金で名湯と道東の旬の山海の幸を味わえる人気の宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">酸性・含硫黄-ナトリウム-硫酸塩温泉（自家源泉かけ流し） / 大浴場・露天風呂 / 効能：美肌、アトピー、神経痛、五十肩、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">道東産海鮮鍋会席、オホーツク産帆立の陶板焼き、北海道産豚のしゃぶしゃぶ、北海道米ななつぼし</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">静かな環境でじっくり名湯に浸かれる癒やしの空間。屈斜路湖の砂湯や硫黄山トレッキングの拠点に最適。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">川湯温泉駅よりバス約10分「川湯温泉街」下車すぐ / 女満別空港より車で約55分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F15233%2F15233.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">ゆのみー</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">ＹＵＮＯＭＹ（旧：川湯温泉ゲストハウスＮＯＭＹ）</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.5 <span className="text-xs text-stone-500 font-normal">(11件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                川湯温泉街に誕生したスタイリッシュでアットホームな温泉ステイハウス。自家源泉の強酸性温泉と、自由で快適な滞在スタイルを提供。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">強酸性硫黄泉（自家源泉かけ流し） / 天然温泉風呂 / 効能：皮膚病改善、殺菌効果、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">地元食材のモーニング、弟子屈町名物ラーメン店や居酒屋の提携ディナー、共同キッチンスタイル</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">名湯・川湯温泉をカジュアルに満喫できる新感覚の宿。道東周遊ドライブや星空観察のベースキャンプとして大人気。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">川湯温泉駅よりバスで約10分 / 女満別空港より車で約60分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月上旬〜11月上旬（摩周湖・屈斜路湖の紅葉・硫黄山秋景色・秋サケ・新いくら・道東新米））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
