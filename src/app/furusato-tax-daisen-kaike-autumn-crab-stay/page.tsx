...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の鳥取・大山＆皆生温泉特集！中国地方最高峰・伯耆大山（大山環状道路）のブナ林紅葉、日本海を望む塩化物泉・皆生温泉の海辺露天風呂、11月解禁の鳥取松葉がにと鳥取和牛オレイン55をふるさと納税で味わう旅。',
    url: 'https://croud-travel.com/furusato-tax-daisen-kaike-autumn-crab-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "伯耆大山の紅葉ドライブと皆生温泉！11月解禁の松葉がに・鳥取和牛・白砂青松の海辺露天風呂",
    "description": "10月・11月の鳥取・大山＆皆生温泉特集！中国地方最高峰・伯耆大山（大山環状道路）のブナ林紅葉、日本海を望む塩化物泉・皆生温泉の海辺露天風呂、11月解禁の鳥取松葉がにと鳥取和牛オレイン55をふるさと納税で味わう旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-daisen-kaike-autumn-crab-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "米子・皆生温泉・伯耆大山の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月下旬（大山鍵掛峠の紅葉・11月6日松葉がに漁解禁・皆生温泉海辺夕日）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の米子・皆生温泉・伯耆大山旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の米子・皆生温泉・伯耆大山は昼夜の寒暖差が激しくなります。日中は長袖シャツで快適ですが、早朝や夕暮れの散策・露天風呂への移動時には防寒アウター（フリースやダウン等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月中旬〜11月下旬（大山鍵掛峠の紅葉・11月6日松葉がに漁解禁・皆生温泉海辺夕日）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">鳥取・大山＆皆生温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の米子・皆生温泉・伯耆大山の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              鳥取県を代表する景勝地・温泉地である米子・皆生温泉・伯耆大山は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月中旬〜11月下旬（大山鍵掛峠の紅葉・11月6日松葉がに漁解禁・皆生温泉海辺夕日）</li>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">かいけおんせん かいけしーさいどほてる うみのしき</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">皆生温泉　皆生シーサイドホテル　海の四季</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.43 <span className="text-xs text-stone-500 font-normal">(4943件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥5,940〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                全室オーシャンビューを誇る日本海フロントの絶景温泉ホテル。海が一望できる露天風呂と、山陰の旬魚・松葉がに・鳥取和牛を堪能できる贅沢会席が評判。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物泉（高温泉） / 海の見える露天風呂・展望大浴場・貸切風呂 / 効能：神経痛、関節痛、冷え性、疲労回復、きりきず、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">11月解禁の境港直送松葉がにフルコース、鳥取和牛オレイン55の陶板焼き、日本海地魚のお造り盛り合わせ、大山おこわ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">波打ち際に佇み、客室や露天風呂から望む日本海の朝焼けと夕景は格別。大山紅葉ドライブ後の塩化物泉の温まり効果で疲労すっきり。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR山陰本線「米子駅」より路線バスで約20分「皆生温泉」下車徒歩約3分 / 米子自動車道「米子IC」より車で約10分 / 米子鬼太郎空港より車で約20分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">かいけおんせん かいけきくのや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">皆生温泉　皆生菊乃家</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.46 <span className="text-xs text-stone-500 font-normal">(1409件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                日本海と白砂青松の海岸通りに面した純和風の美食温泉旅館。毎晩ロビーで開催される無料の生演奏や、板前が技を凝らす山陰の旬会席が絶賛される宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉（源泉かけ流し） / 露天風呂・大浴場・足湯 / 効能：美肌、リウマチ、神経痛、冷え性、胃腸機能低下、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">活松葉がにづくし会席（焼きがに・かに刺し・かに鍋）、鳥取県産黒毛和牛ステーキ、大山鶏の炭火焼き、境港の鮮魚</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">温かいもてなしと心地よい和空間。海風を感じる露天風呂で塩化物泉を満喫し、山陰の冬の味覚を心ゆくまで堪能できる名宿。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">米子駅より皆生温泉行きバス約20分（バス停より徒歩約1分） / 米子ICより車で約10分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">かいけおんせん ゆきぼう はくせん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">皆生温泉　湯喜望　白扇</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.28 <span className="text-xs text-stone-500 font-normal">(1942件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                全館畳敷きの心地よさと全客室展望ジャグジー・露天風呂付きを誇る高級温泉旅館。日本海を一望する絶好のロケーションと、贅を尽くした蟹・和牛会席が人気。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉 / 展望大浴場・客室展望風呂 / 効能：冷え性、神経痛、筋肉痛、五十肩、健康増進、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">タグ付き活松葉がに姿茹で・炭火焼き、鳥取和牛のしゃぶしゃぶ会席、紅ズワイガニの甲羅焼き、山陰の旬魚握り</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">素足で過ごせる全館畳敷きの贅沢。全室から日本海の水平線を見渡し、プライベートな展望風呂でゆったりと秋の休日を過ごせます。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR米子駅より車またはバスで約15分 / 米子ICより車で約10分 / 米子空港よりタクシーで約20分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月中旬〜11月下旬（大山鍵掛峠の紅葉・11月6日松葉がに漁解禁・皆生温泉海辺夕日））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
