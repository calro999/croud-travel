...
export const metadata: Metadata = {
  ...
  keywords: ["tokyo-niigata-bus-vs-shinkansen-guide", "高速バス", "バスツアー", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["tokyo-niigata-bus-vs-shinkansen-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for tokyo-niigata-bus-vs-shinkansen-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "08:00",
        "title": "池袋駅東口またはバスタ新宿から高速バス乗車",
        "desc": "関越自動車道を走り越後山脈へ。越後川口SAで信濃川の雄大な蛇行を眺めて休憩。"
      },
      {
        "time": "13:00",
        "title": "万代シテイバスセンター到着＆名物「黄色いカレー」",
        "desc": "バスを降りてすぐ！立ち食いそば「万代そば」で昔懐かしいスパイシーな黄色いカレー。"
      },
      {
        "time": "14:30",
        "title": "新潟駅「ぽんしゅ館」で越後全酒蔵の利き酒体験",
        "desc": "500円でコイン5枚とお猪口を受け取り、100種類以上の新潟の地酒サーバーから飲み比べ。"
      },
      {
        "time": "17:00",
        "title": "新潟駅前・信濃川沿いの天然温泉大浴場付きホテルチェックイン",
        "desc": "バス移動の疲れを温泉とサウナでリフレッシュ。"
      },
      {
        "time": "19:00",
        "title": "古町・駅前居酒屋で「ノドグロ塩焼き」＆「極み寿司」",
        "desc": "日本海の脂の乗ったノドグロと南魚沼産コシヒカリのシャリが織りなす極上寿司と地酒。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "08:30",
        "title": "日本海の台所「ピアBandai」で朝どれ鮮魚朝食",
        "desc": "市場直営の回転寿司「弁慶」や海鮮直売所で佐渡産の寒ブリや南蛮エビを堪能。"
      },
      {
        "time": "11:00",
        "title": "新潟総鎮守「白山神社」参拝＆信濃川やすらぎ堤散歩",
        "desc": "縁結びの神様を参拝し、信濃川沿いの美しい遊歩道をのんびり散策。"
      },
      {
        "time": "14:00",
        "title": "新潟駅CoCoLoでお土産ショッピング",
        "desc": "「笹団子」「へぎそば」「加島屋の鮭茶漬け」「サラダホープ」を購入。"
      },
      {
        "time": "15:30",
        "title": "新潟駅から高速バス乗車〜東京へ",
        "desc": "夕方の高速バスで夜20時半頃に東京・池袋へ帰還。"
      }
    ]
  }
];
    ...
    <div className="space-y-12 max-w-5xl mx-auto pb-16">
      ...
      <section className="bg-white border border-slate-200 rounded-3xl p-6 md:p-10 shadow-sm space-y-8">
        <div className="border-b border-slate-100 pb-4">
          ...
          <h2 className="text-xl md:text-2xl font-black font-journal-serif text-slate-900">
            新潟駅万代口・南口徒歩5分以内！天然温泉大浴場＆郷土料理朝食の宿
          </h2>
          <p className="text-xs md:text-sm text-slate-600 mt-1">
