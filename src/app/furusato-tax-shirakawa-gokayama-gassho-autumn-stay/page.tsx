...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の富山・五箇山＆庄川温泉郷特集！山里に佇む世界遺産・五箇山合掌造り集落（相倉・菅沼）の日本の原風景紅葉、庄川峡の断崖を巡る紅葉遊覧船クルーズ、エメラルドグリーンの湖畔に湧く庄川温泉郷の名湯、名物「庄川鮎」塩焼きと富山湾の海の幸をふるさと納税で堪能。',
    url: 'https://croud-travel.com/furusato-tax-shirakawa-gokayama-gassho-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "世界遺産・五箇山合掌造りと庄川峡紅葉遊覧船！庄川温泉郷の美肌湯・秋の鮎料理と富山地酒を味わう秋旅",
    "description": "10月・11月の富山・五箇山＆庄川温泉郷特集！山里に佇む世界遺産・五箇山合掌造り集落（相倉・菅沼）の日本の原風景紅葉、庄川峡の断崖を巡る紅葉遊覧船クルーズ、エメラルドグリーンの湖畔に湧く庄川温泉郷の名湯、名物「庄川鮎」塩焼きと富山湾の海の幸をふるさと納税で堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-shirakawa-gokayama-gassho-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "南砺・五箇山・庄川温泉郷の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月下旬（庄川峡紅葉クルーズ・五箇山合掌集落の紅葉・庄川の秋鮎・富山新米）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の南砺・五箇山・庄川温泉郷旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の南砺・五箇山・庄川温泉郷は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月中旬〜11月下旬（庄川峡紅葉クルーズ・五箇山合掌集落の紅葉・庄川の秋鮎・富山新米）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">富山・五箇山＆庄川温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の南砺・五箇山・庄川温泉郷の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              富山県を代表する景勝地・温泉地である南砺・五箇山・庄川温泉郷は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月中旬〜11月下旬（庄川峡紅葉クルーズ・五箇山合掌集落の紅葉・庄川の秋鮎・富山新米）</li>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">しょうがわおんせんきょう となみのしょうがわそういちまんてい</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">庄川温泉郷　美肌の湯　となみ野庄川荘一萬亭（ＢＢＨホテルグループ）</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.09 <span className="text-xs text-stone-500 font-normal">(151件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥6,500〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                庄川の清流を見下ろす高台に位置し、充実の無料サービスと良質な温泉が自慢の温泉ホテル。庄川峡の美しい景色を望む露天風呂と、富山の味覚バイキング・会席が人気。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物・炭酸水素塩温泉 / 庄川を望む露天風呂・大浴場・サウナ / 効能：美肌、神経痛、筋肉痛、冷え性、関節痛、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">富山名物ます寿司、紅ズワイガニ料理、富山湾産白えびのかき揚げ、庄川鮎の塩焼き、富山県産コシヒカリ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">庄川峡遊覧船乗り場まで車で約5分。無料アルコールバーやマッサージチェアなどサービス満載で、五箇山観光の拠点としてコスパ抜群。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR城端線「砺波駅」より車で約15分（無料送迎あり要予約） / 北陸自動車道「砺波IC」より車で約15分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">しょうがわおんせんきょう とりごえのやど さんらくえん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">庄川温泉郷　鳥越の宿　三楽園</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.58 <span className="text-xs text-stone-500 font-normal">(831件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥15,279〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                全国でも珍しい「炭酸水素塩泉（白湯）」と「炭酸鉄泉（赤茶色の濁り湯）」の2つの異なる自家源泉を持つ高級温泉旅館。肌を磨く泥パックと、富山の極上会席が絶賛される宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム-炭酸水素塩泉＆ナトリウム・カルシウム-塩化物温泉（2つの異なる源泉） / 露天風呂「鳥越の湯」・ファンゴ泥セラピー・貸切風呂 / 効能：美肌、皮膚病、リウマチ、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">富山湾の朝獲れ鮮魚お造り、A5ランク富山牛の炭火焼き、庄川産天然鮎、五箇山豆腐、富山名産白えび釜飯</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">2色の自家源泉で楽しむ至極の湯浴み。エステと温泉泥パックで美肌を極め、女性やカップルの記念日旅行に最高峰の人気。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">砺波駅より車で約15分（無料送迎あり） / 砺波ICより車で約15分 / 富山空港より車で約40分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F12602%2F12602.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">しょうがわおんせん ふうりゅうみじどうざしき ゆめつづり</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">庄川温泉風流味道座敷　ゆめつづり</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.51 <span className="text-xs text-stone-500 font-normal">(346件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥13,310〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                庄川のせせらぎを聞く数寄屋造りの風情ある和風温泉旅館。多彩な露天風呂や檜風呂と、富山湾の旬魚や五箇山の山の幸をふんだんに盛り込んだ本格会席が評判。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物泉 / 庭園露天風呂「かわせみの湯」・大浴場・貸切風呂 / 効能：神経痛、筋肉痛、五十肩、冷え性、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">庄川の清流鮎炭火焼き会席、氷見牛ステーキ、白えびと旬魚のお造り盛り合わせ、新米富山米、地酒ペアリング</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">せせらぎが心地よい庭園露天風呂。五箇山合掌集落や白川郷へのドライブコースとしても絶好のロケーション。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR砺波駅よりバスまたはタクシーで約20分（送迎あり） / 砺波ICより車で約20分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F52137%2F52137.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月中旬〜11月下旬（庄川峡紅葉クルーズ・五箇山合掌集落の紅葉・庄川の秋鮎・富山新米））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
