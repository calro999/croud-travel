...
export default function Page() {
  ...
  const hotels = [
  {
    ...
    "reviewCount": 147,
    "reviewAverage": 4.6,
    "userReview": "館内も綺麗でサウナとバイキングが最高館内もきれいだしお風呂、サウナとてもよかったですバイキングも最高でした。またきます。クチコミの詳細はこちらから　https://review.travel.…　2026-07-26 17:33:13投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=187462\" class=\"3click\">つづきはこちら</a>",
  ...
  },
  {
    ...
    "reviewCount": 2752,
    "reviewAverage": 3.98,
    "userReview": "アメニティ充実とシモンズのベッドで満足久しぶりのリピート宿泊。以前からの懸案事項の風呂の化粧水がなかった件は解消されていた。フロント前で自分でアメニティを選ぶ場所に化粧水、乳液、クレンジング、洗顔…　2026-08-30 20:26:26投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=4933\" class=\"3click\">つづきはこちら</a>",
