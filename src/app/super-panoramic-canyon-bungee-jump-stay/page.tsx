...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "【日本一のバンジージャンプ】竜神大吊橋・みなかみ渓谷の絶叫体験と名湯温泉宿5選",
    description: "高さ100mの橋から大自然の渓谷へ飛び込む究極のスリル！バンジージャンプで度胸試し＆大興奮した後は、水上温泉や奥久慈温泉の渓谷露天風呂とサウナで心身をじんわりほぐす人気アクティビティ宿を厳選。",
    url: 'https://croud-travel.com/super-panoramic-canyon-bungee-jump-stay',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "【日本一のバンジージャンプ】竜神大吊橋・みなかみ渓谷の絶叫体験と名湯温泉宿5選",
      }
    ],
  },
  twitter: {
...
export default function FeaturePage() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "【日本一のバンジージャンプ】竜神大吊橋・みなかみ渓谷の絶叫体験と名湯温泉宿5選",
    "description": "高さ100mの橋から大自然の渓谷へ飛び込む究極のスリル！バンジージャンプで度胸試し＆大興奮した後は、水上温泉や奥久慈温泉の渓谷露天風呂とサウナで心身をじんわりほぐす人気アクティビティ宿を厳選。",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://croud-travel.com/super-panoramic-canyon-bungee-jump-stay"
    }
  };
  ...
  return (
    <article className="min-h-screen bg-gradient-to-b from-stone-50 via-white to-stone-50 text-stone-800">
      ...
      <section className="relative h-[480px] md:h-[580px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/90 text-white text-sm font-semibold tracking-wider mb-6 shadow-lg backdrop-blur-sm">
            ...
            <span>絶叫バンジー＆渓谷名湯</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight drop-shadow-md">
            【日本一のバンジージャンプ】竜神大吊橋・みなかみ渓谷の絶叫体験と名湯温泉宿5選
          </h1>
          <p className="text-base md:text-xl text-stone-100 max-w-2xl mx-auto font-medium leading-relaxed drop-shadow">
            高さ100mの橋から大自然の渓谷へ飛び込む究極のスリル！バンジージャンプで度胸試し＆大興奮した後は、水上温泉や奥久慈温泉の渓谷露天風呂とサウナで心身をじんわりほぐす人気アクティビティ宿を厳選。
          </p>
        </div>
      </section>
      ...
      <nav className="max-w-5xl mx-auto px-4 py-4 text-xs md:text-sm text-stone-500 flex items-center gap-1.5 overflow-x-auto">
        ...
        <ChevronRight className="w-3.5 h-3.5 text-stone-400 shrink-0" />
        <span className="text-stone-800 font-medium truncate">【日本一のバンジージャンプ】竜神大吊橋・みなかみ渓谷の絶叫体験と名湯温泉宿5選</span>
      </nav>
        ...
        <section className="bg-white rounded-2xl p-6 md:p-10 shadow-sm border border-stone-200/80">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900">
              渓谷に向かって大ジャンプ！究極のアドベンチャーと渓流露天風呂で叶える最高のリフレッシュ
            </h2>
          </div>
          <p className="text-stone-700 leading-relaxed text-base md:text-lg mb-8">
            日本有数の高さを誇るバンジージャンプスポット・竜神大吊橋やみなかみ諏訪峡。大自然の絶景の中にダイブする爽快感と達成感は、人生の忘れられないハイライトになります。ジャンプ後は宿の温泉へ直行し、川のせせらぎを聴く露天風呂で緊張を一気にリリース。上州牛や常陸牛のすき焼き・ステーキを味わい、エネルギーを満タンにチャージしましょう。
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 pt-6 border-t border-stone-100">
            <div className="p-4 rounded-xl bg-stone-50 border border-stone-100">
              ...
              <h3 className="font-bold text-stone-900 mb-1">プロ公認！日本最高峰バンジージャンプ</h3>
              <p className="text-xs md:text-sm text-stone-600 leading-relaxed">高さ100mから渓谷へダイブ！安全基準を満たした本格ツアーで安心・安全に体験。</p>
            </div>
            <div className="p-4 rounded-xl bg-stone-50 border border-stone-100">
              <div className="flex items-center gap-2 text-amber-600 font-bold mb-2">
                <CheckCircle2 className="w-5 h-5" />
              ...
              <h3 className="font-bold text-stone-900 mb-1">緊張を解きほぐす渓流パノラマ露天風呂</h3>
              <p className="text-xs md:text-sm text-stone-600 leading-relaxed">マイナスイオンあふれる川沿いの温泉。筋肉を和らげる美肌の単純温泉。</p>
            </div>
            <div className="p-4 rounded-xl bg-stone-50 border border-stone-100">
              <div className="flex items-center gap-2 text-amber-600 font-bold mb-2">
                <CheckCircle2 className="w-5 h-5" />
              ...
              <h3 className="font-bold text-stone-900 mb-1">スタミナ満点！ブランド和牛と山の幸会席</h3>
              <p className="text-xs md:text-sm text-stone-600 leading-relaxed">上州牛や常陸牛の鉄板焼き、採れたて山菜やキノコを贅沢に使った滋味あふれる料理。</p>
            </div>
          </div>
        </section>
