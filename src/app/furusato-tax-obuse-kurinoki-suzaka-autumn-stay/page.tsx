...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の長野・小布施＆須坂特集！葛飾北斎が晩年を過ごした小布施の「栗の小径」と秋限定の極上新栗モンブラン・栗おこわ、蔵の町・須坂の歴史散策、北信濃の名湯・須坂温泉や小布施温泉の美肌露天風呂、信州プレミアム牛と信州りんごをふるさと納税で堪能。',
    url: 'https://croud-travel.com/furusato-tax-obuse-kurinoki-suzaka-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "小布施・栗の小径の新栗グルメと須坂温泉！北信濃の秋果実（ぶどう・りんご）・信州牛を味わう極上温泉旅",
    "description": "10月・11月の長野・小布施＆須坂特集！葛飾北斎が晩年を過ごした小布施の「栗の小径」と秋限定の極上新栗モンブラン・栗おこわ、蔵の町・須坂の歴史散策、北信濃の名湯・須坂温泉や小布施温泉の美肌露天風呂、信州プレミアム牛と信州りんごをふるさと納税で堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-obuse-kurinoki-suzaka-autumn-stay"
  };
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月〜11月中旬（小布施新栗まつり・栗おこわ・須坂蔵の街もみじ・信州りんご・ぶどう収穫）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の小布施・須坂・北信濃は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月〜11月中旬（小布施新栗まつり・栗おこわ・須坂蔵の街もみじ・信州りんご・ぶどう収穫）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">長野・小布施＆須坂温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の小布施・須坂・北信濃の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              長野県を代表する景勝地・温泉地である小布施・須坂・北信濃は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月〜11月中旬（小布施新栗まつり・栗おこわ・須坂蔵の街もみじ・信州りんご・ぶどう収穫）</li>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">すざかおんせん こじょうそう</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">須坂温泉　古城荘</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 3.86 <span className="text-xs text-stone-500 font-normal">(182件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥9,340〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                須坂の小高い丘に建ち、北アルプスと北信濃の山並みを見晴らす静寂の温泉宿。自家源泉の天然温泉と、信州の旬食材をふんだんに盛り込んだ創作会席が好評。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">単純温泉（弱アルカリ性・自家源泉かけ流し） / 庭園露天風呂・大浴場・信楽焼壺風呂 / 効能：神経痛、筋肉痛、関節痛、冷え性、疲労回復、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">信州牛の石焼きステーキ会席、小布施栗を使った栗おこわ、北信濃の旬野菜天ぷら、信州の手打ちそば</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">小布施の街並みへ車で約10分の好立地。緑豊かな庭園露天風呂で名湯に浸かり、秋の味覚を贅沢に味わう癒やしの宿。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">長野電鉄「須坂駅」よりタクシーで約8分（無料送迎あり要予約） / 上信越自動車道「須坂長野東IC」より車で約15分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F144487%2F144487.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">しぶおんせん たまきゅうりょかん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">渋温泉　玉久旅館</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.72 <span className="text-xs text-stone-500 font-normal">(627件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                小布施からも近い名湯・渋温泉に佇む、手作り料理と源泉かけ流しの湯が自慢の純和風旅館。九つの外湯めぐりと、信州の温かい家庭料理が評判。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-硫酸塩・塩化物温泉（源泉100%完全かけ流し） / 天然温泉内湯・貸切風呂 / 効能：美肌、リウマチ、神経痛、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">信州牛の陶板焼き、清流イワナの塩焼き、自家製山菜料理、手打ち信州そば、北信州のコシヒカリ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">下駄の音が心地よい石畳の渋温泉街。小布施の栗スイーツ巡りとあわせて、情緒あふれる外湯めぐりを心ゆくまで満喫。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">長野電鉄「湯田中駅」より路線バスで約10分 / 信州中野ICより車で約20分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">おぶせおんせん あけびのゆ</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">小布施温泉あけびの湯</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.27 <span className="text-xs text-stone-500 font-normal">(339件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                小布施の高台に位置し、北アルプス五岳と北信五岳の絶景パノラマを一望できる天然温泉宿。時間によって色を変える神秘の硫黄泉と、地場産グルメが人気。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">含硫黄-ナトリウム・カルシウム-塩化物・硫酸塩温泉（硫黄泉・白濁〜緑色） / 絶景展望大浴場・露天風呂 / 効能：美肌、慢性皮膚病、神経痛、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">信州ポークのせいろ蒸し、小布施栗ごはん、北信濃の採れたて旬野菜御膳、信州地ワイン・地酒</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">北信五岳を一望する開放的な展望露天風呂。湯花漂う硫黄泉で肌を磨き、小布施の散策後の疲れをすっきり解消。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">長野電鉄「小布施駅」よりタクシーで約8分 / 上信越道「小布施スマートIC」より車で約7分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月〜11月中旬（小布施新栗まつり・栗おこわ・須坂蔵の街もみじ・信州りんご・ぶどう収穫））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
