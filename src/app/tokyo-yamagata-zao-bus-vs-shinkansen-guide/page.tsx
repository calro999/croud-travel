...
export const metadata: Metadata = {
  ...
  keywords: ["tokyo-yamagata-zao-bus-vs-shinkansen-guide", "高速バス", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["tokyo-yamagata-zao-bus-vs-shinkansen-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for tokyo-yamagata-zao-bus-vs-shinkansen-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "06:30",
        "title": "山形駅東口到着＆駅ナカカフェモーニング",
        "desc": "夜行バスで早朝到着。駅前で荷物を預けて身軽に観光スタート。"
      },
      {
        "time": "08:00",
        "title": "JR仙山線で約20分「山寺（宝珠山立石寺）」へ",
        "desc": "松尾芭蕉ゆかりの名刹。1015段の石段を登り、五大堂から見下ろす息をのむ絶景パノラマ。"
      },
      {
        "time": "11:30",
        "title": "山寺門前で名物「板そば」＆「力こんにゃく」ランチ",
        "desc": "風味豊かな太打ち田舎そばと、味がしっかり染みた熱々の玉こんにゃく。"
      },
      {
        "time": "14:00",
        "title": "山形駅から路線バスで「蔵王温泉」へ移動（約45分）",
        "desc": "標高約880mの温泉街へ。乳白色で強酸性の名湯「蔵王大露天風呂」で森林浴入浴。"
      },
      {
        "time": "16:30",
        "title": "蔵王温泉の名旅館チェックイン＆源泉かけ流し",
        "desc": "硫黄の香り漂う極上の美肌湯。夕食はとろける霜降り山形牛の陶板焼き会席。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "09:00",
        "title": "蔵王ロープウェイで地蔵山頂駅へ（標高1661m）",
        "desc": "雄大な蔵王連峰を一望し、蔵王地蔵尊にお参り。"
      },
      {
        "time": "12:30",
        "title": "山形市内へ戻り名物「冷やしらーめん」ランチ（栄屋本店）",
        "desc": "氷が浮かぶ澄んだスープにコクがある元祖冷やしらーめん。"
      },
      {
        "time": "14:30",
        "title": "山形駅「エスパル山形」でお土産ショッピング",
        "desc": "「さくらんぼスイーツ」「山形ラ・フランス」「ミルクケーキ」「山形牛しぐれ煮」を購入。"
      },
      {
        "time": "16:00",
        "title": "帰路（山形新幹線または夕方の高速バスで東京へ）",
        "desc": "米沢牛弁当を車内で味わいながら東京へ帰還。"
      }
    ]
  }
];
    ...
    <div className="space-y-12 max-w-5xl mx-auto pb-16">
      ...
      <section className="bg-white border border-slate-200 rounded-3xl p-6 md:p-10 shadow-sm space-y-8">
        <div className="border-b border-slate-100 pb-4">
          ...
          <h2 className="text-xl md:text-2xl font-black font-journal-serif text-slate-900">
            開湯1900年！乳白色の強酸性源泉と山形牛が自慢の蔵王名旅館
          </h2>
          <p className="text-xs md:text-sm text-slate-600 mt-1">
