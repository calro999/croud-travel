...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月中旬〜11月上旬に見頃を迎える谷川岳ロープウェイ・一ノ倉沢の紅葉絶景。利根川の渓流を望む水上温泉郷の名旅館で、上州牛・川場サーモン・旬のキノコをふるさと納税でお得に味わう完全ガイド。',
    url: 'https://croud-travel.com/furusato-tax-minakami-tanigawadake-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "谷川岳一ノ倉沢の岩壁紅葉と利根川渓谷美＆みなかみ温泉郷の源泉湯宿・上州牛会席",
    "description": "10月中旬〜11月上旬に見頃を迎える谷川岳ロープウェイ・一ノ倉沢の紅葉絶景。利根川の渓流を望む水上温泉郷の名旅館で、上州牛・川場サーモン・旬のキノコをふるさと納税でお得に味わう完全ガイド。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-minakami-tanigawadake-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "みなかみ・谷川岳・水上温泉郷の秋（10月〜11月）の見どころや旬の味覚は？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月上旬の荒々しい岩壁を染める紅葉と渓谷美が最高のシーズンです。息をのむ秋の絶景とともに、この時期にしか味わえない旬のブランド食材や名物鍋をご堪能いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋のみなかみ・谷川岳・水上温泉郷旅行のおすすめの過ごし方は？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <header className="relative bg-gradient-to-br from-amber-950 via-stone-900 to-amber-900 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight mb-6">
            谷川岳一ノ倉沢の岩壁紅葉と利根川渓谷美＆みなかみ温泉郷の源泉湯宿・上州牛会席
          </h1>
          <p className="text-base sm:text-lg text-amber-100 max-w-3xl leading-relaxed">
            天を突く谷川岳の岸壁に映える錦秋のグラデーション。利根川のせせらぎと名湯、上州牛会席に癒やされる秋旅。
          </p>
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月中旬〜11月上旬の荒々しい岩壁を染める紅葉と渓谷美</span>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-amber-950 border-b-2 border-amber-600 pb-3 mb-6">
            はじめに：10月・11月のみなかみ・谷川岳・水上温泉郷で叶える極上の秋旅
          </h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            秋が深まる10月から11月、群馬県・みなかみ・谷川岳・水上温泉郷エリアは一年の中で最も豊かで魅力的な表情を見せてくれます。澄み切った秋空に映える山々や渓谷のグラデーション、歴史ある町並みに漂う秋の情緒、そしてこの季節ならではの極上グルメが旅人を迎えます。
          </p>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <p className="text-slate-700 leading-relaxed">
            本記事では、みなかみ・谷川岳・水上温泉郷エリアで高い評価を獲得しているおすすめの名宿3選を詳しくご紹介します。楽天ふるさと納税を活用すれば、実質自己負担わずか2,000円でお得に宿泊クーポンを取得可能。賢く上質な大人の秋旅を計画しましょう。
          </p>
        </section>
        ...
        <section className="bg-amber-50 rounded-2xl p-6 sm:p-8 border border-amber-200 mb-12">
          <h3 className="text-lg sm:text-xl font-bold text-amber-900 mb-4 flex items-center gap-2">
            <span>🍁</span> みなかみ・谷川岳・水上温泉郷 秋旅の3大魅力ポイント
          </h3>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">水上温泉 ペンション 朝ねぼう</h3>
              <p className="text-xs text-slate-500">みなかみおんせん ぺんしょん あさねぼう</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.86点 <span className="text-xs font-normal text-slate-600">(324件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/2497/2497.jpg"
                alt="水上温泉 ペンション 朝ねぼうの外観・温泉風景"
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  ゴールデンレトリバーたちが温かく出迎えてくれる、みなかみ高原の看板犬ペンション。天然温泉の貸切風呂と、ボリューム満点の自家製欧風フルコースディナーでリピーター多数。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  アルカリ性単純温泉（みなかみ温泉引湯） / 24時間貸切天然温泉 / 効能：美肌効果、疲労回復、筋肉痛、冷え性、関節痛
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR上越線「水上駅」より車で約10分（送迎あり要連絡） / 関越自動車道「水上IC」より車で約15分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                上州牛のローストビーフ、上州麦豚のポワレ、地元みなかみ産高原野菜のサラダ、自家製焼きたてパン、手作り特製デザート
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                愛らしい看板犬との触れ合いと、温かなおもてなし。谷川岳の紅葉ハイキングの疲れを天然温泉と絶品ディナーで心地よく癒やせます。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D2497"
              target="_blank"
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">水上温泉 あらたし みなかみ</h3>
              <p className="text-xs text-slate-500">みなかみおんせん あらたし みなかみ</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.42点 <span className="text-xs font-normal text-slate-600">(608件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  利根川の清流を望む絶景ロケーションに誕生した新感覚モダン温泉旅館。全室リバービューの客室や開放的なテラス、川のせせらぎを聴く大浴場で上質なリフレッシュを提供。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  カルシウム・ナトリウム-硫酸塩・塩化物温泉（弱アルカリ性低張性高温泉） / 効能：動脈硬化、美肌、きりきず、やけど、疲労回復、神経痛
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR上越線「水上駅」より徒歩約13分（無料送迎あり） / 関越自動車道「水上IC」より車で約5分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                上州牛と地元野菜のグリル会席、みなかみ名水で仕込んだ川場サーモンのお造り、群馬県産こんにゃくの創作前菜、地酒ペアリング
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                洗練された北欧×和モダンのデザイン空間。テラスのソファに腰掛け、利根川沿いに広がる紅葉パノラマとせせらぎに身を委ねる極上ステイ。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D184453"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">水上温泉 おやど 松葉屋</h3>
              <p className="text-xs text-slate-500">みなかみおんせん おやど まつばや</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.3点 <span className="text-xs font-normal text-slate-600">(238件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/31846/31846.jpg"
                alt="水上温泉 おやど 松葉屋の外観・温泉風景"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  水上温泉街の中心に佇む、純和風の落ち着いた佇まいの老舗旅館。湯量豊富な源泉かけ流しの天然温泉と、上州の四季を盛り込んだ手作り会席料理が自慢。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  カルシウム・ナトリウム-硫酸塩温泉（弱アルカリ性） / 源泉かけ流し / 効能：神経痛、筋肉痛、五十肩、運動麻痺、慢性消化器病、疲労回復
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR水上駅より徒歩約10分（送迎あり） / 関越道・水上ICより車で約8分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                上州牛のすき焼き鍋会席、名物岩魚の塩焼き、舞茸の土瓶蒸し（秋季限定）、地場契約農家直送コシヒカリご飯
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                木の香り漂う大浴場と露天風呂で24時間いつでも湯浴み可能。どこか懐かしい日本の温泉宿の真心こもるもてなしに心が和みます。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D31846"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
        ...
        <section className="bg-gradient-to-br from-amber-950 to-stone-900 text-white rounded-2xl p-6 sm:p-8 shadow-lg mb-12">
          ...
          <p className="text-stone-200 text-sm sm:text-base leading-relaxed mb-6">
            楽天ふるさと納税を利用すれば、群馬県内の対象宿泊施設で使える楽天トラベルクーポンが寄付額に応じて返礼品として付与されます。実質負担2,000円で高級宿に泊まれるお得な活用法をチェックしましょう。
          </p>
          ...
          <div className="space-y-6">
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
                <span className="text-amber-600 font-bold">Q.</span> みなかみ・谷川岳・水上温泉郷の秋のベストシーズンはいつですか？
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                例年10月中旬〜11月上旬の荒々しい岩壁を染める紅葉と渓谷美が最高の見頃となります。標高差や気候に合わせて色づきや食材の旬が移り変わり、10月から11月下旬まで長く楽しめます。
              </p>
            </div>
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                10月〜11月のみなかみ・谷川岳・水上温泉郷は朝晩の冷え込みが予想されます。日中は薄手のアウターで快適ですが、早朝や夜間、山間部の散策には防風ジャケットやフリース、歩きやすい靴をご用意ください。
              </p>
            </div>
          </div>
        </section>
