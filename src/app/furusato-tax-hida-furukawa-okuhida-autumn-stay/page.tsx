...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の岐阜・飛騨古川＆奥飛騨温泉郷特集！瀬戸川沿いの白壁土蔵と錦鯉が美しい飛騨古川の秋散策、標高2,156m雲上の紅葉を望む新穂高ロープウェイ、日本屈指の露天風呂天国・奥飛騨温泉郷の源泉かけ流し湯めぐり、A5等級飛騨牛をふるさと納税で堪能。',
    url: 'https://croud-travel.com/furusato-tax-hida-furukawa-okuhida-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "飛騨古川の白壁土蔵街と新穂高ロープウェイ！奥飛騨温泉郷の紅葉露天・最高級飛騨牛を味わう秋旅",
    "description": "10月・11月の岐阜・飛騨古川＆奥飛騨温泉郷特集！瀬戸川沿いの白壁土蔵と錦鯉が美しい飛騨古川の秋散策、標高2,156m雲上の紅葉を望む新穂高ロープウェイ、日本屈指の露天風呂天国・奥飛騨温泉郷の源泉かけ流し湯めぐり、A5等級飛騨牛をふるさと納税で堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-hida-furukawa-okuhida-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "飛騨古川・奥飛騨温泉郷・新穂高の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月上旬（新穂高ロープウェイ北アルプス紅葉・飛騨古川散策・飛騨牛・新そば）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の飛騨古川・奥飛騨温泉郷・新穂高旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の飛騨古川・奥飛騨温泉郷・新穂高は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月中旬〜11月上旬（新穂高ロープウェイ北アルプス紅葉・飛騨古川散策・飛騨牛・新そば）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">岐阜・飛騨古川＆奥飛騨温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の飛騨古川・奥飛騨温泉郷・新穂高の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              岐阜県を代表する景勝地・温泉地である飛騨古川・奥飛騨温泉郷・新穂高は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月中旬〜11月上旬（新穂高ロープウェイ北アルプス紅葉・飛騨古川散策・飛騨牛・新そば）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の飛騨古川・奥飛騨温泉郷・新穂高を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">ひだふるかわとうげんきょうおんせん ほてる きごり</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">飛騨古川桃源郷温泉　ホテル　季古里</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.26 <span className="text-xs text-stone-500 font-normal">(407件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥8,700〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                飛騨古川の里山に建つ、飛騨の木造建築の美を凝らした温泉リゾートホテル。天然ラドンを豊富に含む桃源郷温泉と、飛騨牛を中心とした郷土会席料理が人気。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">単純弱放射能冷鉱泉（天然ラドン温泉） / 露天風呂・大浴場・檜風呂 / 効能：神経痛、筋肉痛、冷え性、高血圧症、疲労回復、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">A5等級飛騨牛の朴葉味噌ステーキ、飛騨清流イワナのお造り・塩焼き、飛騨産コシヒカリ、地場産旬野菜の天ぷら</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">木の温もりあふれる落ち着いた館内。白壁土蔵街への散策拠点に最適で、静かな里山の空気と良質な温泉で心身をリセット。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR高山本線「飛騨古川駅」より車で約15分（無料送迎バスあり要予約） / 中部縦貫道「高山IC」より車で約30分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F50478%2F50478.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">りょうていりょかん やつさんかん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">料亭旅館　八ツ三館</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.86 <span className="text-xs text-stone-500 font-normal">(956件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥29,500〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                創業百六十余年、国登録有形文化財の雅な数寄屋建築を誇る飛騨古川最高峰の料亭旅館。天然温泉「すっぴんの湯」と、職人の技が光る飛騨の贅を尽くした極上会席が絶賛される宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">単純温泉（自家源泉「すっぴんの湯」） / 庭園露天風呂・せせらぎの湯・大浴場・貸切風呂 / 効能：美肌、神経痛、冷え性、疲労回復、筋肉痛</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">料亭仕立ての特選飛騨牛懐石、飛騨の地野菜と川魚の逸品、飛騨古川の地酒「蓬莱」「白真弓」、釜炊き飛騨米</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">国の有形文化財に泊まる非日常の体験。飛騨川のせせらぎを聞く露天風呂と、料亭ならではの至高の料理で記念日旅行に最高峰の満足を約束。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR飛騨古川駅より徒歩約7分（無料送迎あり） / 高山ICより車で約25分 / 富山空港より車で約60分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F29573%2F29573.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">りょうりりょかん ぶすいてい</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">料理旅館　蕪水亭</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4 <span className="text-xs text-stone-500 font-normal">(22件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥14,915〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                明治三年創業、荒城川のほとりに佇む老舗料理旅館。飛騨の薬草やジビエ、飛騨牛を巧みに使った身体に優しい本格会席と、心温まるもてなしが評判の名宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">人工温泉（生薬・ハーブ薬草風呂） / 貸切風呂 / 効能：冷え性、疲労回復、血行促進、リフレッシュ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">飛騨牛ステーキと飛騨古川薬草会席、自家製手打ち十割そば、山菜・きのこ料理、飛騨の地酒</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">飛騨の薬草文化を取り入れた唯一無二の美食体験。白壁土蔵街まで徒歩3分の好立地で、歴史情緒と心と身体を癒やす旅を堪能。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR飛騨古川駅より徒歩約5分 / 高山ICより車で約25分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F53348%2F53348.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月中旬〜11月上旬（新穂高ロープウェイ北アルプス紅葉・飛騨古川散策・飛騨牛・新そば））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
