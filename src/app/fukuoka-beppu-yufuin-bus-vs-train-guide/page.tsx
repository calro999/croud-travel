...
export const metadata: Metadata = {
  ...
  keywords: ["fukuoka-beppu-yufuin-bus-vs-train-guide", "高速バス", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["fukuoka-beppu-yufuin-bus-vs-train-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for fukuoka-beppu-yufuin-bus-vs-train-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "08:40",
        "title": "博多バスターミナルから直行高速バス「ゆふいん号」乗車",
        "desc": "九州道・大分道を快走。玖珠PAなどで休憩し由布岳の麓へ。"
      },
      {
        "time": "10:55",
        "title": "由布院駅前バスセンター到着＆手荷物配送サービス",
        "desc": "駅前のチッキ（手荷物配送）にスーツケースを預けて、手ぶらで観光へ出発。"
      },
      {
        "time": "11:30",
        "title": "湯の坪街道で食べ歩き＆名物「湯布院金賞コロッケ」",
        "desc": "情緒あるショップが立ち並ぶ通りで、焼きたてカヌレ、抹茶ジェラート、コロッケを堪能。"
      },
      {
        "time": "13:30",
        "title": "神秘の朝霧で有名な「金鱗湖」周辺散策＆湖畔カフェ",
        "desc": "温泉と清水が湧き出る金鱗湖を一周し、木漏れ日あふれるテラス席でティータイム。"
      },
      {
        "time": "15:30",
        "title": "由布岳を望む離れの隠れ家温泉旅館チェックイン",
        "desc": "客室専用露天風呂で源泉かけ流しの美肌の湯を満喫。夕食は最高級豊後牛と関アジの会席。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "09:00",
        "title": "路線バスまたはJRで別府温泉・鉄輪温泉へ移動",
        "desc": "湯けむりが立ち上る鉄輪温泉へ。"
      },
      {
        "time": "10:00",
        "title": "「海地獄」「血の池地獄」など別府地獄めぐり",
        "desc": "コバルトブルーの海地獄や真っ赤な血の池地獄を巡り、温泉卵や地獄蒸しプリンを味わう。"
      },
      {
        "time": "12:30",
        "title": "別府発祥の名物「とり天」ランチ（東洋軒など）",
        "desc": "サクサクふんわりの衣に包まれたジューシーな鶏肉を、からし酢醤油でさっぱりと。"
      },
      {
        "time": "14:30",
        "title": "別府北浜でお土産購入（ざぼん漬け・かぼすラングドシャ）",
        "desc": "大分名産のかぼす果汁や湯の花を購入。"
      },
      {
        "time": "15:30",
        "title": "別府北浜から「とよのくに号」乗車〜博多・天神へ",
        "desc": "夕方の高速バスで夜17:45頃に福岡・天神へ帰還。"
      }
    ]
  }
];
    ...
    <div className="space-y-12 max-w-5xl mx-auto pb-16">
      ...
      <section className="bg-white border border-slate-200 rounded-3xl p-6 md:p-10 shadow-sm space-y-8">
        <div className="border-b border-slate-100 pb-4">
          ...
          <h2 className="text-xl md:text-2xl font-black font-journal-serif text-slate-900">
            由布岳一望＆全室離れ露天風呂付き！由布院極上のおこもり名旅館
          </h2>
          <p className="text-xs md:text-sm text-slate-600 mt-1">
