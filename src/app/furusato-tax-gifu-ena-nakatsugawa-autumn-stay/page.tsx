...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の岐阜・東濃（恵那＆中津川）特集！木曽川のダム湖にそびえる奇岩怪石と紅葉のコントラストを水上から望む「恵那峡遊覧船」、秋限定の栗きんとん本場めぐり、恵那峡温泉の絶景露天風呂、極上飛騨牛会席をふるさと納税トラベルで味わう東濃の贅沢秋旅。',
    url: 'https://croud-travel.com/furusato-tax-gifu-ena-nakatsugawa-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "岐阜・東濃 恵那峡の奇岩紅葉クルーズ＆中津川！栗きんとん発祥の地と恵那峡温泉・飛騨牛",
    "description": "10月・11月の岐阜・東濃（恵那＆中津川）特集！木曽川のダム湖にそびえる奇岩怪石と紅葉のコントラストを水上から望む「恵那峡遊覧船」、秋限定の栗きんとん本場めぐり、恵那峡温泉の絶景露天風呂、極上飛騨牛会席をふるさと納税トラベルで味わう東濃の贅沢秋旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-gifu-ena-nakatsugawa-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "岐阜・東濃（恵那峡＆中津川）の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月上旬〜11月下旬（中津川栗きんとん旬・恵那峡紅葉ピーク）（恵那峡紅葉遊覧船・中津川栗きんとん新栗解禁・苗木城跡雲海と紅葉）が見頃のピークとなります。山々や渓谷・城下町の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "岐阜・東濃（恵那峡＆中津川）へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 岐阜・東濃（恵那峡＆中津川）</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 10月上旬〜11月下旬（中津川栗きんとん旬・恵那峡紅葉ピーク）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の岐阜・東濃（恵那峡＆中津川）を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が心地よく吹き抜け、木々が鮮やかに色づく10月・11月。日本各地がもっとも美しく、実り豊かな季節を迎えます。なかでも「岐阜・東濃（恵那峡＆中津川）」は、恵那峡紅葉遊覧船・中津川栗きんとん新栗解禁・苗木城跡雲海と紅葉など、この時期にしか出逢えない息を呑む絶景と旬の味覚が凝縮された屈指の名所です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>恵那峡（恵那峡遊覧船・奇岩群紅葉）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>苗木城跡（絶景の天空の城・木曽川パノラマ）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>馬籠宿（中山道宿場町散策）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>恵那峡ワンダーランド</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>中津川栗きんとんめぐり（すや・川上屋など）</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                中津川名物新栗栗きんとん・最高ランク飛騨牛サーロイン陶板焼き・恵那鶏・鮎の塩焼き・五平餅
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                恵那峡温泉＆中津川温泉（ナトリウム・カルシウム-塩化物泉、美肌と保温に優れた塩湯）と木曽川峡谷露天風呂
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">岐阜県恵那市大井町2709-399</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/108906/108906.jpg"
                alt="大江戸温泉物語Ｐｒｅｍｉｕｍ　恵那峡"
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 恵那駅より定期巡回バスで約10分（完全予約制）　※詳しくはお問合せ下さい</p>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F108906%2F108906.html"
              target="_blank"
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">岐阜県恵那市大井町2709</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.37
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-stone-900 text-sm">宿の魅力と秋の過ごし方</h4>
              <p className="text-sm text-stone-700 leading-relaxed">
                四季折々の渓谷美を楽しむ温泉宿＜全室恵那峡ビュー×旬の食材を取り入れた会席料理＞
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> JR中央線恵那駅から路線バスで約１５分　バス停「ゆずり葉前」下車目の前 /中央自動車道恵那IC下車10分</p>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">岐阜県中津川市神坂280</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.26
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-stone-900 text-sm">宿の魅力と秋の過ごし方</h4>
              <p className="text-sm text-stone-700 leading-relaxed">
                【2024年7月リニューアル】とろとろ美人の湯が大人気。温泉館も利用可で広々露天風呂も楽しめます！
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 中央自動車道神坂スマートＩＣ約３分、中津川ＩＣ約２０分　駐車場無料　JR中津川駅無料シャトルバス有</p>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】岐阜・東濃（恵那峡＆中津川）を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、恵那峡（恵那峡遊覧船・奇岩群紅葉）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（中津川名物新栗栗きんとんなど）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 苗木城跡（絶景の天空の城・木曽川パノラマ）へ移動。午後の柔らかな木漏れ日の中で絶景撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、馬籠宿（中山道宿場町散策）を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - 恵那峡ワンダーランドにてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 岐阜・東濃（恵那峡＆中津川）の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月上旬〜11月下旬（中津川栗きんとん旬・恵那峡紅葉ピーク）（恵那峡紅葉遊覧船・中津川栗きんとん新栗解禁・苗木城跡雲海と紅葉）が見頃のピークとなります。山々や渓谷・城下町の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 岐阜・東濃（恵那峡＆中津川）へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
