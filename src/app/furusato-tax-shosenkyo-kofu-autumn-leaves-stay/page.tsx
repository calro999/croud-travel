...
const HOTEL_DATA = {
  shosenkyo_tokiwa: {
    ...
    no: 196489,
    url: 'https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D196489',
    planUrl: 'https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2F3VTwt%2F%3Ff_no%3D196489%26f_flg%3DPLAN',
    ...
    thumb: 'https://img.travel.rakuten.co.jp/HIMG/90/196489.jpg',
    minCharge: 9900,
    rating: 4.43,
    reviews: 132,
    special: '2025年8月1日新規オープン！信玄の湯とこだわりの朝ごはんで心ほぐれるひと時を。',
    address: '山梨県甲府市湯村3-10-14',
    access: '甲府駅よりお車で約10分、中央自動車双葉ＩＣより約10分'
  },
  shosenkyo_yanagiya: {
    name: '信玄の湯　湯村温泉　常磐ホテル',
    no: 9045,
    url: 'https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D9045',
    planUrl: 'https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2F3VTwt%2F%3Ff_no%3D9045%26f_flg%3DPLAN',
    ...
    thumb: 'https://img.travel.rakuten.co.jp/HIMG/90/9045.jpg',
    minCharge: 20900,
    rating: 4.8,
    reviews: 1568,
    special: '日本旅館の感性と、都市型ホテルの利便性を兼備えた、皇室もご利用なさる甲府の迎賓館',
    address: '山梨県甲府市湯村2-5-21',
    access: '中央自動車道、甲府昭和ICから20分／甲府駅南口バスターミナル4番線15分「湯村温泉入口」下車。武田神社は車で15分'
  },
  shosenkyo_meigetsu: {
    name: '甲州湯村温泉　柳屋',
    no: 165690,
    url: 'https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D165690',
    planUrl: 'https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2F3VTwt%2F%3Ff_no%3D165690%26f_flg%3DPLAN',
    reviewUrl: 'https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FHTX0u%2F%3Ff_hotel_no%3D165690',
    img: 'https://img.travel.rakuten.co.jp/share/HOTEL/165690/165690.jpg',
    thumb: 'https://img.travel.rakuten.co.jp/HIMG/90/165690.jpg',
    minCharge: 9900,
    rating: 3.96,
    reviews: 180,
    special: '部屋から眺める自然庭園と信玄の隠し湯♪湯村温泉',
    address: '山梨県甲府市湯村3-16-2',
  ...
  return (
    <main className="min-h-screen bg-stone-100/60 text-stone-900 pb-20">
      ...
      <nav className="max-w-6xl mx-auto px-4 py-4 text-xs md:text-sm text-stone-600 flex items-center gap-2 flex-wrap">
        ...
        <span>&gt;</span>
        <span className="text-stone-800 font-medium">山梨・甲府 / 御岳昇仙峡覚円峰紅葉＆仙娥滝・信玄隠し湯湯村温泉</span>
      </nav>

      {/* ヒーローヘッダー */}
      <header className="bg-gradient-to-br from-stone-900 via-amber-950 to-red-950 text-white py-14 md:py-20 px-4 mb-10 shadow-lg">
        ...
        <article className="lg:col-span-2 space-y-10">
          ...
          <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-stone-200/80">
            ...
            <p className="text-stone-700 leading-relaxed text-sm md:text-base mb-6">
              山梨県甲府市の北部に位置する御岳昇仙峡は、国の特別名勝に指定された日本屈指の渓谷美。秋には花崗岩の断崖「覚円峰」や落差30mの「仙娥滝」がカエデやモミジで真っ赤に染まり、渓谷遊歩道散策は息をのむ美しさ。散策後は開湯1200年、武田信玄公や太宰治など文豪に愛された湯村温泉へ。豊かな湯量の天然温泉に浸かり、実りの秋を迎えた甲州ワインと甲州牛会席を味わえます。
            </p>
          ...
          <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-stone-200/80">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-4 pb-3 border-b border-stone-200">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg md:text-2xl font-bold text-stone-900">{HOTEL_DATA.shosenkyo_tokiwa.name}</h3>
              </div>
              <div className="text-xs bg-amber-100 text-amber-900 font-semibold px-2.5 py-1 rounded-full">
                ★ {HOTEL_DATA.shosenkyo_tokiwa.rating} ({HOTEL_DATA.shosenkyo_tokiwa.reviews}件)
              </div>
            </div>

            <div className="mb-6 rounded-xl overflow-hidden shadow-inner aspect-video relative bg-stone-200">
              <img
                src={HOTEL_DATA.shosenkyo_tokiwa.img}
                alt={HOTEL_DATA.shosenkyo_tokiwa.name}
            ...
            <p className="text-stone-700 text-sm md:text-base leading-relaxed mb-6">
              {HOTEL_DATA.shosenkyo_tokiwa.special}。秋の彩りに包まれる極上のロケーションで、日頃の喧騒を忘れ心身を解きほぐす至福の滞在が楽しめます。旬の地元食材をふんだんに使った豪華なお料理とともに、贅沢なひとときを過ごせます。
            </p>
            ...
            <div className="bg-stone-50 rounded-xl p-4 text-xs md:text-sm text-stone-600 space-y-2 mb-6 border border-stone-200">
              <div className="flex items-start gap-2">
                ...
                <span>{HOTEL_DATA.shosenkyo_tokiwa.address}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">アクセス:</span>
                <span>{HOTEL_DATA.shosenkyo_tokiwa.access}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">参考料金:</span>
                <span className="text-rose-600 font-bold">1名あたり {HOTEL_DATA.shosenkyo_tokiwa.minCharge.toLocaleString()}円〜（目安）</span>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href={HOTEL_DATA.shosenkyo_tokiwa.planUrl || HOTEL_DATA.shosenkyo_tokiwa.url}
                target="_blank"
              ...
              <a
                href={HOTEL_DATA.shosenkyo_tokiwa.reviewUrl || HOTEL_DATA.shosenkyo_tokiwa.url}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-stone-200/80">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-4 pb-3 border-b border-stone-200">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg md:text-2xl font-bold text-stone-900">{HOTEL_DATA.shosenkyo_yanagiya.name}</h3>
              </div>
              <div className="text-xs bg-amber-100 text-amber-900 font-semibold px-2.5 py-1 rounded-full">
                ★ {HOTEL_DATA.shosenkyo_yanagiya.rating} ({HOTEL_DATA.shosenkyo_yanagiya.reviews}件)
              </div>
            </div>

            <div className="mb-6 rounded-xl overflow-hidden shadow-inner aspect-video relative bg-stone-200">
              <img
                src={HOTEL_DATA.shosenkyo_yanagiya.img}
                alt={HOTEL_DATA.shosenkyo_yanagiya.name}
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </div>
            ...
            <p className="text-stone-700 text-sm md:text-base leading-relaxed mb-6">
              {HOTEL_DATA.shosenkyo_yanagiya.special}。清らかな空気と美しい自然の景観に囲まれ、旅情あふれる温泉と自慢の料理を堪能できます。秋の心地よい夜長を過ごすのにぴったりの癒しの空間です。
            </p>

            <div className="bg-stone-50 rounded-xl p-4 text-xs md:text-sm text-stone-600 space-y-2 mb-6 border border-stone-200">
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">住所:</span>
                <span>{HOTEL_DATA.shosenkyo_yanagiya.address}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">アクセス:</span>
                <span>{HOTEL_DATA.shosenkyo_yanagiya.access}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">参考料金:</span>
                <span className="text-rose-600 font-bold">1名あたり {HOTEL_DATA.shosenkyo_yanagiya.minCharge.toLocaleString()}円〜（目安）</span>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href={HOTEL_DATA.shosenkyo_yanagiya.planUrl || HOTEL_DATA.shosenkyo_yanagiya.url}
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 px-6 rounded-xl text-center shadow-md transition-all text-sm md:text-base flex items-center justify-center gap-2"
              >
              ...
              <a
                href={HOTEL_DATA.shosenkyo_yanagiya.reviewUrl || HOTEL_DATA.shosenkyo_yanagiya.url}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-stone-100 hover:bg-stone-200 text-stone-700 font-bold py-3.5 px-5 rounded-xl text-center border border-stone-300 text-sm transition-all"
              >
          ...
          <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-stone-200/80">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-4 pb-3 border-b border-stone-200">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg md:text-2xl font-bold text-stone-900">{HOTEL_DATA.shosenkyo_meigetsu.name}</h3>
              </div>
              <div className="text-xs bg-amber-100 text-amber-900 font-semibold px-2.5 py-1 rounded-full">
                ★ {HOTEL_DATA.shosenkyo_meigetsu.rating} ({HOTEL_DATA.shosenkyo_meigetsu.reviews}件)
              </div>
            </div>

            <div className="mb-6 rounded-xl overflow-hidden shadow-inner aspect-video relative bg-stone-200">
              <img
                src={HOTEL_DATA.shosenkyo_meigetsu.img}
                alt={HOTEL_DATA.shosenkyo_meigetsu.name}
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </div>
            ...
            <p className="text-stone-700 text-sm md:text-base leading-relaxed mb-6">
              {HOTEL_DATA.shosenkyo_meigetsu.special}。旅の目的に合わせて快適に過ごせる温かなおもてなしと充実の設備が魅力。観光や散策の拠点として最適で、心地よい秋の滞在を叶えてくれます。
            </p>

            <div className="bg-stone-50 rounded-xl p-4 text-xs md:text-sm text-stone-600 space-y-2 mb-6 border border-stone-200">
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">住所:</span>
                <span>{HOTEL_DATA.shosenkyo_meigetsu.address}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">アクセス:</span>
                <span>{HOTEL_DATA.shosenkyo_meigetsu.access}</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-bold text-stone-800 min-w-[60px]">参考料金:</span>
                <span className="text-rose-600 font-bold">1名あたり {HOTEL_DATA.shosenkyo_meigetsu.minCharge.toLocaleString()}円〜（目安）</span>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href={HOTEL_DATA.shosenkyo_meigetsu.planUrl || HOTEL_DATA.shosenkyo_meigetsu.url}
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 px-6 rounded-xl text-center shadow-md transition-all text-sm md:text-base flex items-center justify-center gap-2"
              >
              ...
              <a
                href={HOTEL_DATA.shosenkyo_meigetsu.reviewUrl || HOTEL_DATA.shosenkyo_meigetsu.url}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-stone-100 hover:bg-stone-200 text-stone-700 font-bold py-3.5 px-5 rounded-xl text-center border border-stone-300 text-sm transition-all"
              >
        ...
        <aside className="space-y-6">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-200/80 sticky top-6">
            ...
            <ul className="space-y-4 text-xs md:text-sm">
              <li>
                <a href={HOTEL_DATA.shosenkyo_tokiwa.url} target="_blank" rel="noopener noreferrer" className="block p-3 rounded-xl hover:bg-stone-50 transition border border-stone-100 hover:border-amber-200">
                  <div className="font-bold text-stone-800 line-clamp-1">{HOTEL_DATA.shosenkyo_tokiwa.name}</div>
                  <div className="text-stone-500 text-xs mt-1">★ {HOTEL_DATA.shosenkyo_tokiwa.rating} | 楽天トラベルで詳細確認</div>
                </a>
              </li>
              <li>
                <a href={HOTEL_DATA.shosenkyo_yanagiya.url} target="_blank" rel="noopener noreferrer" className="block p-3 rounded-xl hover:bg-stone-50 transition border border-stone-100 hover:border-amber-200">
                  <div className="font-bold text-stone-800 line-clamp-1">{HOTEL_DATA.shosenkyo_yanagiya.name}</div>
                  <div className="text-stone-500 text-xs mt-1">★ {HOTEL_DATA.shosenkyo_yanagiya.rating} | 楽天トラベルで詳細確認</div>
                </a>
              </li>
              <li>
                <a href={HOTEL_DATA.shosenkyo_meigetsu.url} target="_blank" rel="noopener noreferrer" className="block p-3 rounded-xl hover:bg-stone-50 transition border border-stone-100 hover:border-amber-200">
                  <div className="font-bold text-stone-800 line-clamp-1">{HOTEL_DATA.shosenkyo_meigetsu.name}</div>
                  <div className="text-stone-500 text-xs mt-1">★ {HOTEL_DATA.shosenkyo_meigetsu.rating} | 楽天トラベルで詳細確認</div>
                </a>
              </li>
            </ul>
