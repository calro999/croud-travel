...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の兵庫・城崎温泉特集！大谿川沿いの柳並木と浴衣での七湯外湯めぐり、11月6日解禁の青タグ付き最高峰「津居山かに（松葉がに）」、幻の但馬牛ステーキをふるさと納税トラベルで味わい尽くす贅沢プラン。',
    url: 'https://croud-travel.com/furusato-tax-kinosaki-tsuiyama-crab-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "城崎温泉の秋の七湯めぐりと11月解禁「津居山かに（松葉がに）」！柳並木と但馬牛を味わう極上温泉旅",
    "description": "10月・11月の兵庫・城崎温泉特集！大谿川沿いの柳並木と浴衣での七湯外湯めぐり、11月6日解禁の青タグ付き最高峰「津居山かに（松葉がに）」、幻の但馬牛ステーキをふるさと納税トラベルで味わい尽くす贅沢プラン。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-kinosaki-tsuiyama-crab-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "豊岡・城崎温泉・津居山港の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月〜11月（11月6日松葉がに・津居山かに漁解禁、外湯めぐり、但馬牛、城崎ロープウェイ紅葉）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の豊岡・城崎温泉・津居山港旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の豊岡・城崎温泉・津居山港は昼夜の寒暖差が激しくなります。日中は長袖シャツで快適ですが、早朝や夕暮れの散策・露天風呂への移動時には防寒アウター（フリースやダウン等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月〜11月（11月6日松葉がに・津居山かに漁解禁、外湯めぐり、但馬牛、城崎ロープウェイ紅葉）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">兵庫・城崎温泉＆津居山かに特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の豊岡・城崎温泉・津居山港の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              兵庫県を代表する景勝地・温泉地である豊岡・城崎温泉・津居山港は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月〜11月（11月6日松葉がに・津居山かに漁解禁、外湯めぐり、但馬牛、城崎ロープウェイ紅葉）</li>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">きのさきおんせん しののめそう</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">城崎温泉　しののめ荘</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 3.83 <span className="text-xs text-stone-500 font-normal">(121件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥11,900〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                城崎温泉街の中心近く、大谿川の奥にひっそり佇む純和風の木造温泉宿。岩風呂の天然温泉と、冬の松葉がに（津居山がに）や最高級但馬牛を味わう本格会席が評判。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物泉（低張性 中性 高温泉） / 天然岩風呂大浴場 / 効能：神経痛、筋肉痛、関節痛、五十肩、冷え性、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">11月解禁の津居山港直送活松葉がにフルコース（焼きがに・かに刺し・かにすき鍋・甲羅味噌焼き）、但馬牛ステーキ、地酒</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">外湯「地蔵湯」や「さとの湯」へも徒歩すぐ。気さくなおもてなしと、丁寧に仕立てられた旬のカニ料理で心満たされる滞在。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR山陰本線「城崎温泉駅」より徒歩約7分（無料巡回バスあり） / 北近畿豊岡道路「但馬空港IC」より車で約25分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F5595%2F5595.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">きのさきおんせん はなこうじ さつき</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">城崎温泉　花小路　彩月</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.67 <span className="text-xs text-stone-500 font-normal">(229件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥12,870〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                大人のための全室禁煙・モダンな隠れ家温泉小宿。趣の異なる貸切風呂と、但馬牛や津居山港水揚げの新鮮な松葉がにを個室風食事処で贅沢にいただく美食ステイ。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉 / 2種類の無料貸切温泉風呂 / 効能：美肌、疲労回復、筋肉痛、関節痛、冷え性</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">津居山かに尽くし会席、A5ランク但馬牛の鉄板焼き、香住産紅ズワイガニの宝楽焼き、但馬コシヒカリ、地酒飲み比べ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">静かな路地に佇むプライベート感あふれる宿。大切な人とゆったり貸切風呂を楽しんだ後、極上のカニと但馬牛に舌鼓を打つ大人の贅沢。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">城崎温泉駅より徒歩約3分 / 外湯「駅舎温泉 さとの湯」まで徒歩すぐ / 但馬空港ICより車で約25分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F165044%2F165044.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">きのさきおんせん にしむらやほてるしょうげつてい</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">城崎温泉　西村屋ホテル招月庭</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.72 <span className="text-xs text-stone-500 font-normal">(1178件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥35,200〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                五万坪の大庭園に抱かれた城崎温泉屈指のラグジュアリー旅館。名門西村屋の伝統を受け継ぐ極上のおもてなし、森の露天風呂、最高峰の津居山がに会席を堪能。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉 / 庭園露天風呂「月見の湯」・大浴場・プライベートスパ / 効能：神経痛、筋肉痛、関節痛、冷え性、疲労回復、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">津居山港水揚げ特選タグ付き活松葉がに会席、極上但馬牛の炭火焼き・しゃぶしゃぶ、八鹿豚、但馬地野菜の創作前菜</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">紅葉に彩られた五万坪の森林庭園を望むプライベートスパ（有料貸切露天風呂）。歴史ある格式と現代の快適性が調和した最高峰の温泉体験。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR城崎温泉駅より無料送迎バスで約5分 / 但馬空港ICより車で約30分 / コウノトリ但馬空港より連絡バス約40分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月〜11月（11月6日松葉がに・津居山かに漁解禁、外湯めぐり、但馬牛、城崎ロープウェイ紅葉））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
