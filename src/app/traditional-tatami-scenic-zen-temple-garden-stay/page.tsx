...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "【2026年】白砂の枯山水庭園と畳の静寂！座禅・写経体験で心を整える禅リトリート宿5選",
    "description": "2026年最新！見事な枯山水日本庭園を眺めながら静寂の時間を過ごし、朝の座禅や写経体験、滋味深い会席料理と名湯で自分と向き合う宿5選。",
    "author": {
      "@type": "Organization",
      "name": "日本全国・旅宿クラウド編集部"
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "枯山水名園＆畳の静寂・禅リトリート温泉宿の旅行でおすすめの予約時期やタイミングは？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "枯山水名園＆畳の静寂・禅リトリート温泉宿の宿選びで失敗しないためのポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  },
  {
    ...
    "hotelInformationUrl": "https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D129984",
    ...
    "affiliateUrl": "https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F129984%2F129984.html"
  },
  {
    "hotelNo": 15962,
    "hotelName": "指宿温泉　いぶすき秀水園",
    "hotelInformationUrl": "https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D15962",
    ...
    "access": "ＪＲ指宿枕崎線指宿駅まで送迎あり／九州自動���道谷山インターより５０分",
    "affiliateUrl": "https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F15962%2F15962.html"
  }
];
    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 pb-20">
      ...
      <div className="bg-white border-b border-stone-200">
        <div className="max-w-5xl mx-auto px-4 py-3 text-xs text-stone-500 flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-800 font-semibold truncate">枯山水名園×禅リトリート温泉</span>
        </div>
      </div>
      ...
      <header className="relative bg-emerald-950 text-white py-12 px-4 md:px-8 border-b border-emerald-900">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="pt-2">
            <ShareButtons title="【2026年】白砂の枯山水庭園と畳の静寂！座禅・写経体験で心を整える禅リトリート宿5選" url="https://croud-travel.pages.dev/traditional-tatami-scenic-zen-temple-garden-stay" />
          </div>
        </div>
      </header>
