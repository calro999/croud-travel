...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の鹿児島・霧島特集！国宝・霧島神宮を包む真紅のモミジと秋空、天孫降臨神話が息づく霧島連峰の秋景色、乳白色・泥パックなど多彩な泉質を誇る霧島温泉郷の露天風呂、極上鹿児島黒豚しゃぶしゃぶと鹿児島黒牛の溶岩焼きをふるさと納税で堪能。',
    url: 'https://croud-travel.com/furusato-tax-kirishima-jingu-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "霧島神宮の紅葉参道と天孫降臨の森！霧島温泉郷の多彩な泉質・鹿児島黒豚・黒牛溶岩焼きを味わう秋の南九州旅",
    "description": "10月・11月の鹿児島・霧島特集！国宝・霧島神宮を包む真紅のモミジと秋空、天孫降臨神話が息づく霧島連峰の秋景色、乳白色・泥パックなど多彩な泉質を誇る霧島温泉郷の露天風呂、極上鹿児島黒豚しゃぶしゃぶと鹿児島黒牛の溶岩焼きをふるさと納税で堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-kirishima-jingu-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "霧島・霧島神宮・霧島温泉郷の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月下旬（霧島神宮紅葉まつり・えびの高原ススキ・霧島連峰紅葉・黒豚・黒牛・さつま芋）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の霧島・霧島神宮・霧島温泉郷旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の霧島・霧島神宮・霧島温泉郷は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月下旬〜11月下旬（霧島神宮紅葉まつり・えびの高原ススキ・霧島連峰紅葉・黒豚・黒牛・さつま芋）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">鹿児島・霧島温泉＆霧島神宮特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の霧島・霧島神宮・霧島温泉郷の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              鹿児島県を代表する景勝地・温泉地である霧島・霧島神宮・霧島温泉郷は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月下旬〜11月下旬（霧島神宮紅葉まつり・えびの高原ススキ・霧島連峰紅葉・黒豚・黒牛・さつま芋）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の霧島・霧島神宮・霧島温泉郷を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">きりしまおんせんきょう みんしゅく みちやそう</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">霧島温泉郷　民宿　みちや荘</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.15 <span className="text-xs text-stone-500 font-normal">(71件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥4,700〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                霧島温泉郷の中心に位置し、天然硫黄泉を源泉かけ流しで楽しめる温泉民宿。リーズナブルな価格とボリューム満点の鹿児島郷土料理が好評の宿。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">単純硫黄温泉（源泉100%完全かけ流し・乳白色） / 露天風呂・家族風呂 / 効能：神経痛、筋肉痛、関節痛、五十肩、冷え性、慢性皮膚病、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">鹿児島黒豚のしゃぶしゃぶ鍋、きびなごのお刺身、手作りさつま揚げ、黒豚なんこつ煮、地元野菜の天ぷら</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">湯花舞う濃厚な乳白色の硫黄泉。家庭的なもてなしと温泉通を唸らせる名湯で、霧島神宮参拝や霧島連峰トレッキングの拠点に最適。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR日豊本線「霧島神宮駅」より路線バスで約30分「丸尾」下車徒歩約3分 / 九州自動車道「横川IC」または「溝辺鹿児島空港IC」より車で約30分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F44093%2F44093.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">きりしまおんせん みんしゅく とざんぐちおんせん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">霧島温泉　民宿　登山口温泉</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.04 <span className="text-xs text-stone-500 font-normal">(119件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                高千穂峰登山口の近くに位置し、豊かな自然に抱かれた素朴な温泉宿。自家源泉の天然温泉と、地元鹿児島の新鮮な食材を使った手作り料理が評判。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">単純温泉・硫黄泉（自家源泉かけ流し） / 天然温泉大浴場 / 効能：疲労回復、筋肉痛、神経痛、冷え性、美肌効果</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">鹿児島県産黒豚の陶板焼き、地鶏の刺身（鳥刺し）、地元産野菜の煮物、さつま芋ご飯、手作り郷土小鉢</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">登山の疲れを癒やす良質な源泉。静寂な森に囲まれ、小鳥のさえずりと共に心落ち着く時間を過ごせます。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR霧島神宮駅より車で約20分 / 鹿児島空港より車で約40分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F13468%2F13468.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">きりしまおんせん めおとろてんぶろのやど あまてらす</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">霧島温泉　夫婦露天風呂の宿　天テラス（あまてらす）</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.55 <span className="text-xs text-stone-500 font-normal">(233件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥12,210〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                霧島の高台に佇み、桜島と錦江湾のパノラマ絶景を見晴らす大人のリゾート温泉宿。全室や専用貸切露天風呂からの絶景と、フレンチと和が融合した創作料理が自慢。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">単純温泉（自家源泉） / 絶景展望露天風呂・プライベート貸切風呂・足湯バー / 効能：美肌、神経痛、冷え性、関節痛、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">鹿児島黒牛のフィレステーキ、黒豚の創作前菜、錦江湾の旬魚カルパッチョ、特製デザート、ソムリエ厳選ワイン</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">桜島を正面に望むプライベート露天風呂と足湯カフェバー。秋の夕暮れや星空を眺めながら、大切な人と過ごす極上の記念日ステイ。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR霧島神宮駅よりタクシーで約20分 / 溝辺鹿児島空港ICより車で約35分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月下旬〜11月下旬（霧島神宮紅葉まつり・えびの高原ススキ・霧島連峰紅葉・黒豚・黒牛・さつま芋））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
