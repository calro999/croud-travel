...
export const metadata: Metadata = {
  ...
  keywords: ['ふるさと納税', '楽天トラベル', '宿泊クーポン', '日本酒ペアリング・名酒宿特集', '温泉旅館', 'ホテル予約', '2026年最新'],
  openGraph: {
    title: '日本酒ペアリング＆酒蔵直結名宿×ふるさと納税完全ガイド【2026年最新】越後湯沢・諏訪・会津の名酒と温泉旅',
    description: '米どころ新潟の地酒利き酒と酒風呂、信州諏訪五蔵めぐり、福島会津の金賞蔵ペアリング会席！厳選された地酒と郷土料理のマリアージュを味わう大人の日本酒温泉旅館を楽天ふるさと納税宿泊クーポンでお得に予約する酒旅ガイド。',
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-amber-500 selection:text-white">
      ...
      <nav className="border-b border-slate-800/80 bg-slate-900/60 backdrop-blur px-4 py-3 text-xs text-slate-400">
        <div className="max-w-6xl mx-auto flex items-center gap-2 overflow-x-auto whitespace-nowrap">
          ...
          <span>/</span>
          <span className="text-slate-200">日本酒ペアリング・名酒宿特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12 space-y-16">
        ...
        <section className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 md:p-10 shadow-xl relative overflow-hidden">
          ...
          <h2 className="text-xl md:text-2xl font-black text-amber-400 mb-4 flex items-center gap-2">
            <span>💡</span>
            <span>銘酒の故郷に泊まる贅沢。酒蔵仕込みの美酒と天然温泉のマリアージュ</span>
          </h2>
          <p className="text-slate-300 leading-relaxed text-sm md:text-base font-normal">
            日本有数の酒どころに足を運び、蔵元が丹精込めて醸した搾りたての純米大吟醸や限定酒を、その土地の郷土料理とともに味わう至福。お酒をたっぷり入れた「酒風呂」で温まる温泉宿や、利き酒師がセレクトするペアリングコースを備えた宿なら、移動の心配なく心ゆくまで美酒を堪能できます。楽天ふるさと納税クーポンを活用して、大人の舌と心を潤すプレミアムな日本酒旅を叶えましょう。
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div key="0" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    利き酒師が提案する料理一皿ごとの地酒ペアリング
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    前菜からメイン、デザートに至るまで、温度帯（冷酒・常温・ぬる燗）や酒質を完璧に合わせたペアリングコースで、食とお酒の相乗効果を極限まで体感できます。
                  </p>
                </div>
              </div>
              ...
              <div key="1" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    天然温泉に本物の日本酒を注ぐ「酒風呂」で血行促進＆美肌効果
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    アミノ酸やミネラルを豊富に含む日本酒を湯船に入れた名物「酒風呂」。身体の芯から温まり、湯上がりは肌がつるつるすべすべになる贅沢な湯浴みです。
                  </p>
                </div>
              </div>
              ...
              <div key="2" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    近隣の老舗酒蔵めぐりや限定酒のお土産特典付きプランも
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    普段は一般非公開の蔵見学や、市販されていない限定ボトルのプレゼント付きプランも多数。ふるさと納税で地域の酒文化継承を応援できます。
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-12">
          ...
          <div className="space-y-12">
                ...
                <div key="echigoyuzawa_sake" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>新潟県湯沢町ふるさと納税：米どころ越後湯沢・ぽんしゅ館の利き酒と酒風呂温泉ステイ</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      越後三山を望む雪国・湯沢。新潟県内全蔵元の日本酒が試飲できる越後湯沢駅のぽんしゅ館とともに、天然温泉に地酒を贅沢に注いだ酒風呂や、魚沼産コシヒカリと新潟清酒を堪能できます。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="5487" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                            
                              <Image
                                src="https://img.travel.rakuten.co.jp/share/HOTEL/5487/5487.jpg"
                                alt="エンゼルグランディア越後中里（越後湯沢）"
                                fill
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed">
                              【露天温泉＆プール完備】イベント充実◎子育て応援リゾート！オータムフェスタ9/5（土）～開催予定♪
                            </p>
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">新潟県南魚沼郡湯沢町土樽4707-1</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F5487%2F5487.html"
                            target="_blank"
                            rel="noopener noreferrer"
                      ...
                      <div key="38764" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">新潟県南魚沼郡湯沢町大字湯沢2494</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F38764%2F38764.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="40019" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">新潟県南魚沼郡湯沢町湯沢318-5</span>
                            </p>
                          </div>
                        </div>
                ...
                <div key="suwa_sake" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>長野県諏訪市ふるさと納税：諏訪湖畔・諏訪五蔵（真澄・横笛・本金・麗人・舞姫）街道の名湯</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      甲州街道沿いのわずか数百メートルに名門5蔵が立ち並ぶ諏訪。霧ヶ峰の伏流水で仕込まれた銘酒を味わい、諏訪湖を一望する自家源泉露天風呂で寛ぐ上質な休日です。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="5209" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">長野県諏訪市湖岸通り3-2-14</span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div key="7071" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">長野県諏訪市湖岸通り3-2-9</span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div key="39539" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">長野県伊那市高遠町勝間217</span>
                            </p>
                          </div>
                        </div>
                ...
                <div key="aizu_sake" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>福島県会津若松市ふるさと納税：会津若松・全国新酒鑑評会金賞蔵の里＆東山温泉の囲炉裏会席</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      全国最多の金賞受賞歴を誇る銘酒王国・会津。東山温泉の老舗旅館で、炭火の囲炉裏端でいただく郷土料理や馬刺しとともに、会津の厳選地酒を心ゆくまで酌み交わせます。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="5887" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                            
                              <Image
                                src="https://img.travel.rakuten.co.jp/share/HOTEL/5887/5887.jpg"
                                alt="会津東山温泉　いろりの宿　芦名"
                                fill
                                sizes="(max-width: 768px) 100vw, 33vw"
                                className="object-cover group-hover:scale-105 transition duration-500"
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed">
                              7つの囲炉裏に7つの客室。懐かしい佇まいのいろりの宿。お客様より４つ星以上の人気宿に選ばれました
                            </p>
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">福島県会津若松市東山町湯本下原232-1</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F5887%2F5887.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="7526" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">福島県会津若松市東山町湯本川向222</span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div key="8395" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">福島県南会津郡下郷町湯野上居平乙766-2</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F8395%2F8395.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
