...
export const metadata: Metadata = {
  ...
  keywords: ['ふるさと納税', '楽天トラベル', '宿泊クーポン', '日本三大夜景・天空ラウンジ特集', '温泉旅館', 'ホテル予約', '2026年最新'],
  openGraph: {
    title: '日本三大夜景＆天空スカイラウンジホテル×ふるさと納税完全ガイド【2026年最新】長崎・神戸・函館の1000万ドル夜景ステイ',
    description: '長崎稲佐山、神戸六甲山、函館山の日本新三大夜景・世界新三大夜景を一望する特等席ホテル！客室バルコニーや最上階スカイバーからきらめく光の海を眺める大人の記念日・ラグジュアリーステイを楽天ふるさと納税でお得に予約。',
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-amber-500 selection:text-white">
      ...
      <nav className="border-b border-slate-800/80 bg-slate-900/60 backdrop-blur px-4 py-3 text-xs text-slate-400">
        <div className="max-w-6xl mx-auto flex items-center gap-2 overflow-x-auto whitespace-nowrap">
          ...
          <span>/</span>
          <span className="text-slate-200">日本三大夜景・天空ラウンジ特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12 space-y-16">
        ...
        <section className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 md:p-10 shadow-xl relative overflow-hidden">
          ...
          <h2 className="text-xl md:text-2xl font-black text-amber-400 mb-4 flex items-center gap-2">
            <span>💡</span>
            <span>宝石箱をひっくり返したような光の絨毯。天空の客室から愛でる夜景のパノラマ</span>
          </h2>
          <p className="text-slate-300 leading-relaxed text-sm md:text-base font-normal">
            すり鉢状の地形に光が立体的に広がる長崎、港と六甲山の稜線が美しく調和する神戸、そして両側を海に挟まれたくびれのシルエットが幻想的な函館。日本を代表する三大夜景ホテルでは、窓一面に広がる光の海を眺めながらシャンパンを傾ける優雅な時間が流れます。楽天ふるさと納税を活用すれば、高層階夜景確約ルームやクラブラウンジ付きプランも最大30%OFFで贅沢に予約可能です。
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div key="0" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    高層階・海側・夜景ビュー確約ルームで感動のパノラマを独占
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    部屋に入った瞬間に息を呑む1000万ドルの夜景。プライベートな空間で誰にも邪魔されず、夜景のきらめきとともに大切な人と特別なひとときを過ごせます。
                  </p>
                </div>
              </div>
              ...
              <div key="1" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    ホテル最上階のクラブラウンジや夜景露天風呂の非日常体験
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    カクテルタイムの無料ドリンクやオードブルを片手に夜景を鑑賞できるラウンジアクセス。光の海を見下ろしながら湯船に浸かる展望大浴場も格別です。
                  </p>
                </div>
              </div>
              ...
              <div key="2" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    プロポーズ・結婚記念日・誕生日祝いのサプライズに最高の選択肢
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    アニバーサリー特典（ケーキ・花束・ワイン）が付いたラグジュアリープランもふるさと納税の対象。一生の思い出に残る記念旅行を格安で叶えられます。
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-12">
          ...
          <div className="space-y-12">
                ...
                <div key="nagasaki_nightview" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>長崎県長崎市ふるさと納税：世界新三大夜景・稲佐山山頂からすり鉢状の長崎港を見下ろすホテル</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      モナコ、上海と並び「世界新三大夜景」に認定された長崎。稲佐山の中腹に建つホテルから望む長崎港の夜景は、山々に広がる街の灯りが星空のように輝く圧倒的なスケールを誇ります。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="108257" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">長崎県長崎市曙町39-38</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F108257%2F108257.html"
                            target="_blank"
                            rel="noopener noreferrer"
                      ...
                      <div key="8438" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">長崎県長崎市曙町40-23</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F8438%2F8438.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="198507" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">長崎県長崎市大鳥町523</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F198507%2F198507.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                ...
                <div key="kobe_nightview" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>兵庫県神戸市ふるさと納税：日本三大夜景・神戸六甲山テラス＆ベイエリアの摩天楼ステイ</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      大阪平野から神戸港まで100万ドルのパノラマが広がる六甲山。港に浮かぶポートタワーやメリケンパークのライトアップ、神戸牛ディナーとともにロマンチックな夜を演出します。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="1648" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">兵庫県神戸市中央区波止場町2-1  メリケンパーク内</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F1648%2F1648.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="1524" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F1524%2F1524.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="15432" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                            
                              <Image
                                src="https://img.travel.rakuten.co.jp/share/HOTEL/15432/15432.jpg"
                                alt="ホテルプラザ神戸"
                                fill
                                sizes="(max-width: 768px) 100vw, 33vw"
                                className="object-cover group-hover:scale-105 transition duration-500"
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed">
                              車アクセス良好★ユニバーサルシティまで20分圏内！ご家族やグループで楽しい思い出を♪
                            </p>
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">兵庫県神戸市東灘区向洋町中2-9-1</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F15432%2F15432.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                ...
                <div key="hakodate_nightview" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>北海道函館市ふるさと納税：函館山ロープウェイ至近・津軽海峡の漁火ときらめく街並み</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      扇形に広がる独特の地峡が生み出す奇跡の夜景。夜空を照らす街の光と、漆黒の津軽海峡に点々と浮かぶイカ釣り漁船の漁火が織りなす幻想的な景色を特等席の客室から楽しめます。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="137023" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">北海道函館市湯川町3-1-17</span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div key="4932" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                            
                              <Image
                                src="https://img.travel.rakuten.co.jp/share/HOTEL/4932/4932.jpg"
                                alt="プレミアホテル－ＣＡＢＩＮ　ＰＲＥＳＩＤＥＮＴ－函館"
                                fill
                                sizes="(max-width: 768px) 100vw, 33vw"
                                className="object-cover group-hover:scale-105 transition duration-500"
                              />
                          ...
                          <div className="p-4 space-y-2">
                            <h4 className="font-bold text-white text-sm line-clamp-2 group-hover:text-amber-300 transition">
                              プレミアホテル－ＣＡＢＩＮ　ＰＲＥＳＩＤＥＮＴ－函館
                            </h4>
                            <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed">
                              JR函館駅や空港発着バスターミナルまでわずか徒歩1分。アクセス抜群のシティホテルです。
                            </p>
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">北海道函館市若松町14番10号</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F4932%2F4932.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="179583" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                            
                              <Image
                                src="https://img.travel.rakuten.co.jp/share/HOTEL/179583/179583.jpg"
                                alt="東急ステイ函館朝市　灯の湯（あかりのゆ）"
                                fill
                                sizes="(max-width: 768px) 100vw, 33vw"
                                className="object-cover group-hover:scale-105 transition duration-500"
                              />
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">北海道函館市大手町22-1-1</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F179583%2F179583.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
