...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "【2026年】専属バリスタのスペシャリティコーヒー！自家焙煎BAR＆カフェラウンジ付き温泉宿5選",
    "description": "2026年最新！世界各国のシングルオリジンコーヒーのハンドドリップや自家焙煎BAR、絶品スイーツが自慢の珈琲好きにおすすめの温泉リゾート5選。",
    "author": {
      "@type": "Organization",
      "name": "日本全国・旅宿クラウド編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.pages.dev/luxury-private-onsen-with-artisan-coffee-bar"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "自家焙煎スペシャリティコーヒー＆カフェ温泉宿の旅行でおすすめの予約時期やタイミングは？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "自家焙煎スペシャリティコーヒー＆カフェ温泉宿の宿選びで失敗しないためのポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  {
    "hotelNo": 10832,
    "hotelName": "指宿温泉　指宿ロイヤルホテル　～すべての女性へ美と健康を楽しむホテル～",
    "hotelInformationUrl": "https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D10832",
    "planListUrl": "https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2F3VTwt%2F%3Ff_no%3D10832%26f_flg%3DPLAN",
    "hotelMinCharge": 12650,
    "hotelImageUrl": "https://img.travel.rakuten.co.jp/share/HOTEL/10832/10832.jpg",
    "userReview": "クチコミの詳細はこちらから　https://review.travel.rakuten.co.jp/hotel/voice/10832?reviewId=33123479414043　2026-09-16 22:46:34投稿",
    "reviewAverage": 4.5,
    "reviewCount": 1628,
    "address": "鹿児島県指宿市十二町4232-1",
    "access": "鹿児島空港→指宿駅　空港バス約１１０分。指宿駅→タクシー約５分。屋久島、霧島、大隅、南薩等指宿を拠点に観光がおすすめ",
    "affiliateUrl": "https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F10832%2F10832.html"
  },
  {
    "hotelNo": 13536,
    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 pb-20">
      ...
      <div className="bg-white border-b border-stone-200">
        <div className="max-w-5xl mx-auto px-4 py-3 text-xs text-stone-500 flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-800 font-semibold truncate">自家焙煎珈琲×カフェラウンジ温泉</span>
        </div>
      </div>
      ...
      <header className="relative bg-emerald-950 text-white py-12 px-4 md:px-8 border-b border-emerald-900">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="pt-2">
            <ShareButtons title="【2026年】専属バリスタのスペシャリティコーヒー！自家焙煎BAR＆カフェラウンジ付き温泉宿5選" url="https://croud-travel.pages.dev/luxury-private-onsen-with-artisan-coffee-bar" />
          </div>
        </div>
      </header>
