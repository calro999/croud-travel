...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "【雪原ダイブ＆極寒外気浴】白銀の世界でととのう北欧薪サウナ＆雪見温泉宿5選",
    description: "薪ストーブの熱気で限界まで体を温めた後、一面のふかふか新雪へダイブ！氷点下の澄み切った空気の中で深呼吸する究極の冬サウナ体験。雪見露天風呂と郷土鍋料理で心も体も温まるスノーリトリートを厳選。",
    url: 'https://croud-travel.com/organic-forest-snow-sauna-retreat-stay',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "【雪原ダイブ＆極寒外気浴】白銀の世界でととのう北欧薪サウナ＆雪見温泉宿5選",
      }
    ],
  },
  twitter: {
...
export default function FeaturePage() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "【雪原ダイブ＆極寒外気浴】白銀の世界でととのう北欧薪サウナ＆雪見温泉宿5選",
    "description": "薪ストーブの熱気で限界まで体を温めた後、一面のふかふか新雪へダイブ！氷点下の澄み切った空気の中で深呼吸する究極の冬サウナ体験。雪見露天風呂と郷土鍋料理で心も体も温まるスノーリトリートを厳選。",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://croud-travel.com/organic-forest-snow-sauna-retreat-stay"
    }
  };
  ...
  const hotelList = [
            ...
            },
            {
              ...
              features: ["源泉かけ流し温泉を八甲田の自然と共に楽しむ北欧風マウンテンリゾート。地元青森の旬の味覚をご用意。", "青森市荒川八甲田山中", "楽天アワード受賞歴"]
            },
            {
  ...
  return (
    <article className="min-h-screen bg-gradient-to-b from-stone-50 via-white to-stone-50 text-stone-800">
      ...
      <section className="relative h-[480px] md:h-[580px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/90 text-white text-sm font-semibold tracking-wider mb-6 shadow-lg backdrop-blur-sm">
            ...
            <span>雪原ダイブ＆北欧薪サウナ</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight drop-shadow-md">
            【雪原ダイブ＆極寒外気浴】白銀の世界でととのう北欧薪サウナ＆雪見温泉宿5選
          </h1>
          <p className="text-base md:text-xl text-stone-100 max-w-2xl mx-auto font-medium leading-relaxed drop-shadow">
            薪ストーブの熱気で限界まで体を温めた後、一面のふかふか新雪へダイブ！氷点下の澄み切った空気の中で深呼吸する究極の冬サウナ体験。雪見露天風呂と郷土鍋料理で心も体も温まるスノーリトリートを厳選。
          </p>
        </div>
      </section>
      ...
      <nav className="max-w-5xl mx-auto px-4 py-4 text-xs md:text-sm text-stone-500 flex items-center gap-1.5 overflow-x-auto">
        ...
        <ChevronRight className="w-3.5 h-3.5 text-stone-400 shrink-0" />
        <span className="text-stone-800 font-medium truncate">【雪原ダイブ＆極寒外気浴】白銀の世界でととのう北欧薪サウナ＆雪見温泉宿5選</span>
      </nav>
        ...
        <section className="bg-white rounded-2xl p-6 md:p-10 shadow-sm border border-stone-200/80">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900">
              白銀の静寂と薪の温もり。熱気と氷点下のコントラストが生む異次元のととのい
            </h2>
          </div>
          <p className="text-stone-700 leading-relaxed text-base md:text-lg mb-8">
            冬の寒さを最高のエンターテインメントに変える「スノーサウナ」。北海道や信州、東北の雪深い宿で体験する薪サウナは、セルフロウリュの熱波と窓外の白銀世界のコントラストが圧巻です。火照った体を雪の上にダイブさせたり、雪見デッキでの氷点下外気浴でととのう感覚は唯一無二。サウナ後は源泉かけ流しの雪見露天風呂と地元の熱々鍋で温まりましょう。
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 pt-6 border-t border-stone-100">
            <div className="p-4 rounded-xl bg-stone-50 border border-stone-100">
              ...
              <h3 className="font-bold text-stone-900 mb-1">雪景色を一望する本格フィンランド式薪サウナ</h3>
              <p className="text-xs md:text-sm text-stone-600 leading-relaxed">パチパチとはぜる薪の音と白樺のアロマロウリュ。雪原のパノラマを望む特等席。</p>
            </div>
            <div className="p-4 rounded-xl bg-stone-50 border border-stone-100">
              <div className="flex items-center gap-2 text-amber-600 font-bold mb-2">
                <CheckCircle2 className="w-5 h-5" />
              ...
              <h3 className="font-bold text-stone-900 mb-1">ふかふかの新雪ダイブ＆氷点下外気浴</h3>
              <p className="text-xs md:text-sm text-stone-600 leading-relaxed">火照った体を雪で一気にクールダウン。澄んだ冬の空気に包まれる最高のととのい。</p>
            </div>
            <div className="p-4 rounded-xl bg-stone-50 border border-stone-100">
              <div className="flex items-center gap-2 text-amber-600 font-bold mb-2">
                <CheckCircle2 className="w-5 h-5" />
              ...
              <h3 className="font-bold text-stone-900 mb-1">湯けむり立ち上る雪見露天風呂＆郷土鍋</h3>
              <p className="text-xs md:text-sm text-stone-600 leading-relaxed">白銀の山並みを眺めながら浸かる名湯と、体が芯から温まる地元名物鍋料理。</p>
            </div>
          </div>
        </section>
