...
export const metadata: Metadata = {
  title: "サイトマップ（全ページ・都道府県ガイド・記事一覧） ｜ 日本全国・旅びより",
  description: "日本全国・旅びよりの全ページ一覧です。47都道府県の観光名所・絶景温泉・厳選ホテル比較ガイド、楽天トラベル最新お得キャンペーン、全特集記事一覧をご案内。",
  keywords: ["サイトマップ", "旅びより", "47都道府県", "観光ガイド", "楽天トラベル", "ホテル比較", "記事一覧"],
  openGraph: {
    title: "サイトマップ ｜ 日本全国・旅びより",
    description: "日本全国・旅びよりの全ページ一覧。47都道府県ガイド＆全特集記事へのリンク案内。",
  }
};
    ...
    <div className="space-y-12 max-w-6xl mx-auto px-2 sm:px-4 py-4">
      ...
      <section className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-emerald-900 via-teal-900 to-amber-800 p-8 md:p-12 text-white shadow-lg space-y-4">
        ...
        <p className="text-emerald-100/90 text-xs md:text-sm max-w-3xl leading-relaxed font-medium">
          「日本全国・旅びより」で公開しているすべてのメインページ、47都道府県別の観光・温泉・厳選宿ガイド、および全特集比較記事への全リンク一覧です。目的のエリアやテーマ探しにご活用ください。
        </p>
      </section>
