...
export const metadata: Metadata = {
  ...
  keywords: ['ふるさと納税', '楽天トラベル', '宿泊クーポン', '紅葉渓谷・錦秋露天風呂特集', '温泉旅館', 'ホテル予約', '2026年最新'],
  openGraph: {
    title: '紅葉渓谷＆錦秋の絶景露天風呂宿×ふるさと納税完全ガイド【2026年最新】定山渓・奥日光・京都嵐山の秋色名宿',
    description: '日本屈指の紅葉名所！北海道定山渓豊平峡、栃木奥日光中禅寺湖、京都嵐山保津川の渓谷美を愛でる秋の特等席宿。赤や黄金色に染まる山々を客室や露天風呂から眺める錦秋ステイを楽天ふるさと納税宿泊クーポンでお得に予約する完全ガイド。',
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-amber-500 selection:text-white">
      ...
      <nav className="border-b border-slate-800/80 bg-slate-900/60 backdrop-blur px-4 py-3 text-xs text-slate-400">
        <div className="max-w-6xl mx-auto flex items-center gap-2 overflow-x-auto whitespace-nowrap">
          ...
          <span>/</span>
          <span className="text-slate-200">紅葉渓谷・錦秋露天風呂特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12 space-y-16">
        ...
        <section className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 md:p-10 shadow-xl relative overflow-hidden">
          ...
          <h2 className="text-xl md:text-2xl font-black text-amber-400 mb-4 flex items-center gap-2">
            <span>💡</span>
            <span>燃えるような赤と黄金のパノラマ。湯けむりに包まれて愛でる秋の最高峰リトリート</span>
          </h2>
          <p className="text-slate-300 leading-relaxed text-sm md:text-base font-normal">
            渓谷全体が赤や黄色、橙色のグラデーションに染まる日本の秋。湯船に身を沈めながら見上げる紅葉のトンネル、水面に浮かぶもみじ葉、そして澄み渡る秋空。季節限定の絶景露天風呂は、日本人の美意識を最も刺激する極上の癒やしです。楽天ふるさと納税を活用すれば、ハイシーズンで予約困難な名門紅葉宿も最大30%オフのトラベルクーポンで実質2,000円の自己負担で優雅に滞在できます。
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div key="0" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    紅葉シーズン最盛期の渓谷ビュー客室や露天風呂を優先確保
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    1年で最も予約が集中する10月〜11月の紅葉期。ふるさと納税クーポンなら3年間有効なため、早期予約や連泊のアップグレードにも柔軟に活用できます。
                  </p>
                </div>
              </div>
              ...
              <div key="1" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    松茸・新米・戻り鰹・秋の味覚を味わい尽くす山里会席
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    香り高い焼き松茸や土瓶蒸し、獲れたての秋サケやイクラ、実りの秋のブランド新米など、食欲の秋にふさわしい贅を尽くしたディナーを堪能できます。
                  </p>
                </div>
              </div>
              ...
              <div key="2" className="bg-slate-900/60 border border-slate-800 hover:border-amber-500/50 transition rounded-2xl p-6 flex flex-col justify-between shadow-lg">
                <div>
                  ...
                  <h3 className="font-bold text-white text-base md:text-lg mb-3">
                    冷え込む秋の身体を芯から温める良質な源泉かけ流し温泉
                  </h3>
                  <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                    朝晩の冷え込みが心地よい秋だからこそ、濃厚な硫黄泉や塩化物泉の温もりが身体に染み渡ります。湯冷めしにくい極上の泉質で美肌と免疫力を高めましょう。
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-12">
          ...
          <div className="space-y-12">
                ...
                <div key="jozankei_foliage" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>北海道札幌市ふるさと納税：定山渓温泉・豊平川の渓谷紅葉と支笏洞爺国立公園の森宿</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      「札幌の奥座敷」定山渓。豊平峡ダム周辺の燃えるような紅葉パノラマと、ナトリウム塩化物泉の温まりの湯。北海道の豊かな大地の恵みを取り入れた贅沢な会席料理を楽しめます。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="875" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">北海道札幌市南区定山渓温泉西3-105</span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div key="44948" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">北海道札幌市南区定山渓温泉西3-57</span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div key="130162" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">北海道札幌市南区定山渓温泉東2-138-1</span>
                            </p>
                          </div>
                        </div>
                ...
                <div key="nikko_foliage" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>栃木県日光市ふるさと納税：奥日光中禅寺湖・男体山を映す錦秋の湖畔と乳白色硫黄泉</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      標高1,200mを超える高冷地・奥日光。いろは坂の絶景ドライブを経てたどり着く中禅寺湖畔では、カエデやナナカマドの鮮やかな紅葉と、美肌効果抜群のにごり湯硫黄泉が旅人を癒やします。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="168189" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">栃木県日光市瀬尾1640-14</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F168189%2F168189.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="149268" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">栃木県日光市湯西川597</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F149268%2F149268.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="31366" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">栃木県日光市鬼怒川温泉大原1021</span>
                            </p>
                          </div>
                        </div>
                ...
                <div key="arashiyama_foliage" className="bg-slate-900/50 border border-slate-800/90 rounded-3xl p-6 md:p-8 space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-black text-amber-300 flex items-center gap-2">
                      <span>📍</span>
                      <span>京都府京都市ふるさと納税：京都嵐山・渡月橋と保津川渓谷の紅葉絵巻に抱かれる老舗料理旅館</span>
                    </h3>
                    <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                      平安の貴族たちが愛した嵐山の紅葉。嵐峡の山肌が茜色に染まる絶景を望みながら、繊細な京料理と嵐山温泉の肌に優しい湯を味わう、日本最高峰の雅な秋ステイです。
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    
                      <div key="8838" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">京都府京都市西京区嵐山中尾下町54-4（渡月橋南詰め）</span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div key="32245" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                            
                              <Image
                                src="https://img.travel.rakuten.co.jp/share/HOTEL/32245/32245.jpg"
                                alt="京都・嵐山　ご清遊の宿　らんざん"
                                fill
                                sizes="(max-width: 768px) 100vw, 33vw"
                                className="object-cover group-hover:scale-105 transition duration-500"
                              />
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed">
                              京都駅まで約15分。嵐電・嵐山駅から徒歩５分。嵐山の風光明媚な立地にある癒しの宿。
                            </p>
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">京都府京都市右京区嵯峨天龍寺芒ノ馬場町33</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F32245%2F32245.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
                      ...
                      <div key="168472" className="bg-slate-950/80 border border-slate-800/80 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-amber-500/40 transition group shadow-md">
                        <div>
                          <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                            
                              <Image
                                src="https://img.travel.rakuten.co.jp/share/HOTEL/168472/168472.jpg"
                                alt="ホーム・ステイ・椛　嵐山　京都"
                                fill
                                sizes="(max-width: 768px) 100vw, 33vw"
                                className="object-cover group-hover:scale-105 transition duration-500"
                          ...
                          <div className="p-4 space-y-2">
                            ...
                            <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed">
                              京都・嵐山の心安らぐ隠れ家で、地域の魅力に囲まれた滞在を。
                            </p>
                            <p className="text-xs text-slate-500 flex items-center gap-1">
                              <span>📍</span>
                              <span className="truncate">京都府京都市右京区嵯峨天龍寺若宮町17-4</span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0 border-t border-slate-800/50 mt-2 flex items-center justify-between">
                          ...
                          <a
                            href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F168472%2F168472.html"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs px-3.5 py-2 rounded-xl transition shadow-md flex items-center gap-1"
                          >
