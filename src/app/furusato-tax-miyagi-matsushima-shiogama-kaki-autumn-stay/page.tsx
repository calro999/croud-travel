...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の宮城・松島＆塩竈特集！日本三景・松島湾の260余りの島々を染める秋景趣、円通院の幻想的な紅葉ライトアップ、10月解禁のぷりぷり松島牡蠣や三陸戻り鰹・塩竈生マグロをふるさと納税トラベルで味わう宮城の極上秋旅。',
    url: 'https://croud-travel.com/furusato-tax-miyagi-matsushima-shiogama-kaki-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "日本三景・松島＆塩竈の秋！松島湾の紅葉ライトアップ・解禁松島牡蠣＆極上三陸海鮮",
    "description": "10月・11月の宮城・松島＆塩竈特集！日本三景・松島湾の260余りの島々を染める秋景趣、円通院の幻想的な紅葉ライトアップ、10月解禁のぷりぷり松島牡蠣や三陸戻り鰹・塩竈生マグロをふるさと納税トラベルで味わう宮城の極上秋旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-miyagi-matsushima-shiogama-kaki-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "宮城・松島＆塩竈の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月下旬（円通院石庭の紅葉・牡蠣旬・三陸戻り鰹）（円通院紅葉ライトアップ・松島湾遊覧船・10月解禁松島牡蠣・塩竈まぐろ）が見頃のピークとなります。山々や海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "宮城・松島＆塩竈へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 宮城・松島＆塩竈</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 10月下旬〜11月下旬（円通院石庭の紅葉・牡蠣旬・三陸戻り鰹）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の宮城・松島＆塩竈を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が吹き抜け、木々が鮮やかに色づく10月・11月。日本各地がもっとも美しく、実り豊かな季節を迎えます。なかでも「宮城・松島＆塩竈」は、円通院紅葉ライトアップ・松島湾遊覧船・10月解禁松島牡蠣・塩竈まぐろなど、この時期にしか出逢えない息を呑む絶景と旬の味覚が凝縮された屈指の名所です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>円通院（心字の池と石庭の紅葉）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>瑞巌寺（国宝）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>松島湾観光遊覧船</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>五大堂</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>塩竈神社</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                松島産焼き牡蠣・牡蠣鍋・塩竈直送生本まぐろ・三陸戻り鰹・仙台牛ステーキ・宮城新米ひとめぼれ
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                松島温泉「絹の肌の湯」（太古の地層から湧く美肌のアルカリ性単純温泉）と松島湾一望露天風呂
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">宮城県宮城郡松島町松島字犬田10-76</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/7748/7748.jpg"
                alt="ホテル松島大観荘"
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 仙台駅よりJR仙石線乗車、松島海岸駅下車、ホテル無料シャトルバスで3分　　車は三陸道松島海岸ICより5分</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥15,180〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F7748%2F7748.html"
              target="_blank"
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">宮城県宮城郡松島町松島字仙随８番地</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.43
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> ＪＲ仙石線松島海岸駅下車徒歩10分、ＪＲ東北本線松島駅下車徒歩15分</p>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F4964%2F4964.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">宮城県宮城郡松島町松島東浜4-6</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.52
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 仙石線 松島海岸駅・東北本線　松島駅　（15：00～21：00まで送迎有・予約不可）／三陸道松島ICより１０分</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥7,600〜</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F29538%2F29538.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】宮城・松島＆塩竈を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、円通院（心字の池と石庭の紅葉）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（松島産焼き牡蠣など）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 瑞巌寺（国宝）へ移動。午後の柔らかな木漏れ日の中で絶景撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、松島湾観光遊覧船を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - 五大堂にてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 宮城・松島＆塩竈の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月下旬〜11月下旬（円通院石庭の紅葉・牡蠣旬・三陸戻り鰹）（円通院紅葉ライトアップ・松島湾遊覧船・10月解禁松島牡蠣・塩竈まぐろ）が見頃のピークとなります。山々や海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 宮城・松島＆塩竈へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
