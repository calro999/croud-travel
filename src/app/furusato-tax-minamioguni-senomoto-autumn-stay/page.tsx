...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の熊本・小国＆杖立温泉特集！くじゅう連山と阿蘇外輪山に挟まれた瀬の本高原の一面黄金ススキ野原、開湯1800年を誇る杖立温泉の天然サウナ「むし湯」と名物杖立プリン、熊本あか牛ステーキや小国ジャージー乳スイーツをふるさと納税で堪能。',
    url: 'https://croud-travel.com/furusato-tax-minamioguni-senomoto-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "瀬の本高原の黄金ススキと杖立温泉蒸し湯！阿蘇カルデラ絶景・小国あか牛＆ジャージー乳を味わう秋旅",
    "description": "10月・11月の熊本・小国＆杖立温泉特集！くじゅう連山と阿蘇外輪山に挟まれた瀬の本高原の一面黄金ススキ野原、開湯1800年を誇る杖立温泉の天然サウナ「むし湯」と名物杖立プリン、熊本あか牛ステーキや小国ジャージー乳スイーツをふるさと納税で堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-minamioguni-senomoto-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "小国・杖立温泉・瀬の本高原の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月下旬（瀬の本高原の黄金ススキ・杖立温泉もみじ紅葉・蒸し場体験・あか牛）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の小国・杖立温泉・瀬の本高原旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の小国・杖立温泉・瀬の本高原は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月中旬〜11月下旬（瀬の本高原の黄金ススキ・杖立温泉もみじ紅葉・蒸し場体験・あか牛）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">熊本・小国＆杖立温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の小国・杖立温泉・瀬の本高原の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              熊本県を代表する景勝地・温泉地である小国・杖立温泉・瀬の本高原は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月中旬〜11月下旬（瀬の本高原の黄金ススキ・杖立温泉もみじ紅葉・蒸し場体験・あか牛）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の小国・杖立温泉・瀬の本高原を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">つえたておんせん じゅんわふうりょかん いずみや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">杖立温泉　純和風旅館　泉屋</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.63 <span className="text-xs text-stone-500 font-normal">(344件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥7,150〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                杖立川沿いに建つ、趣豊かな純和風老舗旅館。名物の天然温泉蒸し風呂（むし湯）や多彩な露天風呂・檜風呂と、熊本の旬素材を丁寧に仕立てた会席料理が絶賛される宿。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">弱アルカリ性単純温泉（高温泉・源泉かけ流し） / 名物むし湯・露天風呂・大浴場・貸切風呂 / 効能：神経痛、筋肉痛、関節痛、冷え性、疲労回復、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">肥後あか牛の陶板焼き会席、馬刺しの盛り合わせ、杖立温泉名物「手作り杖立プリン」、小国郷の旬野菜料理</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">体の芯からデトックスできる伝統の蒸し湯。川のせせらぎを聞きながら入る露天風呂と、温かい女将のおもてなしに心癒やされます。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR日田駅より路線バスで約40分「杖立温泉」下車徒歩約1分 / 大分自動車道「日田IC」より車で約40分 / 熊本空港より車で約90分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F28521%2F28521.html"
                  target="_blank"
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">つえたておんせん はがくれかん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">杖立温泉　葉隠館</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 3.78 <span className="text-xs text-stone-500 font-normal">(538件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥14,300〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                杖立川のほとりに位置し、文人墨客にも親しまれてきた家庭的な温もりあふれる温泉旅館。源泉かけ流しの天然温泉と、地元小国郷の恵みを活かした郷土会席が人気。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">弱アルカリ性単純泉（源泉100%かけ流し） / 展望岩風呂・大浴場 / 効能：冷え性、疲労回復、筋肉痛、神経痛、美肌効果</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">熊本県産黒毛和牛のすき焼き、清流鮎の塩焼き、小国ジャージー牛乳を使った特製プリン、地元契約農家の採れたて新米</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">川沿いの風情ある木造建築。温泉街の「蒸し場」体験や足湯めぐりへのアクセスも良く、昭和レトロな温泉情緒を満喫。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">日田駅よりバス約40分 / 日田ICより車で約40分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F28586%2F28586.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">つえたておんせん りょかんよろづや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">杖立温泉　旅館よろづや</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 0 <span className="text-xs text-stone-500 font-normal">(3件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥7,850〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                杖立温泉街の中心に佇む、手頃な料金で良質な源泉を楽しめる純和風の温泉宿。昭和の面影を残す落ち着いた客室と、手作りの田舎料理でもてなす隠れ宿。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">弱アルカリ性単純温泉（自家源泉かけ流し） / 天然温泉内湯・家族風呂 / 効能：神経痛、関節痛、五十肩、冷え性、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">地元熊本豚の陶板焼き、季節の山菜小鉢、川魚の塩焼き、手作り刺身こんにゃく、小国郷の新米ご飯</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">自噴する良質な高温泉を気兼ねなく楽しめるアットホームな宿。瀬の本高原ドライブや九重連山観光の拠点に最適。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR日田駅よりバスで約40分 / 日田ICより車で約40分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F193168%2F193168.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月中旬〜11月下旬（瀬の本高原の黄金ススキ・杖立温泉もみじ紅葉・蒸し場体験・あか牛））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
