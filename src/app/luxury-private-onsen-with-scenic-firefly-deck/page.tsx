...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "【初夏の幻想蛍夜】客室露天・専用テラスから舞う蛍を鑑賞！清流沿いの隠れ家名湯宿5選",
    description: "初夏の夜、静寂な清流沿いのプライベートデッキや客室露天風呂から、淡く光りながら舞い飛ぶ天然のゲンジボタルを鑑賞。喧騒を離れ、自然の光と水のせせらぎに包まれる風雅な温泉旅館を厳選紹介。",
    url: 'https://croud-travel.com/luxury-private-onsen-with-scenic-firefly-deck',
...
export default function FeaturePage() {
  const jsonLd = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://croud-travel.com/luxury-private-onsen-with-scenic-firefly-deck"
    }
  };
      ...
      <section className="relative h-[480px] md:h-[580px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight drop-shadow-md">
            【初夏の幻想蛍夜】客室露天・専用テラスから舞う蛍を鑑賞！清流沿いの隠れ家名湯宿5選
          </h1>
