...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '11月上旬〜11月中旬に京都で最も早く鮮やかに色づく高雄・三尾エリア。清滝川のせせらぎを望む隠れ宿で、赤く染まるもみじのライトアップと極上京会席・丹波牛をふるさと納税でお得に堪能。',
    url: 'https://croud-travel.com/furusato-tax-kyoto-takao-autumn-leaves-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "京都・高雄の三尾紅葉（神護寺・高山寺）＆清滝川沿い隠れ家宿で味わう秋の川床名残会席",
    "description": "11月上旬〜11月中旬に京都で最も早く鮮やかに色づく高雄・三尾エリア。清滝川のせせらぎを望む隠れ宿で、赤く染まるもみじのライトアップと極上京会席・丹波牛をふるさと納税でお得に堪能。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-kyoto-takao-autumn-leaves-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "京都・高雄・三尾（神護寺・西明寺・高山寺）の秋（10月〜11月）のベストシーズン・見頃はいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年11月上旬〜11月中旬の京都屈指の早染め紅葉と清滝川の幽玄美が見頃のピークとなります。山々や渓谷のグラデーションとともに、旬を迎える地場食材を存分にお楽しみいただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の京都・高雄・三尾（神護寺・西明寺・高山寺）旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の京都・高雄・三尾（神護寺・西明寺・高山寺）は朝晩の冷え込みが強まります。日中は快適な服装で問題ありませんが、朝夕の散策や露天風呂への移動時には防寒着（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：11月上旬〜11月中旬の京都屈指の早染め紅葉と清滝川の幽玄美</span>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-amber-950 border-b-2 border-amber-600 pb-3 mb-6">
            はじめに：秋の京都・高雄・三尾（神護寺・西明寺・高山寺）で味わう絶景と至高の温泉時間
          </h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            10月から11月にかけての京都府・京都・高雄・三尾（神護寺・西明寺・高山寺）は、豊かな自然美と歴史情緒が鮮やかに交差する特別なシーズンを迎えます。澄んだ秋空の下、山肌や渓谷が織りなす錦秋のパノラマは息をのむ美しさで、訪れる人々を魅了してやみません。
          </p>
          <p className="text-slate-700 leading-relaxed mb-4">
            心地よい秋風を感じながら名所を巡ったあとは、名湯に身を浸して日々の喧騒を忘れ、夜には秋の実りを凝縮した贅沢な郷土会席に舌鼓を打つ――これこそが大人の旅にふさわしい至高の贅沢です。
          </p>
          <p className="text-slate-700 leading-relaxed">
            本記事では、京都・高雄・三尾（神護寺・西明寺・高山寺）エリアで高い評価を誇るおすすめの名宿3選を徹底解説します。楽天ふるさと納税の宿泊クーポンを活用すれば、実質自己負担わずか2,000円で憧れの高級旅館や温泉宿にお得に宿泊可能です。秋の特別な旅行プランをぜひご検討ください。
          </p>
        </section>
        ...
        <section className="bg-amber-50 rounded-2xl p-6 sm:p-8 border border-amber-200 mb-12">
          <h3 className="text-lg sm:text-xl font-bold text-amber-900 mb-4 flex items-center gap-2">
            <span>🍁</span> 京都・高雄・三尾（神護寺・西明寺・高山寺） 秋旅の3大魅力ポイント
          </h3>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">もみぢ家本館 高雄山荘</h3>
              <p className="text-xs text-slate-500">もみぢやほんかん たかおさんそう</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.25点 <span className="text-xs font-normal text-slate-600">(40件)</span>
            </div>
          </div>
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  京都屈指の紅葉名所・高雄の山腹に建つ創業明治の老舗料理旅館。神護寺や高山寺への参拝に便利で、秋には全館が紅葉の錦に包まれる絶好のロケーション。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  展望檜風呂・貸切半露天風呂 / 効能：疲労回復、リフレッシュ、血行促進
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR京都駅よりJRバス「高雄」下車徒歩約5分（送迎あり要連絡） / 名神高速「京都南IC」より約45分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                名物「紅葉会席」、京都丹波牛のしゃぶしゃぶ鍋、旬の松茸土瓶蒸し、湯葉料理、秋の京野菜の焚き合わせ
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                秋風そよぐパノラマ露天風呂から見渡す高雄の山並みはまさに絶景。夕食時には舞妓さんのおもてなしプランも人気です。
              </p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">もみぢ家別館 川の庵</h3>
              <p className="text-xs text-slate-500">もみぢやべっかん かわのいおり</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.75点 <span className="text-xs font-normal text-slate-600">(90件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden shadow-inner bg-slate-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/38914/38914.jpg"
                alt="もみぢ家別館 川の庵の外観・温泉風景"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  清滝川にかかる専用の吊り橋を渡って訪れる、清流のほとりに佇む数寄屋造りの隠れ家宿。夏から秋にかけて川床での贅沢な食事と、離れの客室露天風呂が魅力。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  客室露天風呂・貸切露天風呂 / 効能：美肌、リラクゼーション、神経痛緩和
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR花園駅または地下鉄太秦天神川駅より無料送迎バスあり（要予約） / 京都南ICより約40分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                清滝川の秋の川床名残会席、丹波牛の陶板焼き、天然あゆ・子持ち鮎の炭火焼き、自家製ごま豆腐、秋の吹き寄せ前菜
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                清滝川のせせらぎと頭上を覆う真紅のもみじ。幻想的な夜のライトアップを眺めながら味わう川床料理は一生の思い出に。
              </p>
            </div>
          </div>
          ...
          <div className="text-center pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Fimg.travel.rakuten.co.jp%2Fimage%2Ftr%2Fapi%2Fkw%2FJBe8h%2F%3Ff_no%3D38914"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-md hover:from-amber-700 hover:to-orange-700 transition duration-150 transform hover:-translate-y-0.5 w-full sm:w-auto text-sm sm:text-base"
            >
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-12">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-4 mb-6">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">リーガロイヤルホテル京都</h3>
              <p className="text-xs text-slate-500">りーがろいやるほてるきょうと</p>
            </div>
            <div className="bg-amber-100 text-amber-900 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
              ★ 楽天評価: 4.25点 <span className="text-xs font-normal text-slate-600">(7185件)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-slate-800 text-base mb-2">宿の概要とロケーション</h4>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
                  京都駅より徒歩約7分。伝統の格式と洗練されたモダンホスピタリティが融合したラグジュアリーホテル。京都紅葉めぐりの拠点として極上の快適性を提供。
                </p>
                <h4 className="font-bold text-slate-800 text-base mb-2">自慢の温泉・泉質</h4>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  室内温水プール・サウナ（フィットネス施設）
                </p>
              </div>
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
                📍 アクセス：JR「京都駅」西口より徒歩約7分（八条口より無料シャトルバス運行） / 名神高速・京都南ICより約15分
              </div>
            </div>
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-5 border border-stone-200 mb-6 space-y-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                フレンチ「トップ オブ キョウト」（京都唯一の回転展望レストラン）、京料理「たん熊北店」の本格懐石、旬の京都産和牛ディナー
              </p>
            </div>
            <div>
              <h5 className="font-bold text-stone-800 text-sm mb-1 flex items-center gap-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                京都駅からのアクセスが抜群で、高雄や嵐山、東山への周遊に最適。360度京都の街並みと秋の山々を見渡す展望フレンチが格別。
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
                <span className="text-amber-600 font-bold">Q.</span> 京都・高雄・三尾（神護寺・西明寺・高山寺）の秋の見頃時期はいつですか？
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                例年11月上旬〜11月中旬の京都屈指の早染め紅葉と清滝川の幽玄美が見頃となります。標高差や気候に合わせて色づきが移り変わり、長期間にわたって楽しめます。
              </p>
            </div>
            <div className="border-b border-slate-100 pb-4">
              <h4 className="font-bold text-slate-800 text-base mb-2 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed pl-6">
                10月〜11月の京都・高雄・三尾（神護寺・西明寺・高山寺）は朝夕の冷え込みが予想されます。日中は薄手のアウターで快適ですが、早朝や夜間、散策時には厚手のフリースやジャケット、歩きやすい靴をご用意ください。
              </p>
            </div>
          </div>
        </section>
