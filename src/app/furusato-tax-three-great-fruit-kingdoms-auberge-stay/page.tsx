...
export default function Page() {
  ...
  const hotels = [
  {
    ...
    "reviewCount": 779,
    "reviewAverage": 4.59,
    "userReview": "また訪れたい場所ワイナリー巡り目的で家族と宿泊しました。残念ながら当日は曇りで、富士山は一部しか眺められませんでしたが、ホテルからの夜景は素晴らしく、周辺も自然豊かで、リラックスした時間を過ごせま…　2026-08-31 16:32:58投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=1221\" class=\"3click\">つづきはこちら</a>",
  ...
  },
  {
    ...
    "reviewCount": 1030,
    "reviewAverage": 4.58,
    "userReview": "豪華な夕食と温泉で心身ともにリフレッシュ15時少し前に到着し、店員さんがお出迎えして下さりチェックインしました。親子4人で利用しました。夕食は豪華な料理で堪能し、お腹一杯になり大満足でした。だ…　2026-09-05 14:35:09投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=53746\" class=\"3click\">つづきはこちら</a>",
