...
export default function Page() {
  ...
  const hotels = [
  {
    ...
    "reviewCount": 606,
    "reviewAverage": 3.84,
    "userReview": "部屋が狭くフロントまでの階段が負担部屋が狭くてびっくりした!部屋に入ると既に布団がひいてあり余計に部屋が狭く感じた!後、建物じょう仕方ないと思うがフロントに行くまで階段が数段あり 高齢者の…　2026-08-21 11:33:23投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=7520\" class=\"3click\">つづきはこちら</a>",
  ...
  },
  {
    ...
    "reviewCount": 5673,
    "reviewAverage": 4.42,
    "userReview": "バイキングは豊富で美味、扉の汚れが気になるバイキングのメニューは豊富で、どれも美味しかったです。建物の造りが古いのか、部屋の入口の扉に汚れが目立つのが気になりました。クチコミの詳細はこ…　2026-09-05 21:39:09投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=18253\" class=\"3click\">つづきはこちら</a>",
  ...
  },
  {
    ...
    "reviewCount": 2145,
    "reviewAverage": 3.93,
    "userReview": "館内の清掃不足と危険な温度設定に不満建物の老朽は致し方のないことですが、館内室内の清潔さは努力できると思います。ロビーに置かれた椅子は長年お客様に愛用されてきた暁なのでしょうか、背もたれの首の…　2026-09-05 18:36:05投稿 <a href=\"https://img.travel.rakuten.co.jp/image/tr/api/kw/HTX0u/?f_hotel_no=54209\" class=\"3click\">つづきはこちら</a>",
