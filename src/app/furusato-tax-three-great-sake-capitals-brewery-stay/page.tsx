      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 mt-12 space-y-16">
        ...
        <section className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 backdrop-blur shadow-2xl">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">
            名水が生み出す黄金の一滴と白壁の酒蔵が連なる風情。美酒と美食のマリアージュに溺れる大人の休日
          </h2>
          <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
            日本の清酒文化を牽引し、江戸の昔から現在に至るまで最高峰の日本酒を世に送り出してきた「日本三大酒どころ（日本三大銘醸地）」――六甲山の硬水「宮水」と山田錦を用い力強い辛口の「男酒」として知られる兵庫の「灘五郷」、桃山丘陵の柔らかく清冽な「伏水」が醸し出す滑らかで上品な「女酒」の京都「伏見」、そして明治時代に軟水醸造法を確立し日本の吟醸酒の礎を築いた広島の「西条」。黒板塀やレンガ造りの煙突が並ぶ酒蔵通りを歩き、蔵元でしか味わえない搾りたての無濾過生原酒をテイスティング。夜には名酒に合わせた地元ブランド牛や瀬戸内海鮮のペアリングコースを味わう極上の酒蔵ステイを楽天ふるさと納税でお楽しみください。
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key="0" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              ...
              <h3 className="font-bold text-white text-lg mb-2">歩いて巡れる酒蔵通り！蔵元直営ショップでの限定酒試飲や酒蔵見学</h3>
              <p className="text-slate-400 text-sm leading-relaxed">一般流通しない限定酒や古酒の試飲を心ゆくまで楽しみ、酒造りの奥深い歴史と職人技に触れる旅。</p>
            </div>
            <div key="1" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                02
              </div>
              <h3 className="font-bold text-white text-lg mb-2">神戸牛・京野菜・美酒鍋（びしゅなべ）など銘酒を引き立てる郷土グルメ</h3>
              <p className="text-slate-400 text-sm leading-relaxed">酒どころならではの酒粕料理や、日本酒で豚肉と野菜を煮込む西条名物「美酒鍋」などの絶品料理。</p>
            </div>
            <div key="2" className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 font-bold flex items-center justify-center mb-4">
                03
              </div>
              <h3 className="font-bold text-white text-lg mb-2">ふるさと納税で高級地酒返礼品と宿泊クーポンをダブルで満喫</h3>
              <p className="text-slate-400 text-sm leading-relaxed">宿泊費用の割引に加え、お気に入りのプレミアム銘酒を返礼品として自宅へ届ける贅沢な活用術。</p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            ...
            <article key="0" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  兵庫県神戸市東灘区・灘区ふるさと納税：日本一の酒生産量を誇る「灘五郷」酒蔵めぐりとヴィラフォンテーヌ神戸三宮
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  白鶴、菊正宗、剣菱など名立たる蔵元が立ち並ぶ灘五郷。酒蔵記念館で利き酒体験を楽しんだ後は、三宮駅至近の「ヴィラフォンテーヌ神戸三宮」を拠点に、老舗ステーキハウスでの神戸牛と灘の生一本ペアリングを堪能します。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/141282/141282.jpg"
                    alt="住友不動産ホテル　ヴィラフォンテーヌ神戸三宮"
                    fill
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-slate-300 text-xs sm:text-sm leading-relaxed mb-4 bg-slate-900/60 p-3.5 rounded-xl border border-slate-800/60">
                      毎日17時から20時迄ワインやおつまみ無料のハッピーアワーを開催中！客室にはスマートTV完備。
                    </p>
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F141282%2F141282.html"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <article key="1" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  京都府京都市伏見区ふるさと納税：月桂冠や黄桜が並ぶ水郷の酒蔵街「伏見」十石舟とアーバンホテル京都ステイ
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  伏見の名水が湧き出る酒蔵の郷。柳並木が美しい十石舟遊覧や酒蔵カフェを満喫した後は、アーバンホテル京都で京都名物のおばんざいや伏見の銘酒を味わい、伏見稲荷大社の早朝参拝も満喫します。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F1445%2F1445.html"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
            ...
            <article key="2" className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden hover:border-slate-700/80 transition duration-300 shadow-xl">
              <div className="p-6 sm:p-8 border-b border-slate-800/80">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                  広島県東広島市西条ふるさと納税：赤瓦と赤レンガ煙突の景観「西条酒蔵通り」美酒鍋とホテルルートイン東広島西条駅前
                </h3>
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                  駅前に7つの蔵元が集まる奇跡の酒のまち。名物「美酒鍋」や仕込み水の飲み比べを楽しんだ後は、西条駅徒歩圏の「ホテルルートイン東広島西条駅前」の大浴場で寛ぎ、広島名物の牡蠣料理と純米吟醸酒に酔いしれます。
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 sm:p-8 items-center bg-slate-950/40">
                <div className="lg:col-span-5 relative h-64 sm:h-72 w-full rounded-2xl overflow-hidden border border-slate-800">
                  <Image
                    src="https://img.travel.rakuten.co.jp/share/HOTEL/161066/161066.jpg"
                    alt="ホテルルートイン東広島西条駅前"
                    fill
                    className="object-cover hover:scale-105 transition duration-500"
                    unoptimized
                ...
                <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F161066%2F161066.html"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs sm:text-sm font-bold rounded-xl transition border border-slate-700"
                      >
        ...
        <section className="border-t border-slate-800/80 pt-12 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div>
                <h3 className="font-bold text-white text-base group-hover:text-rose-400 transition mb-2">
                  日本三大名水＆清冽な湧水仕込み美食宿×ふるさと納税完全ガイド
                </h3>
            ...
            >
              <div>
                <h3 className="font-bold text-white text-base group-hover:text-rose-400 transition mb-2">
                  日本三大銘茶の産地＆茶香炉ヒーリング宿×ふるさと納税完全ガイド
                </h3>
                <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                  静岡茶・宇治茶・朝宮茶。
                </p>
