...
export const metadata: Metadata = {
  ...
  keywords: ["nagoya-kanazawa-bus-vs-train-guide", "高速バス", "新幹線 比較", "安く行く方法", "1泊2日 モデルコース", "宿泊予約", "楽天トラベル"],
};
...
function loadHotels() {
  try {
    ...
    if (fs.existsSync(filePath)) {
      ...
      return data["nagoya-kanazawa-bus-vs-train-guide"]?.hotels || [];
    }
  } catch (e) {
    console.error("Failed to load hotels for nagoya-kanazawa-bus-vs-train-guide", e);
  }
  return [];
}
...
export default function HighwayBusArticlePage() {
  ...
  const itinerary = [
  {
    ...
    "steps": [
      {
        "time": "08:00",
        "title": "名鉄バスセンターから直行高速バス乗車",
        "desc": "乗り換えなしでゆったりシート。北陸の山々や田園風景を眺めながらドライブ。"
      },
      {
        "time": "12:00",
        "title": "金沢駅到着＆近江町市場で海鮮ランチ",
        "desc": "金沢駅の鼓門を抜け、徒歩で近江町市場へ。新鮮なブリ・カニ・甘海老の海鮮丼。"
      },
      {
        "time": "14:00",
        "title": "ひがし茶屋街の格子戸通り散歩＆箔一の金箔ソフト",
        "desc": "金箔が丸ごと1枚乗った贅沢ソフトクリームを食べながら伝統建築の街並みを散策。"
      },
      {
        "time": "16:30",
        "title": "金沢駅前ホテルチェックイン＆大浴場",
        "desc": "バス移動の疲れを駅前温泉で流し、浴衣でリラックス。"
      },
      {
        "time": "18:30",
        "title": "片町・香林坊で「金沢おでん」と石川の地酒「黒帯」",
        "desc": "出汁が染みた車麩やバイ貝、カニ面を熱燗とともに味わう至福の夜。"
      }
    ]
  },
  {
    ...
    "steps": [
      {
        "time": "09:00",
        "title": "兼六園＆金沢城公園をじっくり散策",
        "desc": "日本三名園の美しさを堪能。時雨亭でお抹茶をいただきながら庭園を鑑賞。"
      },
      {
        "time": "11:30",
        "title": "金沢21世紀美術館＆モダンカフェランチ",
        "desc": "現代アートを体感後、カフェで加賀棒茶のスイーツ。"
      },
      {
        "time": "14:30",
        "title": "金沢駅「あんと」で名産品ショッピング",
        "desc": "中田屋のきんつば、加賀棒茶、能登牛ジャーキーをお土産に購入。"
      },
      {
        "time": "16:00",
        "title": "金沢駅から直行高速バス乗車〜名古屋へ",
        "desc": "夕方の直行バスで夜20時頃に名古屋駅到着。"
      }
    ]
  }
];
