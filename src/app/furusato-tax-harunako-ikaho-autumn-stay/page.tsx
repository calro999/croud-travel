...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の群馬・榛名山＆伊香保温泉特集！榛名富士を映す榛名湖の秋景色、伊香保石段街365段の紅葉ライトアップ、鉄分豊富な「黄金の湯」とメタケイ酸豊富な「白銀の湯」の二大名湯をふるさと納税で巡る旅。',
    url: 'https://croud-travel.com/furusato-tax-harunako-ikaho-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "榛名湖の紅葉ロープウェイと伊香保温泉石段街！黄金の湯・白銀の湯と極上上州牛を味わう秋の上州旅",
    "description": "10月・11月の群馬・榛名山＆伊香保温泉特集！榛名富士を映す榛名湖の秋景色、伊香保石段街365段の紅葉ライトアップ、鉄分豊富な「黄金の湯」とメタケイ酸豊富な「白銀の湯」の二大名湯をふるさと納税で巡る旅。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-harunako-ikaho-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "渋川・伊香保温泉・榛名山の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月中旬（榛名湖畔のカエデ紅葉、伊香保温泉湯元河鹿橋の紅葉ライトアップ、上州牛・水沢うどん）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の渋川・伊香保温泉・榛名山旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の渋川・伊香保温泉・榛名山は昼夜の寒暖差が激しくなります。日中は長袖シャツで快適ですが、早朝や夕暮れの散策・露天風呂への移動時には防寒アウター（フリースやダウン等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月下旬〜11月中旬（榛名湖畔のカエデ紅葉、伊香保温泉湯元河鹿橋の紅葉ライトアップ、上州牛・水沢うどん）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">群馬・榛名湖＆伊香保温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の渋川・伊香保温泉・榛名山の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              群馬県を代表する景勝地・温泉地である渋川・伊香保温泉・榛名山は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月下旬〜11月中旬（榛名湖畔のカエデ紅葉、伊香保温泉湯元河鹿橋の紅葉ライトアップ、上州牛・水沢うどん）</li>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">いかほおんせん いかほしゅうすいえん</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">伊香保温泉　いかほ秀水園</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.3 <span className="text-xs text-stone-500 font-normal">(573件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥9,350〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                伊香保温泉の高台に位置し、上州の雄大な山並みを見渡す純和風の温泉旅館。名湯「白銀の湯」をたたえる大浴場・露天風呂と、上州の山海の恵みを活かした本格会席が評判。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">単純温泉（白銀の湯） / 展望露天風呂・檜大浴場・貸切風呂 / 効能：疲労回復、健康増進、病後回復期、神経痛、筋肉痛、美肌効果</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">厳選上州牛の陶板焼き会席、群馬県産旬野菜の天ぷら、伊香保名物水沢うどん、吟醸味噌仕立て鍋、秋の栗おこわ</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">露天風呂から望む赤城山や子持山の秋の山景。石段街への無料送迎もあり、河鹿橋の紅葉ライトアップ鑑賞にも非常に便利。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">JR上越線「渋川駅」より伊香保温泉行き路線バスで約25分（終点より送迎あり） / 関越自動車道「渋川伊香保IC」より車で約20分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">いかほおんせん おんせんやど つかごしやしちべえ</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">伊香保温泉　温泉宿　塚越屋七兵衛</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.41 <span className="text-xs text-stone-500 font-normal">(894件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥8,470〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                創業百余年の歴史を誇る老舗宿。伊香保特有の茶褐色の名湯「黄金の湯」を源泉かけ流しで引く大浴場と、群馬のブランド肉を贅沢に味わう季節会席が人気。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">硫酸塩温泉（カルシウム・ナトリウム-硫酸塩・炭酸水素塩・塩化物泉・黄金の湯） / 檜露天風呂・大浴場 / 効能：神経痛、筋肉痛、関節痛、五十肩、冷え性、切り傷、美肌</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">上州牛と上州麦豚の食べ比べすき焼き会席、刺身こんにゃく、舞茸の土瓶蒸し、地元契約農家の採れたて秋野菜</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">体の芯から温まる鉄分豊富な黄金の湯。心地よい和の情緒あふれる客室と、地元の地酒を取り揃えたおもてなしで大人の休日を満喫。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">渋川駅より伊香保温泉行きバス約25分（見晴下バス停下車すぐ・送迎あり） / 渋川伊香保ICより約20分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">いかほおんせん きんだゆう</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">伊香保温泉　金太夫（伊東園ホテルズ）</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 3.73 <span className="text-xs text-stone-500 font-normal">(911件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥7,348〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                伊香保温泉石段街の中腹に位置する歴史ある宿。黄金の湯を引く展望露天風呂から上州の絶景を望み、種類豊富なバイキングと飲み放題をお手頃価格で楽しめるホテル。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">カルシウム・ナトリウム-硫酸塩・炭酸水素塩・塩化物温泉（黄金の湯） / 展望露天風呂・大浴場・無料貸切風呂 / 効能：冷え性、疲労回復、筋肉痛、神経痛、皮膚病</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">和洋中季節の創作バイキング（アルコール・ソフトドリンク飲み放題付き）、群馬名物もつ煮、上州名物うどん</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">石段街まで徒歩1分の抜群のアクセス。石段散策や食べ歩きの拠点に最適で、無料貸切風呂でプライベートな名湯浴みも可能。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">渋川駅よりバス約30分「伊香保温泉」下車徒歩約5分 / 渋川伊香保ICより車で約25分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F73955%2F73955.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月下旬〜11月中旬（榛名湖畔のカエデ紅葉、伊香保温泉湯元河鹿橋の紅葉ライトアップ、上州牛・水沢うどん））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
