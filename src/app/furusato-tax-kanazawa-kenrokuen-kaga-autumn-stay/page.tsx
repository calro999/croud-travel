...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の石川・金沢＆湯涌温泉特集！日本三名園・兼六園の伝統行事「雪吊り作業」と錦秋の庭園美、11月6日解禁の冬の王様「加能ガニ（越前・松葉蟹）」、竹久夢二ゆかりの金沢の奥座敷「湯涌温泉」の美肌湯をふるさと納税トラベルで楽しむ贅沢プラン。',
    url: 'https://croud-travel.com/furusato-tax-kanazawa-kenrokuen-kaga-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "金沢・兼六園の雪吊り紅葉と奥座敷・湯涌温泉！加能ガニ解禁＆加賀百万石の秋会席",
    "description": "10月・11月の石川・金沢＆湯涌温泉特集！日本三名園・兼六園の伝統行事「雪吊り作業」と錦秋の庭園美、11月6日解禁の冬の王様「加能ガニ（越前・松葉蟹）」、竹久夢二ゆかりの金沢の奥座敷「湯涌温泉」の美肌湯をふるさと納税トラベルで楽しむ贅沢プラン。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-kanazawa-kenrokuen-kaga-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "石川・金沢＆湯涌温泉の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月下旬〜11月下旬（兼六園雪吊り＆紅葉・加能ガニ初競り・寒ブリ）（兼六園の雪吊り作業と紅葉・ひがし茶屋街の秋風情・11月6日加能ガニ解禁）が見頃のピークとなります。山々や海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "石川・金沢＆湯涌温泉へのアクセスや秋旅の注意点はありますか？",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      <section className="relative bg-stone-900 text-white py-16 px-4 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2 text-xs text-stone-300">
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">エリア: 石川・金沢＆湯涌温泉</span>
            <span className="bg-stone-800/80 px-3 py-1 rounded border border-stone-700">見頃: 10月下旬〜11月下旬（兼六園雪吊り＆紅葉・加能ガニ初競り・寒ブリ）</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-12 leading-relaxed">
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-4">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            秋の石川・金沢＆湯涌温泉を旅する魅力と贅沢なふるさと納税活用法
          </h2>
          <p className="text-stone-700 leading-relaxed">
            秋風が吹き抜け、木々が鮮やかに色づく10月・11月。日本各地がもっとも美しく、実り豊かな季節を迎えます。なかでも「石川・金沢＆湯涌温泉」は、兼六園の雪吊り作業と紅葉・ひがし茶屋街の秋風情・11月6日加能ガニ解禁など、この時期にしか出逢えない息を呑む絶景と旬の味覚が凝縮された屈指の名所です。
          </p>
          <p className="text-stone-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              ...
              <ul className="text-sm text-stone-600 space-y-2">
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>特別名勝 兼六園（徽軫灯籠・雪吊り）</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>金沢城公園</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>ひがし茶屋街・主計町茶屋街</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>金沢21世紀美術館</li>
                <li className="flex items-start"><span className="text-amber-500 mr-2">•</span>近江町市場</li>
              </ul>
            </div>
            <div className="bg-stone-50 p-5 rounded-lg border border-stone-200">
              <h3 className="text-base font-bold text-stone-900 mb-2 flex items-center">
              ...
              <p className="text-sm text-stone-700 leading-relaxed mb-3">
                解禁直後の加能ガニ（茹で蟹・焼き蟹・甲羅味噌）・のどぐろ塩焼き・加賀野菜治部煮・金沢地酒
              </p>
              ...
              <p className="text-sm text-stone-700 leading-relaxed">
                湯涌温泉（ナトリウム・カルシウム-塩化物・硫酸塩泉、弱アルカリ性）のしっとり潤い湯
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">石川県金沢市湯涌荒屋町92-3</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> ★金沢中心街より車で20分★「金沢駅・兼六園」より“無料送迎”！お帰りは金沢駅近くへ荷物お届けサービス◎手ぶら観光もOK</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥19,470〜</p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">石川県金沢市湯涌荒屋町77-2</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.65
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 兼六園より車で25分、金沢駅より車で約40分。金沢森本I.Cから山側環状経由で30分。</p>
                <p><span className="font-semibold text-stone-800">目安料金:</span> 1泊1名 ￥17,325〜</p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-4">
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1">石川県金沢市湯涌町イ68</p>
            </div>
            <div className="mt-3 md:mt-0 flex items-center space-x-2">
              <div className="bg-amber-100 text-amber-800 font-bold px-3 py-1 rounded-full text-sm">
                ★ 総合評価: 4.64
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-64 rounded-lg overflow-hidden border border-stone-200 bg-stone-100">
              <img
                src="https://img.travel.rakuten.co.jp/share/HOTEL/167495/167495.jpg"
                alt="金沢湯涌温泉　古香里庵"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="space-y-3">
              <h4 className="font-bold text-stone-900 text-sm">宿の魅力と秋の過ごし方</h4>
              <p className="text-sm text-stone-700 leading-relaxed">
                2018年6月オープン「金沢湯涌温泉　古香里庵」全4室温泉露天風呂付と食事処は個室
              </p>
              <div className="bg-stone-50 p-3 rounded text-xs text-stone-600 space-y-1">
                <p><span className="font-semibold text-stone-800">アクセス:</span> 金沢駅よりお車にて約40分</p>
          ...
          <div className="pt-2">
            <a
              href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F167495%2F167495.html"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold rounded-lg shadow-md transition text-sm text-center"
            >
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold text-stone-900 border-l-4 border-amber-600 pl-3">
            【秋旅モデルコース】石川・金沢＆湯涌温泉を満喫する1泊2日の極上周遊ルート
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-amber-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                <li><span className="font-semibold text-amber-700">10:00</span> - 現地到着後、特別名勝 兼六園（徽軫灯籠・雪吊り）を散策。澄んだ秋空と鮮やかな景観を堪能</li>
                <li><span className="font-semibold text-amber-700">12:30</span> - ご当地名店にて旬の味覚（解禁直後の加能ガニ（茹で蟹など）の贅沢ランチ</li>
                <li><span className="font-semibold text-amber-700">14:30</span> - 金沢城公園へ移動。午後の柔らかな木漏れ日の中で絶景撮影</li>
            ...
            <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
              ...
              <ul className="text-sm text-stone-700 space-y-2">
                ...
                <li><span className="font-semibold text-emerald-700">09:30</span> - チェックアウト後、ひがし茶屋街・主計町茶屋街を訪問</li>
                <li><span className="font-semibold text-emerald-700">11:30</span> - 金沢21世紀美術館にてお土産選びと散策</li>
        ...
        <section className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 石川・金沢＆湯涌温泉の秋（10月〜11月）のベストシーズン・見どころはいつですか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年10月下旬〜11月下旬（兼六園雪吊り＆紅葉・加能ガニ初競り・寒ブリ）（兼六園の雪吊り作業と紅葉・ひがし茶屋街の秋風情・11月6日加能ガニ解禁）が見頃のピークとなります。山々や海岸線の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              <h3 className="font-bold text-stone-900 text-sm md:text-base">Q. 石川・金沢＆湯涌温泉へのアクセスや秋旅の注意点はありますか？</h3>
              <p className="text-xs md:text-sm text-stone-700 mt-2">
