...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '10月・11月の新潟・十日町＆松之山温泉特集！早朝の水鏡に映る星峠の棚田の幻想的な雲海と紅葉、草津・有馬と並ぶ日本三大薬湯「松之山温泉」の濃厚な天然塩化物泉、魚沼産新米コシヒカリと妻有ポーク・秋の山菜ジビエをふるさと納税トラベルで味わう贅沢プラン。',
    url: 'https://croud-travel.com/furusato-tax-echigo-tsumari-tokamachi-autumn-stay',
...
export default function Page() {
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": "十日町・星峠の棚田雲海と日本三大薬湯・松之山温泉！魚沼新米コシヒカリ＆越後妻有秋アート旅",
    "description": "10月・11月の新潟・十日町＆松之山温泉特集！早朝の水鏡に映る星峠の棚田の幻想的な雲海と紅葉、草津・有馬と並ぶ日本三大薬湯「松之山温泉」の濃厚な天然塩化物泉、魚沼産新米コシヒカリと妻有ポーク・秋の山菜ジビエをふるさと納税トラベルで味わう贅沢プラン。",
    "author": {
      "@type": "Organization",
      "name": "クラウドトラベル編集部"
    ...
    "mainEntityOfPage": "https://croud-travel.com/furusato-tax-echigo-tsumari-tokamachi-autumn-stay"
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "十日町・松之山温泉・星峠の棚田の秋（10月〜11月）のベストシーズン・見どころはいつですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年10月中旬〜11月下旬（星峠の棚田雲海と朝霧・美人林の黄金ブナ紅葉・魚沼新米・日本三大薬湯）が見頃のピークとなります。山々や景勝地の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "秋の十日町・松之山温泉・星峠の棚田旅行における服装や持ち物のポイントは？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "10月〜11月の十日町・松之山温泉・星峠の棚田は昼夜の寒暖差が大きくなります。日中は快適に散策できますが、朝夕の散策や露天風呂への移動時には防寒用のアウター（フリースやジャケット等）を必ずご用意ください。"
        }
      }
    ]
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 leading-relaxed font-sans">
      ...
      <header className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-orange-950 text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs sm:text-sm text-stone-300">
            <span className="flex items-center gap-1">📅 旬のシーズン：10月中旬〜11月下旬（星峠の棚田雲海と朝霧・美人林の黄金ブナ紅葉・魚沼新米・日本三大薬湯）</span>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3 px-4 sm:px-6 lg:px-8 text-xs text-stone-600">
        <div className="max-w-5xl mx-auto flex items-center space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-stone-900 font-medium">新潟・十日町＆松之山温泉特集</span>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            10月・11月に訪れるべき理由：秋の十日町・松之山温泉・星峠の棚田の魅力
          </h2>
          <div className="space-y-4 text-stone-700 text-sm sm:text-base leading-relaxed">
            <p>
              新潟県を代表する景勝地・温泉地である十日町・松之山温泉・星峠の棚田は、秋の訪れとともに最も華やかで風情あふれる季節を迎えます。
            ...
            <div className="bg-amber-50/80 rounded-xl p-5 border-l-4 border-amber-500 mt-6 space-y-2">
              ...
              <ul className="list-disc list-inside text-stone-700 text-xs sm:text-sm space-y-1">
                <li><strong>紅葉の見頃ピーク：</strong> 10月中旬〜11月下旬（星峠の棚田雲海と朝霧・美人林の黄金ブナ紅葉・魚沼新米・日本三大薬湯）</li>
        ...
        <section className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-stone-200/80">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-6 flex items-center gap-3 border-b border-stone-200 pb-4">
            ...
            秋の十日町・松之山温泉・星峠の棚田を満喫する1泊2日モデルコース
          </h2>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">えちごまつのやまおんせん りょううんかく</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">越後松之山温泉　凌雲閣</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.13 <span className="text-xs text-stone-500 font-normal">(248件)</span>
                  </div>
              ...
              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                昭和13年築の国登録有形文化財を誇る木造三階建ての名門温泉旅館。日本三大薬湯・松之山温泉の濃厚な自家源泉かけ流しと、十日町・魚沼の山里会席が絶賛される宿。
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  ...
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉（日本三大薬湯・自家源泉かけ流し） / 登録有形文化財の木造大浴場・露天風呂 / 効能：きりきず、やけど、慢性皮膚病、虚弱児童、慢性婦人病、美肌、神経痛</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">魚沼産極上コシヒカリの釜炊きご飯、にいがた和牛の炭火焼き、妻有ポークの角煮、雪国越後の山菜・きのこ鍋</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">国の文化財建築が放つ格調高い和の空間。太古の海水が湧き出る日本三大薬湯で体の芯から温まり、美人林や星峠の棚田へのアクセスも抜群。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">北越急行ほくほく線「まつだい駅」より路線バスで約25分（無料送迎あり要予約） / 関越自動車道「越後川口IC」より車で約60分 / 塩沢石打ICより車で約50分</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">まつのやまおんせん かもすもり</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">松之山温泉　醸す森［ｋａｍｏｓｕ　ｍｏｒｉ］</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.26 <span className="text-xs text-stone-500 font-normal">(100件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥12,000〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                ブナ林の豊かな森に佇む、モダンフレンチと地酒・自然派ワインのマリアージュを楽しむオーベルジュスタイルの温泉宿。美肌の天然温泉と洗練された美食空間が評判。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物泉（松之山温泉引き湯） / 森を望む展望風呂 / 効能：美肌効果、疲労回復、筋肉痛、冷え性改善</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">地元十日町食材を昇華させた薪火フレンチコース、妻有ポークのロースト、魚沼産コシヒカリの創作リゾット、新潟銘酒・自然派ワイン</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">森の静寂に抱かれる開放的なリゾート。薪の香りと鳥のさえずりを聞きながら、上質なワインと新潟の豊かな秋の恵みを堪能。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">まつだい駅よりタクシーで約20分（送迎あり要予約） / 六日町ICより車で約45分</div>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <a
                  href="https://hb.afl.rakuten.co.jp/hgc/54d2a438.4bc4abc2.54d2a439.aa1be583/?pc=https%3A%2F%2Ftravel.rakuten.co.jp%2FHOTEL%2F168000%2F168000.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition transform active:scale-95 text-sm"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <div className="text-xs text-stone-400 font-medium mt-2">まつのやまおんせん いずみや</div>
                  <h3 className="text-xl sm:text-2xl font-bold text-stone-900 mt-0.5">松之山温泉　和泉屋　＜新潟県＞</h3>
                </div>
                <div className="text-right">
                  <div className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 font-bold px-3 py-1 rounded-lg border border-amber-200 text-sm">
                    ★ 4.67 <span className="text-xs text-stone-500 font-normal">(95件)</span>
                  </div>
                  <div className="text-xs text-stone-500 mt-1">目安料金: ¥15,125〜</div>
                </div>
              </div>

              <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
                松之山温泉街の中心に位置し、木造の温もりと家庭的なおもてなしが光る老舗旅館。日本三大薬湯の源泉かけ流しと、地場産旬野菜・魚沼コシヒカリの手作り料理が好評。
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-stone-50 rounded-xl p-5 border border-stone-200/70 text-xs sm:text-sm">
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">♨️ 温泉・泉質</div>
                  <div className="text-stone-600">ナトリウム・カルシウム-塩化物温泉（源泉100%完全かけ流し） / 檜造り天然温泉内湯・貸切風呂 / 効能：神経痛、筋肉痛、冷え性、皮膚病、疲労回復</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">🍽️ 自慢の料理</div>
                  <div className="text-stone-600">越後もち豚の陶板焼き会席、岩魚の塩焼き、採れたてきのこの天ぷら、魚沼産棚田米コシヒカリ、手作り郷土小鉢</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">✨ 宿の魅力</div>
                  <div className="text-stone-600">温泉街の散策や足湯へ徒歩すぐ。薬効豊かな濃厚源泉を贅沢に楽しめ、棚田巡りや大地の芸術祭作品鑑賞の拠点に最適。</div>
                </div>
                <div>
                  <div className="font-bold text-stone-900 flex items-center gap-1.5 mb-1">📍 アクセス</div>
                  <div className="text-stone-600">まつだい駅よりバス約20分「松之山温泉」下車徒歩約1分 / 越後川口ICより車で約55分</div>
                </div>
              </div>
          ...
          <div className="space-y-6 text-stone-700 text-sm sm:text-base">
            <div className="border-b border-stone-100 pb-4">
              ...
              <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
                紅葉の見頃ピーク（10月中旬〜11月下旬（星峠の棚田雲海と朝霧・美人林の黄金ブナ紅葉・魚沼新米・日本三大薬湯））は週末を中心に観光客で賑わいます。ゆっくり散策や温泉を楽しみたい方は平日の宿泊や、早朝の観光スポット訪問がおすすめです。
              </p>
            </div>
            <div className="border-b border-stone-100 pb-4">
