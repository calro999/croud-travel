    ...
    subAreas: [
      {
        ...
        keywords: [cleanName],
        subAreaHotels: [
          { hotelName: `${cleanName}おすすめ宿`, areaName: cleanName, postId: "1017" },
          { hotelName: `${cleanName}人気ホテル`, areaName: cleanName, postId: "1019" },
          { hotelName: `${cleanName}和モダン宿`, areaName: cleanName, postId: "104526" }
        ]
      }
    ],
    cafes: [
