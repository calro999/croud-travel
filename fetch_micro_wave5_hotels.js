...
const microWave5Configs = [
  {
    ...
    queries: [
      { key: 'atami_fireworks_view', query: '熱海温泉 花火 見える ホテル 旅館 露天風呂', label: '客室・露天風呂から熱海海上花火を望む絶景宿' },
      { key: 'atami_sunbeach_walk', query: '熱海 サンビーチ ホテル 温泉 オーシャンビュー 徒歩', label: '熱海サンビーチ・親水公園徒歩圏内の海辺リゾート' },
      { key: 'atami_kinomiya_luxury', query: '熱海 高級 旅館 露天風呂 離れ 来宮', label: '来宮神社周辺・緑に抱かれる大人の隠れ家高級宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'ikaho_stairs_walk', query: '伊香保温泉 石段街 旅館 露天風呂 黄金の湯 群馬', label: '365段の石段街沿い・黄金の湯を引く老舗旅館' },
      { key: 'ikaho_kajikabashi_view', query: '伊香保温泉 河鹿橋 旅館 露天風呂 紅葉', label: '河鹿橋・伊香保神社周辺の風情ある名門宿' },
      { key: 'mizusawa_udon_stay', query: '伊香保 水沢うどん ホテル 旅館 温泉 榛名山', label: '水沢うどん街・榛名湖観光に便利なリゾート' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'toba_aquarium_walk', query: '鳥羽水族館 ホテル 旅館 温泉 三重 徒歩', label: '鳥羽水族館・ミキモト真珠島至近のオーシャンビュー宿' },
      { key: 'toba_iseebi_luxury', query: '鳥羽 温泉 伊勢海老 アワビ 料理 旅館 高級', label: '本場活伊勢海老・アワビ会席が自慢の名門温泉宿' },
      { key: 'toba_ijika_seafood', query: '相差 鳥羽 旅館 温泉 舟盛り 海鮮', label: '海女のまち相差（おうさつ）・豪快舟盛り民宿＆旅館' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'unzen_jigoku_walk', query: '雲仙地獄 雲仙温泉 旅館 露天風呂 硫黄泉 長崎', label: '雲仙地獄を望む湯けむりフロント・白濁硫黄泉宿' },
      { key: 'unzen_classic_hotel', query: '雲仙観光ホテル 雲仙温泉 クラシック ホテル', label: '登録有形文化財・歴史あるクラシック洋館ホテル' },
      { key: 'unzen_nita_pass', query: '雲仙 仁田峠 ホテル 旅館 温泉 露天風呂', label: '仁田峠ロープウェイ・雲仙岳パノラマ周辺宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'kurashiki_river_walk', query: '倉敷美観地区 ホテル 旅館 倉敷川 徒歩 岡山', label: '倉敷美観地区内・倉敷川沿いの白壁町家宿' },
      { key: 'kurashiki_ohara_art', query: '大原美術館 倉敷 ホテル 旅館 徒歩', label: '大原美術館・倉敷アイビースクエア周辺宿' },
      { key: 'kurashiki_gourmet_fruits', query: '倉敷 料理 旅館 瀬戸内 蛸 フルーツ 岡山', label: '下津井タコ・千屋牛＆旬のフルーツ会席宿' }
    ],
    areaGuides: [
      {
...
async function main() {
  console.log('=== Fetching direct hotel data from Rakuten Travel API for 5 Micro Tourist Hubs (Wave 5) ===');
  ...
  for (const theme of microWave5Configs) {
    console.log(`\n========================================`);
  ...
  console.log(`\nSuccessfully saved all Micro Tourist Hubs Wave 5 hotel data to: ${cachePath}`);
}
