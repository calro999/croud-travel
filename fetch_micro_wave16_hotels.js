...
const microWave16Configs = [
  {
    ...
    queries: [
      { key: 'hirado_castle_heritage_onsen', query: '平戸 温泉 旅館 ホテル 露天風呂 平戸城 長崎 宿泊', label: '平戸城下町・南蛮貿易の歴史薫る平戸温泉旅館' },
      { key: 'sasebo_kujukushima_resort_stay', query: '佐世保 九十九島 ホテル リゾート 温泉 弓張岳 宿泊', label: '九十九島パノラマ・弓張岳展望リゾートホテル' },
      { key: 'hirado_hirame_sasebo_beef_stay', query: '平戸 旅館 天然ヒラメ 長崎和牛 レモンステーキ 料理 高級', label: '平戸名物「天然ヒラメ姿造り」＆長崎和牛会席宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'aoshima_coast_resort_onsen', query: '青島 温泉 ホテル リゾート 露天風呂 宮崎 鬼の洗濯板 宿泊', label: '青島ビーチフロント・鬼の洗濯板一望の天然温泉リゾート' },
      { key: 'nichinan_udo_shrine_stay', query: '日南 鵜戸神宮 サンメッセ日南 ホテル 旅館 温泉 宮崎 宿泊', label: '鵜戸神宮＆サンメッセ日南周辺・オーシャンビュー宿' },
      { key: 'miyazaki_beef_katsuo_gourmet', query: '宮崎 旅館 宮崎牛 カツオ 料理 温泉 部屋食 高級 日南', label: '日本一「宮崎牛」ステーキ＆日南一本釣り初ガツオ宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'amaharashi_tateyama_view_stay', query: '雨晴海岸 立山連峰 ホテル 旅館 温泉 富山 高岡 宿泊', label: '雨晴海岸・立山連峰パノラマ一望の絶景温泉宿' },
      { key: 'himi_seaside_onsen_luxury', query: '氷見温泉 旅館 露天風呂 富山湾 海鮮 宿泊 高級 富山', label: '氷見温泉郷・富山湾オーシャンビュー名門海鮮旅館' },
      { key: 'himi_kanburi_sushi_gourmet', query: '氷見 旅館 寒ブリ 白えび 氷見牛 料理 温泉 部屋食', label: '本場「ひみ寒ぶり」フルコース＆富山湾鮨・氷見牛宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'uji_byodoin_greentea_stay', query: '宇治 平等院 旅館 ホテル 宇治川 抹茶 京都 宿泊', label: '平等院鳳凰堂至近・宇治川の清流を望む老舗茶寮宿' },
      { key: 'fushimi_sake_brewery_stay', query: '伏見 酒蔵 十石舟 ホテル 旅館 温泉 京都 宿泊', label: '伏見酒蔵通り・十石舟乗船場周辺のクラシカルホテル' },
      { key: 'kyoto_kaiseki_matcha_sake_stay', query: '京都 宇治 伏見 懐石 料理 抹茶 利き酒 高級 旅館', label: '本場宇治抹茶会席＆伏見名酒ペアリング極上宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'onomichi_senkoji_slope_stay', query: '尾道 旅館 ホテル 露天風呂 千光寺 尾道水道 広島 宿泊', label: '尾道水道一望・千光寺坂の街に佇むレトロモダン宿' },
      { key: 'shimanami_cycling_mukoujima_stay', query: 'しまなみ海道 向島 サイクリング ホテル リゾート 宿泊 広島', label: 'しまなみ海道サイクリング拠点・自転車持ち込み可能宿' },
      { key: 'onomichi_ramen_setouchi_fish_stay', query: '尾道 旅館 尾道ラーメン 瀬戸内海鮮 料理 温泉 部屋食 広島', label: '瀬戸内地魚お造り＆尾道ラーメン・レモンポーク会席宿' }
    ],
    areaGuides: [
      {
...
async function main() {
  console.log('=== Fetching direct hotel data from Rakuten Travel API for 5 Micro Tourist Hubs (Wave 16) ===');
  ...
  for (const theme of microWave16Configs) {
    console.log(`\n========================================`);
  ...
  console.log(`\nSuccessfully saved all Micro Tourist Hubs Wave 16 hotel data to: ${cachePath}`);
}
