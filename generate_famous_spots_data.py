...
# jsonとして書き出し
with open('/Users/calro/Downloads/croud-travel/src/data/famousSpots.json', 'w', encoding='utf-8') as f:
    json.dump(famous_spots_map, f, ensure_ascii=False, indent=2)

print("famousSpots.json successfully created with 47 prefectures!")
