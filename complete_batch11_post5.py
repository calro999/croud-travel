...
<div class="my-6 p-6 bg-gradient-to-br from-amber-50 to-orange-50/50 border border-amber-200 rounded-3xl shadow-sm">
  ...
  <ul class="space-y-2 text-xs text-stone-800 font-medium">
    <li class="flex items-start gap-2"><span class="text-amber-500 font-bold">✔</span><span>房州伊勢海老・あわび舞踊りを堪能する南房総の秋海鮮</span></li>
    <li class="flex items-start gap-2"><span class="text-amber-500 font-bold">✔</span><span>【楽天公式データ取得】太平洋を一望する屋上天空露天温泉スパ</span></li>
    <li class="flex items-start gap-2"><span class="text-amber-500 font-bold">✔</span><span>敷地内無料駐車場完備＆鴨川シーワールド・紅葉スポットに好アクセス</span></li>
  </ul>
</div>
...
print(f"🎉 Batch 11 Completed 5th post: {out_path}")
