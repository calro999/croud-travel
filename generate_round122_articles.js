...
const round122Data = JSON.parse(fs.readFileSync(path.join(__dirname, 'round122_batch_data.json'), 'utf8'));
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "例年${article.bestTiming}（${article.seasonHighlight}）が見頃のピークとなります。山々や海岸・温泉街の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。"
        }
      },
      {
        "@type": "Question",
          ...
          <div className="space-y-4">
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
              ...
              <p className="text-xs md:text-sm text-stone-700 mt-2">
                例年${article.bestTiming}（${article.seasonHighlight}）が見頃のピークとなります。山々や海岸・温泉街の鮮やかなグラデーションとともに、旬を迎える極上の地場食材を心ゆくまで満喫いただけます。
              </p>
            </div>
            <div className="p-4 bg-stone-50 rounded-lg border border-stone-200">
...
for (const article of round122Data) {
