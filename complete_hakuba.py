...
<div class="my-6 p-6 bg-gradient-to-br from-amber-50 to-orange-50/50 border border-amber-200 rounded-3xl shadow-sm">
  ...
  <ul class="space-y-2 text-xs text-stone-800 font-medium">
    ...
    <li class="flex items-start gap-2"><span class="text-amber-500 font-bold">✔</span><span>【楽天公式データ取得】自慢の源泉掛け流し温泉・3万坪森林リゾート・フレンチ懐石</span></li>
...
print(f"🎉 Completed 5th Post (Hakuba): {out_path}")
