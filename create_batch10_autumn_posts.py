...
batch10_queries = [
    {
        "id": "autumn-tohoku-iwate-salmon-gourmet-guide",
        "query": "東北 岩手 三陸 宮古 秋鮭 こぼれいくら 海鮮丼 温泉宿",
        "search_kw": "浄土ヶ浜パークホテル",
        "title": "【2026年最新】岩手 三陸宮古の秋鮭＆こぼれいくら掛け放題瓶ドン・三陸名湯温泉リゾート特集",
        "description": "三陸海岸の秋の豪華海鮮リトリート！宮古名物瓶ドン・秋鮭いくらビュッフェ、浄土ヶ浜の絶景を望む温泉大浴場を誇る「浄土ヶ浜パークホテル」等の楽天公式写真・最新空室情報を掲載。",
        "prefecture": "岩手県",
        "area": "宮古・浄土ヶ浜",
        "categories": ["岩手県", "東北", "グルメ・美食", "リゾート・絶景", "特集・まとめ"],
        "date": "2026-08-12"
    },
    {
        "id": "autumn-kanto-gunma-ikaho-momiji-guide",
        "query": "関東 群馬 伊香保温泉 石段街 紅葉 上州豚 温泉宿",
        "search_kw": "伊香保温泉　福一",
        "title": "【2026年最新】群馬 伊香保温泉 石段街の紅葉ライトアップ＆名物黄金の湯・上州豚会席名宿特集",
        "description": "石段街の秋の情景＆美食名湯旅！河鹿橋の紅葉ライトアップ、黄金の湯・白銀の湯の二大名湯、上州もち豚・松茸懐石を誇る「伊香保温泉 福一」等の楽天公式データをチェック。",
        "prefecture": "群馬県",
        "area": "伊香保",
    ...
    {
        "id": "autumn-hokuriku-toyama-himi-buri-guide",
        "query": "北陸 富山 氷見 寒ブリ お造り ズワイガニ 温泉旅館",
        "search_kw": "氷見温泉郷　くつろぎの宿　うみあかり",
        "title": "【2026年最新】北陸 富山・氷見名物 ひみ寒ブリ三昧＆富山湾オーシャンビュー温泉旅館特集",
        "description": "富山湾の冬の味覚先取りガイド！脂がのった極上ひみ寒ブリのお造り・ブリしゃぶ、紅ズワイガニ、立山連峰を望む絶景温泉を誇る「氷見温泉郷 くつろぎの宿 うみあかり」等の楽天公式写真を掲載。",
        "prefecture": "富山県",
        "area": "高岡・氷見",
        "categories": ["富山県", "北陸", "グルメ・美食", "温泉旅行", "リゾート・絶景"],
        "date": "2026-08-12"
    },
    {
...
print("🚀 Fetching direct Rakuten OpenAPI data for New Batch 10 (5 posts)...")

for q in batch10_queries:
    params = {
    ...
    if "hotels" in res and len(res["hotels"]) > 0:
        ...
        print(f"✅ Batch 10 Direct Rakuten OpenAPI SUCCESS for [{q['query']}]: {hotel_name}")
...
<div class="my-6 p-6 bg-gradient-to-br from-amber-50 to-orange-50/50 border border-amber-200 rounded-3xl shadow-sm">
  ...
  <ul class="space-y-2 text-xs text-stone-800 font-medium">
    <li class="flex items-start gap-2"><span class="text-amber-500 font-bold">✔</span><span>三陸秋鮭・上州豚・氷見寒ブリ・近江牛・霧島黒豚を味わう極上食体験</span></li>
    <li class="flex items-start gap-2"><span class="text-amber-500 font-bold">✔</span><span>【楽天公式データ取得】美肌の名湯・黄金の湯・メガ庭園露天風呂</span></li>
    <li class="flex items-start gap-2"><span class="text-amber-500 font-bold">✔</span><span>敷地内無料駐車場完備＆周辺の紅葉・観光スポットに好アクセス</span></li>
  </ul>
</div>
...
<p class="text-sm text-stone-700 leading-relaxed mb-4">{query_text}は、味覚の秋と温泉を一度に愉しめる最高のリトリートです。人気のお宿は早期に満室となりますので、ぜひお早めにチェックしてみてください！</p>'''
        ...
        print(f"🎉 Batch 10 Generated post: {out_path}")

print("🎉 BATCH 10 ALL 5 NEW AUTUMN POSTS GENERATED SUCCESSFULLY VIA DIRECT RAKUTEN OPENAPI!")
