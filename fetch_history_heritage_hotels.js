...
const historyConfigs = [
  {
    ...
    queries: [
      { key: 'himeji_matsumoto_castle_stay', query: '姫路城 松本城 ホテル 旅館 天守 展望 宿泊', label: '世界遺産姫路城＆国宝松本城・天守ライトアップ一望ホテル' },
      { key: 'inuyama_hikone_castle_stay', query: '犬山城 彦根城 ホテル 旅館 温泉 琵琶湖 木曽川 宿泊', label: '国宝犬山城＆彦根城・城下町＆川畔レトロ宿' },
      { key: 'matsue_maruoka_heritage_castle_stay', query: '松江城 丸岡城 旅館 ホテル 温泉 宍道湖 宿泊', label: '国宝松江城＆現存天守・宍道湖畔温泉旅館' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'tsumago_magome_kiso_stay', query: '妻籠宿 馬籠宿 旅館 民宿 木曽路 温泉 宿泊 長野 岐阜', label: '妻籠宿＆馬籠宿・木曽路の石畳に佇む江戸情緒古民家宿' },
      { key: 'naraijuku_kiso_timber_stay', query: '奈良井宿 木曽 旅館 ホテル 温泉 古民家 宿泊 長野', label: '奈良井宿・「奈良井千軒」出桁造りの伝統旅籠＆酒蔵ホテル' },
      { key: 'ouchijuku_aizu_thatched_stay', query: '大内宿 芦ノ牧温泉 湯野上温泉 旅館 茅葺き 会津 福島 宿泊', label: '大内宿＆湯野上温泉・茅葺き屋根の駅舎とねぎそば宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'koyasan_shukubo_temple_stay', query: '高野山 宿坊 寺院 精進料理 温泉 和歌山 宿泊 高級', label: '高野山宿坊・庭園を望む名刹＆本格精進料理・勤行体験宿' },
      { key: 'kumano_kodo_yunomine_stay', query: '熊野古道 湯の峰温泉 川湯温泉 旅館 露天風呂 和歌山 宿泊', label: '熊野古道＆世界遺産つぼ湯・仙人風呂名湯旅館' },
      { key: 'hieizan_enryakuji_lake_stay', query: '比叡山 延暦寺 宿坊 ホテル 琵琶湖 展望 滋賀 京都 宿泊', label: '比叡山延暦寺会館・琵琶湖一望の天空宿坊ホテル' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'hagi_meiji_revolution_stay', query: '萩 温泉 旅館 城下町 松陰神社 山口 宿泊 高級', label: '萩城下町・明治維新胎動の地＆萩温泉郷名門旅館' },
      { key: 'aizu_samurai_higashiyama_stay', query: '会津若松 東山温泉 旅館 露天風呂 鶴ヶ城 福島 宿泊', label: '会津若松・鶴ヶ城至近＆名湯東山温泉老舗旅館' },
      { key: 'kochi_ryoma_katsurahama_stay', query: '高知 桂浜 旅館 ホテル 坂本龍馬 カツオのタタキ 宿泊', label: '高知・坂本龍馬の故郷＆桂浜・皿鉢料理名宿' }
    ],
    areaGuides: [
      {
  ...
  },
  {
    ...
    queries: [
      { key: 'kakunodate_samurai_mansion_stay', query: '角館 武家屋敷 温泉 旅館 ホテル 秋田 宿泊', label: '角館武家屋敷通り・黒板塀に佇む小京都の隠れ宿' },
      { key: 'omihachiman_canal_kura_stay', query: '近江八幡 八幡堀 旅館 ホテル 近江牛 滋賀 宿泊', label: '近江八幡・八幡堀の水郷と近江商人白壁土蔵宿' },
      { key: 'takayama_mima_heritage_stay', query: '飛騨高山 古い町並み 旅館 温泉 飛騨牛 高級 岐阜 宿泊', label: '飛騨高山古い町並み＆美馬・伝統建築リノベーション宿' }
    ],
    areaGuides: [
      {
...
async function main() {
  console.log('=== Fetching direct hotel data from Rakuten Travel API for 5 History & Heritage Hubs ===');
  ...
  for (const theme of historyConfigs) {
    console.log(`\n========================================`);
    console.log(`History Hub: ${theme.title} (${theme.slug})`);
    console.log(`========================================`);
  ...
  console.log(`\nSuccessfully saved all History & Heritage Hubs hotel data to: ${cachePath}`);
}
