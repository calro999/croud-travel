...
const womenSoloConfigs = [
  {
    ...
    categoryKey: 'women-solo-safe-amenity-onsen-retreat-stay',
    areaGuides: [
      {
  ...
  },
  {
    ...
    categoryKey: 'book-hotel-library-stay-reading-retreat',
    areaGuides: [
      {
  ...
  },
  {
    ...
    categoryKey: 'cosme-spa-facial-treatment-esthetic-stay',
    areaGuides: [
      {
  ...
  },
  {
    ...
    categoryKey: 'art-museum-design-hotel-creative-stay',
    areaGuides: [
      {
  ...
  },
  {
    ...
    categoryKey: 'power-spot-shrine-temple-fortune-solo-stay',
    areaGuides: [
      {
...
export const metadata: Metadata = {
  ...
  keywords: ["${config.slug}", "女性一人旅", "ソロ活", "ご褒美ステイ", "温泉宿", "楽天トラベル"],
};
